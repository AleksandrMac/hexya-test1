...
type SequenceCondition interface {
	models.Conditioner
	SequenceConditionHexyaFunc()
}
...
// SequenceDateRangeConditionHexyaFunc is a dummy function to uniquely match interfaces.
func (c Condition) SequenceDateRangeConditionHexyaFunc() {}
...
// DateFrom adds the "DateFrom" field to the Condition
func (cs ConditionStart) DateFrom() pDatesDateConditionField {
	return pDatesDateConditionField{
		ConditionField: cs.Field(models.NewFieldName("DateFrom", "date_from")),
	}
}

// DateTo adds the "DateTo" field to the Condition
func (cs ConditionStart) DateTo() pDatesDateConditionField {
	return pDatesDateConditionField{
		ConditionField: cs.Field(models.NewFieldName("DateTo", "date_to")),
	}
}
...
func (cs ConditionStart) Sequence() pMSequenceSetConditionField {
	return pMSequenceSetConditionField{
		ConditionField: cs.Field(models.NewFieldName("Sequence", "sequence_id")),
	}
}

// SequenceFilteredOn adds a condition with a table join on the given field and
// filters the result with the given condition
func (cs ConditionStart) SequenceFilteredOn(cond SequenceCondition) Condition {
	return Condition{
		Condition: cs.FilteredOn(models.NewFieldName("Sequence", "sequence_id"), cond.Underlying()),
	}
}
...
// A pMSequenceSetConditionField is a partial Condition when
// we have selected a field of type SequenceSet and expecting an operator.
type pMSequenceSetConditionField struct {
	*models.ConditionField
}

// Equals adds a condition value to the ConditionPath
func (c pMSequenceSetConditionField) Equals(arg SequenceSet) Condition {
	return Condition{
...
func (c pMSequenceSetConditionField) EqualsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Equals(arg),
	}
}
...
// be used server-side.
func (c pMSequenceSetConditionField) EqualsEval(expression string) Condition {
	return Condition{
...
func (c pMSequenceSetConditionField) NotEquals(arg SequenceSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMSequenceSetConditionField) NotEqualsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotEquals(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMSequenceSetConditionField) NotEqualsEval(expression string) Condition {
	return Condition{
...
func (c pMSequenceSetConditionField) Greater(arg SequenceSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMSequenceSetConditionField) GreaterFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Greater(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMSequenceSetConditionField) GreaterEval(expression string) Condition {
	return Condition{
...
func (c pMSequenceSetConditionField) GreaterOrEqual(arg SequenceSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMSequenceSetConditionField) GreaterOrEqualFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.GreaterOrEqual(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMSequenceSetConditionField) GreaterOrEqualEval(expression string) Condition {
	return Condition{
...
func (c pMSequenceSetConditionField) Lower(arg SequenceSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMSequenceSetConditionField) LowerFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Lower(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMSequenceSetConditionField) LowerEval(expression string) Condition {
	return Condition{
...
func (c pMSequenceSetConditionField) LowerOrEqual(arg SequenceSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMSequenceSetConditionField) LowerOrEqualFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.LowerOrEqual(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMSequenceSetConditionField) LowerOrEqualEval(expression string) Condition {
	return Condition{
...
func (c pMSequenceSetConditionField) Like(arg SequenceSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMSequenceSetConditionField) LikeFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Like(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMSequenceSetConditionField) LikeEval(expression string) Condition {
	return Condition{
...
func (c pMSequenceSetConditionField) Contains(arg SequenceSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMSequenceSetConditionField) ContainsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Contains(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMSequenceSetConditionField) ContainsEval(expression string) Condition {
	return Condition{
...
func (c pMSequenceSetConditionField) NotContains(arg SequenceSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMSequenceSetConditionField) NotContainsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotContains(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMSequenceSetConditionField) NotContainsEval(expression string) Condition {
	return Condition{
...
func (c pMSequenceSetConditionField) IContains(arg SequenceSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMSequenceSetConditionField) IContainsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.IContains(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMSequenceSetConditionField) IContainsEval(expression string) Condition {
	return Condition{
...
func (c pMSequenceSetConditionField) NotIContains(arg SequenceSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMSequenceSetConditionField) NotIContainsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotIContains(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMSequenceSetConditionField) NotIContainsEval(expression string) Condition {
	return Condition{
...
func (c pMSequenceSetConditionField) ILike(arg SequenceSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMSequenceSetConditionField) ILikeFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.ILike(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMSequenceSetConditionField) ILikeEval(expression string) Condition {
	return Condition{
...
func (c pMSequenceSetConditionField) In(arg SequenceSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMSequenceSetConditionField) InFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.In(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMSequenceSetConditionField) InEval(expression string) Condition {
	return Condition{
...
func (c pMSequenceSetConditionField) NotIn(arg SequenceSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMSequenceSetConditionField) NotInFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotIn(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMSequenceSetConditionField) NotInEval(expression string) Condition {
	return Condition{
...
func (c pMSequenceSetConditionField) ChildOf(arg SequenceSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMSequenceSetConditionField) ChildOfFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.ChildOf(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMSequenceSetConditionField) ChildOfEval(expression string) Condition {
	return Condition{
...
func (c pMSequenceSetConditionField) IsNull() Condition {
	return Condition{
...
func (c pMSequenceSetConditionField) IsNotNull() Condition {
	return Condition{
...
func (c pMSequenceSetConditionField) AddOperator(op operator.Operator, data interface{}) Condition {
	return Condition{
