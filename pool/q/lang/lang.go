...
// LangConditionHexyaFunc is a dummy function to uniquely match interfaces.
func (c Condition) LangConditionHexyaFunc() {}
...
// DateFormat adds the "DateFormat" field to the Condition
func (cs ConditionStart) DateFormat() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("DateFormat", "date_format")),
	}
}

// DecimalPoint adds the "DecimalPoint" field to the Condition
func (cs ConditionStart) DecimalPoint() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("DecimalPoint", "decimal_point")),
	}
}

// Direction adds the "Direction" field to the Condition
func (cs ConditionStart) Direction() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("Direction", "direction")),
	}
}
...
// Grouping adds the "Grouping" field to the Condition
func (cs ConditionStart) Grouping() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("Grouping", "grouping")),
	}
}
...
// ISOCode adds the "ISOCode" field to the Condition
func (cs ConditionStart) ISOCode() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("ISOCode", "iso_code")),
	}
}
...
// ThousandsSep adds the "ThousandsSep" field to the Condition
func (cs ConditionStart) ThousandsSep() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("ThousandsSep", "thousands_sep")),
	}
}

// TimeFormat adds the "TimeFormat" field to the Condition
func (cs ConditionStart) TimeFormat() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("TimeFormat", "time_format")),
	}
}

// Translatable adds the "Translatable" field to the Condition
func (cs ConditionStart) Translatable() pBoolConditionField {
	return pBoolConditionField{
		ConditionField: cs.Field(models.NewFieldName("Translatable", "translatable")),
	}
}
