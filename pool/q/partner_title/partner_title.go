...
// PartnerTitleConditionHexyaFunc is a dummy function to uniquely match interfaces.
func (c Condition) PartnerTitleConditionHexyaFunc() {}
...
// Shortcut adds the "Shortcut" field to the Condition
func (cs ConditionStart) Shortcut() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("Shortcut", "shortcut")),
	}
}
