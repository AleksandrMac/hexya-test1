...
// PartnerIndustryConditionHexyaFunc is a dummy function to uniquely match interfaces.
func (c Condition) PartnerIndustryConditionHexyaFunc() {}
...
// FullName adds the "FullName" field to the Condition
func (cs ConditionStart) FullName() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("FullName", "full_name")),
	}
}
