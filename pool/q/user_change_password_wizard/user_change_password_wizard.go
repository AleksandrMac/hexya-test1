...
type UserChangePasswordWizardLineCondition interface {
	models.Conditioner
	UserChangePasswordWizardLineConditionHexyaFunc()
}
...
// UserChangePasswordWizardConditionHexyaFunc is a dummy function to uniquely match interfaces.
func (c Condition) UserChangePasswordWizardConditionHexyaFunc() {}
...
func (cs ConditionStart) Users() pMUserChangePasswordWizardLineSetConditionField {
	return pMUserChangePasswordWizardLineSetConditionField{
...
func (cs ConditionStart) UsersFilteredOn(cond UserChangePasswordWizardLineCondition) Condition {
	return Condition{
...
// A pMUserChangePasswordWizardLineSetConditionField is a partial Condition when
// we have selected a field of type UserChangePasswordWizardLineSet and expecting an operator.
type pMUserChangePasswordWizardLineSetConditionField struct {
	*models.ConditionField
}

// Equals adds a condition value to the ConditionPath
func (c pMUserChangePasswordWizardLineSetConditionField) Equals(arg UserChangePasswordWizardLineSet) Condition {
	return Condition{
...
func (c pMUserChangePasswordWizardLineSetConditionField) EqualsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Equals(arg),
	}
}
...
// be used server-side.
func (c pMUserChangePasswordWizardLineSetConditionField) EqualsEval(expression string) Condition {
	return Condition{
...
func (c pMUserChangePasswordWizardLineSetConditionField) NotEquals(arg UserChangePasswordWizardLineSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMUserChangePasswordWizardLineSetConditionField) NotEqualsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotEquals(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMUserChangePasswordWizardLineSetConditionField) NotEqualsEval(expression string) Condition {
	return Condition{
...
func (c pMUserChangePasswordWizardLineSetConditionField) Greater(arg UserChangePasswordWizardLineSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMUserChangePasswordWizardLineSetConditionField) GreaterFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Greater(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMUserChangePasswordWizardLineSetConditionField) GreaterEval(expression string) Condition {
	return Condition{
...
func (c pMUserChangePasswordWizardLineSetConditionField) GreaterOrEqual(arg UserChangePasswordWizardLineSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMUserChangePasswordWizardLineSetConditionField) GreaterOrEqualFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.GreaterOrEqual(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMUserChangePasswordWizardLineSetConditionField) GreaterOrEqualEval(expression string) Condition {
	return Condition{
...
func (c pMUserChangePasswordWizardLineSetConditionField) Lower(arg UserChangePasswordWizardLineSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMUserChangePasswordWizardLineSetConditionField) LowerFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Lower(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMUserChangePasswordWizardLineSetConditionField) LowerEval(expression string) Condition {
	return Condition{
...
func (c pMUserChangePasswordWizardLineSetConditionField) LowerOrEqual(arg UserChangePasswordWizardLineSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMUserChangePasswordWizardLineSetConditionField) LowerOrEqualFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.LowerOrEqual(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMUserChangePasswordWizardLineSetConditionField) LowerOrEqualEval(expression string) Condition {
	return Condition{
...
func (c pMUserChangePasswordWizardLineSetConditionField) Like(arg UserChangePasswordWizardLineSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMUserChangePasswordWizardLineSetConditionField) LikeFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Like(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMUserChangePasswordWizardLineSetConditionField) LikeEval(expression string) Condition {
	return Condition{
...
func (c pMUserChangePasswordWizardLineSetConditionField) Contains(arg UserChangePasswordWizardLineSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMUserChangePasswordWizardLineSetConditionField) ContainsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Contains(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMUserChangePasswordWizardLineSetConditionField) ContainsEval(expression string) Condition {
	return Condition{
...
func (c pMUserChangePasswordWizardLineSetConditionField) NotContains(arg UserChangePasswordWizardLineSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMUserChangePasswordWizardLineSetConditionField) NotContainsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotContains(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMUserChangePasswordWizardLineSetConditionField) NotContainsEval(expression string) Condition {
	return Condition{
...
func (c pMUserChangePasswordWizardLineSetConditionField) IContains(arg UserChangePasswordWizardLineSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMUserChangePasswordWizardLineSetConditionField) IContainsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.IContains(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMUserChangePasswordWizardLineSetConditionField) IContainsEval(expression string) Condition {
	return Condition{
...
func (c pMUserChangePasswordWizardLineSetConditionField) NotIContains(arg UserChangePasswordWizardLineSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMUserChangePasswordWizardLineSetConditionField) NotIContainsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotIContains(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMUserChangePasswordWizardLineSetConditionField) NotIContainsEval(expression string) Condition {
	return Condition{
...
func (c pMUserChangePasswordWizardLineSetConditionField) ILike(arg UserChangePasswordWizardLineSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMUserChangePasswordWizardLineSetConditionField) ILikeFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.ILike(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMUserChangePasswordWizardLineSetConditionField) ILikeEval(expression string) Condition {
	return Condition{
...
func (c pMUserChangePasswordWizardLineSetConditionField) In(arg UserChangePasswordWizardLineSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMUserChangePasswordWizardLineSetConditionField) InFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.In(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMUserChangePasswordWizardLineSetConditionField) InEval(expression string) Condition {
	return Condition{
...
func (c pMUserChangePasswordWizardLineSetConditionField) NotIn(arg UserChangePasswordWizardLineSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMUserChangePasswordWizardLineSetConditionField) NotInFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotIn(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMUserChangePasswordWizardLineSetConditionField) NotInEval(expression string) Condition {
	return Condition{
...
func (c pMUserChangePasswordWizardLineSetConditionField) ChildOf(arg UserChangePasswordWizardLineSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMUserChangePasswordWizardLineSetConditionField) ChildOfFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.ChildOf(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMUserChangePasswordWizardLineSetConditionField) ChildOfEval(expression string) Condition {
	return Condition{
...
func (c pMUserChangePasswordWizardLineSetConditionField) IsNull() Condition {
	return Condition{
...
func (c pMUserChangePasswordWizardLineSetConditionField) IsNotNull() Condition {
	return Condition{
...
func (c pMUserChangePasswordWizardLineSetConditionField) AddOperator(op operator.Operator, data interface{}) Condition {
	return Condition{
