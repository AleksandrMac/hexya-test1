...
// CountryGroupConditionHexyaFunc is a dummy function to uniquely match interfaces.
func (c Condition) CountryGroupConditionHexyaFunc() {}
...
// Countries adds the "Countries" field to the Condition
func (cs ConditionStart) Countries() pMCountrySetConditionField {
	return pMCountrySetConditionField{
		ConditionField: cs.Field(models.NewFieldName("Countries", "countries_ids")),
	}
}

// CountriesFilteredOn adds a condition with a table join on the given field and
// filters the result with the given condition
func (cs ConditionStart) CountriesFilteredOn(cond CountryCondition) Condition {
	return Condition{
		Condition: cs.FilteredOn(models.NewFieldName("Countries", "countries_ids"), cond.Underlying()),
	}
}
