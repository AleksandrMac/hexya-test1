...
// QueueChannelConditionHexyaFunc is a dummy function to uniquely match interfaces.
func (c Condition) QueueChannelConditionHexyaFunc() {}
...
// Capacity adds the "Capacity" field to the Condition
func (cs ConditionStart) Capacity() pIntConditionField {
	return pIntConditionField{
		ConditionField: cs.Field(models.NewFieldName("Capacity", "capacity")),
	}
}
