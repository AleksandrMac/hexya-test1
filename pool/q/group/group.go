...
// GroupConditionHexyaFunc is a dummy function to uniquely match interfaces.
func (c Condition) GroupConditionHexyaFunc() {}
...
// GroupID adds the "GroupID" field to the Condition
func (cs ConditionStart) GroupID() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("GroupID", "group_id")),
	}
}
