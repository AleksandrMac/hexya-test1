...
// FilterConditionHexyaFunc is a dummy function to uniquely match interfaces.
func (c Condition) FilterConditionHexyaFunc() {}
...
// Action adds the "Action" field to the Condition
func (cs ConditionStart) Action() pInt64ConditionField {
	return pInt64ConditionField{
		ConditionField: cs.Field(models.NewFieldName("Action", "action_id")),
	}
}
...
// Context adds the "Context" field to the Condition
func (cs ConditionStart) Context() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("Context", "context")),
	}
}
...
// Domain adds the "Domain" field to the Condition
func (cs ConditionStart) Domain() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("Domain", "domain")),
	}
}
...
// IsDefault adds the "IsDefault" field to the Condition
func (cs ConditionStart) IsDefault() pBoolConditionField {
	return pBoolConditionField{
		ConditionField: cs.Field(models.NewFieldName("IsDefault", "is_default")),
	}
}
...
func (cs ConditionStart) ResModel() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("ResModel", "model_id")),
	}
}

// Sort adds the "Sort" field to the Condition
func (cs ConditionStart) Sort() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("Sort", "sort")),
	}
}
