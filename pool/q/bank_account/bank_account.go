...
type BankCondition interface {
	models.Conditioner
	BankConditionHexyaFunc()
}
...
// BankAccountConditionHexyaFunc is a dummy function to uniquely match interfaces.
func (c Condition) BankAccountConditionHexyaFunc() {}
...
// AccountType adds the "AccountType" field to the Condition
func (cs ConditionStart) AccountType() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("AccountType", "account_type")),
	}
}

// Bank adds the "Bank" field to the Condition
func (cs ConditionStart) Bank() pMBankSetConditionField {
	return pMBankSetConditionField{
		ConditionField: cs.Field(models.NewFieldName("Bank", "bank_id")),
	}
}

// BankFilteredOn adds a condition with a table join on the given field and
// filters the result with the given condition
func (cs ConditionStart) BankFilteredOn(cond BankCondition) Condition {
	return Condition{
		Condition: cs.FilteredOn(models.NewFieldName("Bank", "bank_id"), cond.Underlying()),
	}
}

// BankBIC adds the "BankBIC" field to the Condition
func (cs ConditionStart) BankBIC() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("BankBIC", "bank_bic")),
	}
}

// BankName adds the "BankName" field to the Condition
func (cs ConditionStart) BankName() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("BankName", "bank_name")),
	}
}
...
// SanitizedAccountNumber adds the "SanitizedAccountNumber" field to the Condition
func (cs ConditionStart) SanitizedAccountNumber() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("SanitizedAccountNumber", "sanitized_account_number")),
	}
}
...
// A pMBankSetConditionField is a partial Condition when
// we have selected a field of type BankSet and expecting an operator.
type pMBankSetConditionField struct {
	*models.ConditionField
}

// Equals adds a condition value to the ConditionPath
func (c pMBankSetConditionField) Equals(arg BankSet) Condition {
	return Condition{
...
func (c pMBankSetConditionField) EqualsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Equals(arg),
	}
}
...
// be used server-side.
func (c pMBankSetConditionField) EqualsEval(expression string) Condition {
	return Condition{
...
func (c pMBankSetConditionField) NotEquals(arg BankSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMBankSetConditionField) NotEqualsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotEquals(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMBankSetConditionField) NotEqualsEval(expression string) Condition {
	return Condition{
...
func (c pMBankSetConditionField) Greater(arg BankSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMBankSetConditionField) GreaterFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Greater(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMBankSetConditionField) GreaterEval(expression string) Condition {
	return Condition{
...
func (c pMBankSetConditionField) GreaterOrEqual(arg BankSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMBankSetConditionField) GreaterOrEqualFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.GreaterOrEqual(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMBankSetConditionField) GreaterOrEqualEval(expression string) Condition {
	return Condition{
...
func (c pMBankSetConditionField) Lower(arg BankSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMBankSetConditionField) LowerFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Lower(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMBankSetConditionField) LowerEval(expression string) Condition {
	return Condition{
...
func (c pMBankSetConditionField) LowerOrEqual(arg BankSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMBankSetConditionField) LowerOrEqualFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.LowerOrEqual(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMBankSetConditionField) LowerOrEqualEval(expression string) Condition {
	return Condition{
...
func (c pMBankSetConditionField) Like(arg BankSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMBankSetConditionField) LikeFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Like(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMBankSetConditionField) LikeEval(expression string) Condition {
	return Condition{
...
func (c pMBankSetConditionField) Contains(arg BankSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMBankSetConditionField) ContainsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Contains(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMBankSetConditionField) ContainsEval(expression string) Condition {
	return Condition{
...
func (c pMBankSetConditionField) NotContains(arg BankSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMBankSetConditionField) NotContainsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotContains(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMBankSetConditionField) NotContainsEval(expression string) Condition {
	return Condition{
...
func (c pMBankSetConditionField) IContains(arg BankSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMBankSetConditionField) IContainsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.IContains(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMBankSetConditionField) IContainsEval(expression string) Condition {
	return Condition{
...
func (c pMBankSetConditionField) NotIContains(arg BankSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMBankSetConditionField) NotIContainsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotIContains(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMBankSetConditionField) NotIContainsEval(expression string) Condition {
	return Condition{
...
func (c pMBankSetConditionField) ILike(arg BankSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMBankSetConditionField) ILikeFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.ILike(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMBankSetConditionField) ILikeEval(expression string) Condition {
	return Condition{
...
func (c pMBankSetConditionField) In(arg BankSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMBankSetConditionField) InFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.In(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMBankSetConditionField) InEval(expression string) Condition {
	return Condition{
...
func (c pMBankSetConditionField) NotIn(arg BankSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMBankSetConditionField) NotInFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotIn(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMBankSetConditionField) NotInEval(expression string) Condition {
	return Condition{
...
func (c pMBankSetConditionField) ChildOf(arg BankSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMBankSetConditionField) ChildOfFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.ChildOf(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMBankSetConditionField) ChildOfEval(expression string) Condition {
	return Condition{
...
func (c pMBankSetConditionField) IsNull() Condition {
	return Condition{
...
func (c pMBankSetConditionField) IsNotNull() Condition {
	return Condition{
...
func (c pMBankSetConditionField) AddOperator(op operator.Operator, data interface{}) Condition {
	return Condition{
