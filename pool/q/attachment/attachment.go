...
// AccessToken adds the "AccessToken" field to the Condition
func (cs ConditionStart) AccessToken() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("AccessToken", "access_token")),
	}
}

// CheckSum adds the "CheckSum" field to the Condition
func (cs ConditionStart) CheckSum() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("CheckSum", "check_sum")),
	}
}
...
func (cs ConditionStart) DBDatas() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("DBDatas", "db_datas")),
	}
}

// Datas adds the "Datas" field to the Condition
func (cs ConditionStart) Datas() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("Datas", "datas")),
	}
}
...
func (cs ConditionStart) FileSize() pIntConditionField {
	return pIntConditionField{
		ConditionField: cs.Field(models.NewFieldName("FileSize", "file_size")),
	}
}
...
// IndexContent adds the "IndexContent" field to the Condition
func (cs ConditionStart) IndexContent() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("IndexContent", "index_content")),
	}
}
...
// MimeType adds the "MimeType" field to the Condition
func (cs ConditionStart) MimeType() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("MimeType", "mime_type")),
	}
}
...
func (cs ConditionStart) Public() pBoolConditionField {
	return pBoolConditionField{
		ConditionField: cs.Field(models.NewFieldName("Public", "public")),
	}
}

// ResField adds the "ResField" field to the Condition
func (cs ConditionStart) ResField() pStringConditionField {
	return pStringConditionField{
...
func (cs ConditionStart) ResID() pInt64ConditionField {
	return pInt64ConditionField{
...
func (cs ConditionStart) ResModel() pStringConditionField {
	return pStringConditionField{
...
func (cs ConditionStart) ResName() pStringConditionField {
	return pStringConditionField{
...
func (cs ConditionStart) StoreFname() pStringConditionField {
	return pStringConditionField{
...
func (cs ConditionStart) URL() pStringConditionField {
	return pStringConditionField{
