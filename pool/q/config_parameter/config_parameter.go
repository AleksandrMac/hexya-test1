...
// ConfigParameterConditionHexyaFunc is a dummy function to uniquely match interfaces.
func (c Condition) ConfigParameterConditionHexyaFunc() {}
...
func (cs ConditionStart) Groups() pMGroupSetConditionField {
	return pMGroupSetConditionField{
		ConditionField: cs.Field(models.NewFieldName("Groups", "groups_ids")),
	}
}
...
func (cs ConditionStart) GroupsFilteredOn(cond GroupCondition) Condition {
	return Condition{
		Condition: cs.FilteredOn(models.NewFieldName("Groups", "groups_ids"), cond.Underlying()),
	}
}
...
// Key adds the "Key" field to the Condition
func (cs ConditionStart) Key() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("Key", "key")),
	}
}
...
// Value adds the "Value" field to the Condition
func (cs ConditionStart) Value() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("Value", "value")),
	}
}
