...
type CountryGroupCondition interface {
	models.Conditioner
	CountryGroupConditionHexyaFunc()
}
...
// CountryConditionHexyaFunc is a dummy function to uniquely match interfaces.
func (c Condition) CountryConditionHexyaFunc() {}
...
// AddressFormat adds the "AddressFormat" field to the Condition
func (cs ConditionStart) AddressFormat() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("AddressFormat", "address_format")),
	}
}

// AddressViewID adds the "AddressViewID" field to the Condition
func (cs ConditionStart) AddressViewID() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("AddressViewID", "address_view_id")),
	}
}
...
// CountryGroups adds the "CountryGroups" field to the Condition
func (cs ConditionStart) CountryGroups() pMCountryGroupSetConditionField {
	return pMCountryGroupSetConditionField{
		ConditionField: cs.Field(models.NewFieldName("CountryGroups", "country_groups_ids")),
	}
}

// CountryGroupsFilteredOn adds a condition with a table join on the given field and
// filters the result with the given condition
func (cs ConditionStart) CountryGroupsFilteredOn(cond CountryGroupCondition) Condition {
	return Condition{
		Condition: cs.FilteredOn(models.NewFieldName("CountryGroups", "country_groups_ids"), cond.Underlying()),
	}
}
...
// NamePosition adds the "NamePosition" field to the Condition
func (cs ConditionStart) NamePosition() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("NamePosition", "name_position")),
	}
}

// PhoneCode adds the "PhoneCode" field to the Condition
func (cs ConditionStart) PhoneCode() pInt64ConditionField {
	return pInt64ConditionField{
		ConditionField: cs.Field(models.NewFieldName("PhoneCode", "phone_code")),
	}
}

// States adds the "States" field to the Condition
func (cs ConditionStart) States() pMCountryStateSetConditionField {
	return pMCountryStateSetConditionField{
		ConditionField: cs.Field(models.NewFieldName("States", "states_ids")),
	}
}

// StatesFilteredOn adds a condition with a table join on the given field and
// filters the result with the given condition
func (cs ConditionStart) StatesFilteredOn(cond CountryStateCondition) Condition {
	return Condition{
		Condition: cs.FilteredOn(models.NewFieldName("States", "states_ids"), cond.Underlying()),
	}
}

// VATLabel adds the "VATLabel" field to the Condition
func (cs ConditionStart) VATLabel() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("VATLabel", "vat_label")),
	}
}
...
// A pMCountryGroupSetConditionField is a partial Condition when
// we have selected a field of type CountryGroupSet and expecting an operator.
type pMCountryGroupSetConditionField struct {
	*models.ConditionField
}

// Equals adds a condition value to the ConditionPath
func (c pMCountryGroupSetConditionField) Equals(arg CountryGroupSet) Condition {
	return Condition{
...
func (c pMCountryGroupSetConditionField) EqualsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Equals(arg),
	}
}
...
// be used server-side.
func (c pMCountryGroupSetConditionField) EqualsEval(expression string) Condition {
	return Condition{
...
func (c pMCountryGroupSetConditionField) NotEquals(arg CountryGroupSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMCountryGroupSetConditionField) NotEqualsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotEquals(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMCountryGroupSetConditionField) NotEqualsEval(expression string) Condition {
	return Condition{
...
func (c pMCountryGroupSetConditionField) Greater(arg CountryGroupSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMCountryGroupSetConditionField) GreaterFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Greater(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMCountryGroupSetConditionField) GreaterEval(expression string) Condition {
	return Condition{
...
func (c pMCountryGroupSetConditionField) GreaterOrEqual(arg CountryGroupSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMCountryGroupSetConditionField) GreaterOrEqualFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.GreaterOrEqual(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMCountryGroupSetConditionField) GreaterOrEqualEval(expression string) Condition {
	return Condition{
...
func (c pMCountryGroupSetConditionField) Lower(arg CountryGroupSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMCountryGroupSetConditionField) LowerFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Lower(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMCountryGroupSetConditionField) LowerEval(expression string) Condition {
	return Condition{
...
func (c pMCountryGroupSetConditionField) LowerOrEqual(arg CountryGroupSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMCountryGroupSetConditionField) LowerOrEqualFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.LowerOrEqual(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMCountryGroupSetConditionField) LowerOrEqualEval(expression string) Condition {
	return Condition{
...
func (c pMCountryGroupSetConditionField) Like(arg CountryGroupSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMCountryGroupSetConditionField) LikeFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Like(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMCountryGroupSetConditionField) LikeEval(expression string) Condition {
	return Condition{
...
func (c pMCountryGroupSetConditionField) Contains(arg CountryGroupSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMCountryGroupSetConditionField) ContainsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Contains(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMCountryGroupSetConditionField) ContainsEval(expression string) Condition {
	return Condition{
...
func (c pMCountryGroupSetConditionField) NotContains(arg CountryGroupSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMCountryGroupSetConditionField) NotContainsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotContains(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMCountryGroupSetConditionField) NotContainsEval(expression string) Condition {
	return Condition{
...
func (c pMCountryGroupSetConditionField) IContains(arg CountryGroupSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMCountryGroupSetConditionField) IContainsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.IContains(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMCountryGroupSetConditionField) IContainsEval(expression string) Condition {
	return Condition{
...
func (c pMCountryGroupSetConditionField) NotIContains(arg CountryGroupSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMCountryGroupSetConditionField) NotIContainsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotIContains(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMCountryGroupSetConditionField) NotIContainsEval(expression string) Condition {
	return Condition{
...
func (c pMCountryGroupSetConditionField) ILike(arg CountryGroupSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMCountryGroupSetConditionField) ILikeFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.ILike(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMCountryGroupSetConditionField) ILikeEval(expression string) Condition {
	return Condition{
...
func (c pMCountryGroupSetConditionField) In(arg CountryGroupSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMCountryGroupSetConditionField) InFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.In(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMCountryGroupSetConditionField) InEval(expression string) Condition {
	return Condition{
...
func (c pMCountryGroupSetConditionField) NotIn(arg CountryGroupSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMCountryGroupSetConditionField) NotInFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotIn(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMCountryGroupSetConditionField) NotInEval(expression string) Condition {
	return Condition{
...
func (c pMCountryGroupSetConditionField) ChildOf(arg CountryGroupSet) Condition {
	return Condition{
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMCountryGroupSetConditionField) ChildOfFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.ChildOf(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMCountryGroupSetConditionField) ChildOfEval(expression string) Condition {
	return Condition{
...
func (c pMCountryGroupSetConditionField) IsNull() Condition {
	return Condition{
...
func (c pMCountryGroupSetConditionField) IsNotNull() Condition {
	return Condition{
...
func (c pMCountryGroupSetConditionField) AddOperator(op operator.Operator, data interface{}) Condition {
	return Condition{
