...
// BankConditionHexyaFunc is a dummy function to uniquely match interfaces.
func (c Condition) BankConditionHexyaFunc() {}
...
// BIC adds the "BIC" field to the Condition
func (cs ConditionStart) BIC() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("BIC", "bic")),
	}
}
