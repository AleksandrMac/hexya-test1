...
type QueueChannelCondition interface {
	models.Conditioner
	QueueChannelConditionHexyaFunc()
}
...
type QueueJobCondition interface {
	models.Conditioner
	QueueJobConditionHexyaFunc()
}
...
// QueueJobConditionHexyaFunc is a dummy function to uniquely match interfaces.
func (c Condition) QueueJobConditionHexyaFunc() {}
...
// Channel adds the "Channel" field to the Condition
func (cs ConditionStart) Channel() pMQueueChannelSetConditionField {
	return pMQueueChannelSetConditionField{
		ConditionField: cs.Field(models.NewFieldName("Channel", "channel_id")),
	}
}

// ChannelFilteredOn adds a condition with a table join on the given field and
// filters the result with the given condition
func (cs ConditionStart) ChannelFilteredOn(cond QueueChannelCondition) Condition {
	return Condition{
		Condition: cs.FilteredOn(models.NewFieldName("Channel", "channel_id"), cond.Underlying()),
	}
}
...
// DateDone adds the "DateDone" field to the Condition
func (cs ConditionStart) DateDone() pDatesDateTimeConditionField {
	return pDatesDateTimeConditionField{
		ConditionField: cs.Field(models.NewFieldName("DateDone", "date_done")),
	}
}

// DateEnqueued adds the "DateEnqueued" field to the Condition
func (cs ConditionStart) DateEnqueued() pDatesDateTimeConditionField {
	return pDatesDateTimeConditionField{
		ConditionField: cs.Field(models.NewFieldName("DateEnqueued", "date_enqueued")),
	}
}

// DateStarted adds the "DateStarted" field to the Condition
func (cs ConditionStart) DateStarted() pDatesDateTimeConditionField {
	return pDatesDateTimeConditionField{
		ConditionField: cs.Field(models.NewFieldName("DateStarted", "date_started")),
	}
}
...
// ETA adds the "ETA" field to the Condition
func (cs ConditionStart) ETA() pDatesDateTimeConditionField {
	return pDatesDateTimeConditionField{
		ConditionField: cs.Field(models.NewFieldName("ETA", "eta")),
	}
}

// ExcInfo adds the "ExcInfo" field to the Condition
func (cs ConditionStart) ExcInfo() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("ExcInfo", "exc_info")),
	}
}

// ExecuteAfterJob adds the "ExecuteAfterJob" field to the Condition
func (cs ConditionStart) ExecuteAfterJob() pMQueueJobSetConditionField {
	return pMQueueJobSetConditionField{
		ConditionField: cs.Field(models.NewFieldName("ExecuteAfterJob", "execute_after_job_id")),
	}
}

// ExecuteAfterJobFilteredOn adds a condition with a table join on the given field and
// filters the result with the given condition
func (cs ConditionStart) ExecuteAfterJobFilteredOn(cond QueueJobCondition) Condition {
	return Condition{
		Condition: cs.FilteredOn(models.NewFieldName("ExecuteAfterJob", "execute_after_job_id"), cond.Underlying()),
	}
}

// ExecuteBeforeJobs adds the "ExecuteBeforeJobs" field to the Condition
func (cs ConditionStart) ExecuteBeforeJobs() pMQueueJobSetConditionField {
	return pMQueueJobSetConditionField{
		ConditionField: cs.Field(models.NewFieldName("ExecuteBeforeJobs", "execute_before_jobs_ids")),
	}
}

// ExecuteBeforeJobsFilteredOn adds a condition with a table join on the given field and
// filters the result with the given condition
func (cs ConditionStart) ExecuteBeforeJobsFilteredOn(cond QueueJobCondition) Condition {
	return Condition{
		Condition: cs.FilteredOn(models.NewFieldName("ExecuteBeforeJobs", "execute_before_jobs_ids"), cond.Underlying()),
	}
}
...
// MaxRetries adds the "MaxRetries" field to the Condition
func (cs ConditionStart) MaxRetries() pInt64ConditionField {
	return pInt64ConditionField{
		ConditionField: cs.Field(models.NewFieldName("MaxRetries", "max_retries")),
	}
}
...
// Priority adds the "Priority" field to the Condition
func (cs ConditionStart) Priority() pInt64ConditionField {
	return pInt64ConditionField{
		ConditionField: cs.Field(models.NewFieldName("Priority", "priority")),
	}
}
...
// Result adds the "Result" field to the Condition
func (cs ConditionStart) Result() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("Result", "result")),
	}
}

// Retry adds the "Retry" field to the Condition
func (cs ConditionStart) Retry() pInt64ConditionField {
	return pInt64ConditionField{
		ConditionField: cs.Field(models.NewFieldName("Retry", "retry")),
	}
}
...
// A pMQueueChannelSetConditionField is a partial Condition when
// we have selected a field of type QueueChannelSet and expecting an operator.
type pMQueueChannelSetConditionField struct {
	*models.ConditionField
}

// Equals adds a condition value to the ConditionPath
func (c pMQueueChannelSetConditionField) Equals(arg QueueChannelSet) Condition {
	return Condition{
		Condition: c.ConditionField.Equals(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueChannelSetConditionField) EqualsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Equals(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueChannelSetConditionField) EqualsEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.Equals(models.ClientEvaluatedString(expression)),
	}
}
...
// NotEquals adds a condition value to the ConditionPath
func (c pMQueueChannelSetConditionField) NotEquals(arg QueueChannelSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotEquals(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueChannelSetConditionField) NotEqualsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotEquals(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueChannelSetConditionField) NotEqualsEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.NotEquals(models.ClientEvaluatedString(expression)),
	}
}
...
// Greater adds a condition value to the ConditionPath
func (c pMQueueChannelSetConditionField) Greater(arg QueueChannelSet) Condition {
	return Condition{
		Condition: c.ConditionField.Greater(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueChannelSetConditionField) GreaterFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Greater(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueChannelSetConditionField) GreaterEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.Greater(models.ClientEvaluatedString(expression)),
	}
}
...
// GreaterOrEqual adds a condition value to the ConditionPath
func (c pMQueueChannelSetConditionField) GreaterOrEqual(arg QueueChannelSet) Condition {
	return Condition{
		Condition: c.ConditionField.GreaterOrEqual(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueChannelSetConditionField) GreaterOrEqualFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.GreaterOrEqual(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueChannelSetConditionField) GreaterOrEqualEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.GreaterOrEqual(models.ClientEvaluatedString(expression)),
	}
}
...
// Lower adds a condition value to the ConditionPath
func (c pMQueueChannelSetConditionField) Lower(arg QueueChannelSet) Condition {
	return Condition{
		Condition: c.ConditionField.Lower(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueChannelSetConditionField) LowerFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Lower(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueChannelSetConditionField) LowerEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.Lower(models.ClientEvaluatedString(expression)),
	}
}
...
// LowerOrEqual adds a condition value to the ConditionPath
func (c pMQueueChannelSetConditionField) LowerOrEqual(arg QueueChannelSet) Condition {
	return Condition{
		Condition: c.ConditionField.LowerOrEqual(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueChannelSetConditionField) LowerOrEqualFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.LowerOrEqual(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueChannelSetConditionField) LowerOrEqualEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.LowerOrEqual(models.ClientEvaluatedString(expression)),
	}
}
...
// Like adds a condition value to the ConditionPath
func (c pMQueueChannelSetConditionField) Like(arg QueueChannelSet) Condition {
	return Condition{
		Condition: c.ConditionField.Like(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueChannelSetConditionField) LikeFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Like(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueChannelSetConditionField) LikeEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.Like(models.ClientEvaluatedString(expression)),
	}
}
...
// Contains adds a condition value to the ConditionPath
func (c pMQueueChannelSetConditionField) Contains(arg QueueChannelSet) Condition {
	return Condition{
		Condition: c.ConditionField.Contains(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueChannelSetConditionField) ContainsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Contains(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueChannelSetConditionField) ContainsEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.Contains(models.ClientEvaluatedString(expression)),
	}
}
...
// NotContains adds a condition value to the ConditionPath
func (c pMQueueChannelSetConditionField) NotContains(arg QueueChannelSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotContains(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueChannelSetConditionField) NotContainsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotContains(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueChannelSetConditionField) NotContainsEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.NotContains(models.ClientEvaluatedString(expression)),
	}
}
...
// IContains adds a condition value to the ConditionPath
func (c pMQueueChannelSetConditionField) IContains(arg QueueChannelSet) Condition {
	return Condition{
		Condition: c.ConditionField.IContains(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueChannelSetConditionField) IContainsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.IContains(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueChannelSetConditionField) IContainsEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.IContains(models.ClientEvaluatedString(expression)),
	}
}
...
// NotIContains adds a condition value to the ConditionPath
func (c pMQueueChannelSetConditionField) NotIContains(arg QueueChannelSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotIContains(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueChannelSetConditionField) NotIContainsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotIContains(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueChannelSetConditionField) NotIContainsEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.NotIContains(models.ClientEvaluatedString(expression)),
	}
}
...
// ILike adds a condition value to the ConditionPath
func (c pMQueueChannelSetConditionField) ILike(arg QueueChannelSet) Condition {
	return Condition{
		Condition: c.ConditionField.ILike(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueChannelSetConditionField) ILikeFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.ILike(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueChannelSetConditionField) ILikeEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.ILike(models.ClientEvaluatedString(expression)),
	}
}
...
// In adds a condition value to the ConditionPath
func (c pMQueueChannelSetConditionField) In(arg QueueChannelSet) Condition {
	return Condition{
		Condition: c.ConditionField.In(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueChannelSetConditionField) InFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.In(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueChannelSetConditionField) InEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.In(models.ClientEvaluatedString(expression)),
	}
}
...
// NotIn adds a condition value to the ConditionPath
func (c pMQueueChannelSetConditionField) NotIn(arg QueueChannelSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotIn(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueChannelSetConditionField) NotInFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotIn(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueChannelSetConditionField) NotInEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.NotIn(models.ClientEvaluatedString(expression)),
	}
}
...
// ChildOf adds a condition value to the ConditionPath
func (c pMQueueChannelSetConditionField) ChildOf(arg QueueChannelSet) Condition {
	return Condition{
		Condition: c.ConditionField.ChildOf(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueChannelSetConditionField) ChildOfFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.ChildOf(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueChannelSetConditionField) ChildOfEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.ChildOf(models.ClientEvaluatedString(expression)),
	}
}
...
// IsNull checks if the current condition field is null
func (c pMQueueChannelSetConditionField) IsNull() Condition {
	return Condition{
		Condition: c.ConditionField.IsNull(),
	}
}
...
// IsNotNull checks if the current condition field is not null
func (c pMQueueChannelSetConditionField) IsNotNull() Condition {
	return Condition{
		Condition: c.ConditionField.IsNotNull(),
	}
}
...
//
// This method is low level and should be avoided. Use operator methods such as Equals() instead.
func (c pMQueueChannelSetConditionField) AddOperator(op operator.Operator, data interface{}) Condition {
	return Condition{
		Condition: c.ConditionField.AddOperator(op, data),
	}
}

// A pMQueueJobSetConditionField is a partial Condition when
// we have selected a field of type QueueJobSet and expecting an operator.
type pMQueueJobSetConditionField struct {
	*models.ConditionField
}

// Equals adds a condition value to the ConditionPath
func (c pMQueueJobSetConditionField) Equals(arg QueueJobSet) Condition {
	return Condition{
		Condition: c.ConditionField.Equals(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueJobSetConditionField) EqualsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Equals(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueJobSetConditionField) EqualsEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.Equals(models.ClientEvaluatedString(expression)),
	}
}
...
// NotEquals adds a condition value to the ConditionPath
func (c pMQueueJobSetConditionField) NotEquals(arg QueueJobSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotEquals(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueJobSetConditionField) NotEqualsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotEquals(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueJobSetConditionField) NotEqualsEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.NotEquals(models.ClientEvaluatedString(expression)),
	}
}
...
// Greater adds a condition value to the ConditionPath
func (c pMQueueJobSetConditionField) Greater(arg QueueJobSet) Condition {
	return Condition{
		Condition: c.ConditionField.Greater(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueJobSetConditionField) GreaterFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Greater(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueJobSetConditionField) GreaterEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.Greater(models.ClientEvaluatedString(expression)),
	}
}
...
// GreaterOrEqual adds a condition value to the ConditionPath
func (c pMQueueJobSetConditionField) GreaterOrEqual(arg QueueJobSet) Condition {
	return Condition{
		Condition: c.ConditionField.GreaterOrEqual(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueJobSetConditionField) GreaterOrEqualFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.GreaterOrEqual(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueJobSetConditionField) GreaterOrEqualEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.GreaterOrEqual(models.ClientEvaluatedString(expression)),
	}
}
...
// Lower adds a condition value to the ConditionPath
func (c pMQueueJobSetConditionField) Lower(arg QueueJobSet) Condition {
	return Condition{
		Condition: c.ConditionField.Lower(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueJobSetConditionField) LowerFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Lower(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueJobSetConditionField) LowerEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.Lower(models.ClientEvaluatedString(expression)),
	}
}
...
// LowerOrEqual adds a condition value to the ConditionPath
func (c pMQueueJobSetConditionField) LowerOrEqual(arg QueueJobSet) Condition {
	return Condition{
		Condition: c.ConditionField.LowerOrEqual(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueJobSetConditionField) LowerOrEqualFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.LowerOrEqual(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueJobSetConditionField) LowerOrEqualEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.LowerOrEqual(models.ClientEvaluatedString(expression)),
	}
}
...
// Like adds a condition value to the ConditionPath
func (c pMQueueJobSetConditionField) Like(arg QueueJobSet) Condition {
	return Condition{
		Condition: c.ConditionField.Like(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueJobSetConditionField) LikeFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Like(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueJobSetConditionField) LikeEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.Like(models.ClientEvaluatedString(expression)),
	}
}
...
// Contains adds a condition value to the ConditionPath
func (c pMQueueJobSetConditionField) Contains(arg QueueJobSet) Condition {
	return Condition{
		Condition: c.ConditionField.Contains(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueJobSetConditionField) ContainsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.Contains(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueJobSetConditionField) ContainsEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.Contains(models.ClientEvaluatedString(expression)),
	}
}
...
// NotContains adds a condition value to the ConditionPath
func (c pMQueueJobSetConditionField) NotContains(arg QueueJobSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotContains(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueJobSetConditionField) NotContainsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotContains(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueJobSetConditionField) NotContainsEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.NotContains(models.ClientEvaluatedString(expression)),
	}
}
...
// IContains adds a condition value to the ConditionPath
func (c pMQueueJobSetConditionField) IContains(arg QueueJobSet) Condition {
	return Condition{
		Condition: c.ConditionField.IContains(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueJobSetConditionField) IContainsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.IContains(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueJobSetConditionField) IContainsEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.IContains(models.ClientEvaluatedString(expression)),
	}
}
...
// NotIContains adds a condition value to the ConditionPath
func (c pMQueueJobSetConditionField) NotIContains(arg QueueJobSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotIContains(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueJobSetConditionField) NotIContainsFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotIContains(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueJobSetConditionField) NotIContainsEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.NotIContains(models.ClientEvaluatedString(expression)),
	}
}
...
// ILike adds a condition value to the ConditionPath
func (c pMQueueJobSetConditionField) ILike(arg QueueJobSet) Condition {
	return Condition{
		Condition: c.ConditionField.ILike(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueJobSetConditionField) ILikeFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.ILike(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueJobSetConditionField) ILikeEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.ILike(models.ClientEvaluatedString(expression)),
	}
}
...
// In adds a condition value to the ConditionPath
func (c pMQueueJobSetConditionField) In(arg QueueJobSet) Condition {
	return Condition{
		Condition: c.ConditionField.In(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueJobSetConditionField) InFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.In(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueJobSetConditionField) InEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.In(models.ClientEvaluatedString(expression)),
	}
}
...
// NotIn adds a condition value to the ConditionPath
func (c pMQueueJobSetConditionField) NotIn(arg QueueJobSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotIn(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueJobSetConditionField) NotInFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.NotIn(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueJobSetConditionField) NotInEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.NotIn(models.ClientEvaluatedString(expression)),
	}
}
...
// ChildOf adds a condition value to the ConditionPath
func (c pMQueueJobSetConditionField) ChildOf(arg QueueJobSet) Condition {
	return Condition{
		Condition: c.ConditionField.ChildOf(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c pMQueueJobSetConditionField) ChildOfFunc(arg func(models.RecordSet) models.RecordSet) Condition {
	return Condition{
		Condition: c.ConditionField.ChildOf(arg),
	}
}
...
// corresponding execution context. The resulting Condition cannot
// be used server-side.
func (c pMQueueJobSetConditionField) ChildOfEval(expression string) Condition {
	return Condition{
		Condition: c.ConditionField.ChildOf(models.ClientEvaluatedString(expression)),
	}
}
...
// IsNull checks if the current condition field is null
func (c pMQueueJobSetConditionField) IsNull() Condition {
	return Condition{
		Condition: c.ConditionField.IsNull(),
	}
}
...
// IsNotNull checks if the current condition field is not null
func (c pMQueueJobSetConditionField) IsNotNull() Condition {
	return Condition{
		Condition: c.ConditionField.IsNotNull(),
	}
}
...
//
// This method is low level and should be avoided. Use operator methods such as Equals() instead.
func (c pMQueueJobSetConditionField) AddOperator(op operator.Operator, data interface{}) Condition {
	return Condition{
		Condition: c.ConditionField.AddOperator(op, data),
	}
}
