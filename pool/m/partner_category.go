...
type PartnerCategorySet interface {
	...
	ForceLoad(fields ...models.FieldName) PartnerCategorySet
	...
	AddDomainLimitOffset(domain domains.Domain, limit int, offset int, order string) PartnerCategorySet
	...
	Aggregates(fieldNames ...models.FieldName) []PartnerCategoryGroupAggregateRow
	// Browse returns a new RecordSet with only the records with the given ids.
	// Note that this function is just a shorcut for Search on a list of ids.
	Browse(ids []int64) PartnerCategorySet
	...
	BrowseOne(id int64) PartnerCategorySet

	CartesianProduct(others ...PartnerCategorySet) []PartnerCategorySet
	...
	Copy(overrides PartnerCategoryData) PartnerCategorySet

	CopyData(overrides PartnerCategoryData) PartnerCategoryData

	Create(data PartnerCategoryData) PartnerCategorySet

	DefaultGet() PartnerCategoryData
	...
	Equals(other PartnerCategorySet) bool
	...
	Filtered(test func(PartnerCategorySet) bool) PartnerCategorySet
	...
	Intersect(other PartnerCategorySet) PartnerCategorySet
	// Limit returns a new RecordSet with only the first 'limit' records.
	Limit(limit int) PartnerCategorySet
	...
	// model are retrieved.
	Load(fields ...models.FieldName) PartnerCategorySet
	...
	New(data PartnerCategoryData) PartnerCategorySet
	...
	Offset(offset int) PartnerCategorySet
	...
	OrderBy(exprs ...string) PartnerCategorySet
	...
	Search(condition q.PartnerCategoryCondition) PartnerCategorySet
	...
	SearchAll() PartnerCategorySet

	SearchByName(name string, op operator.Operator, additionalCond q.PartnerCategoryCondition, limit int) PartnerCategorySet
	...
	Sorted(less func(PartnerCategorySet, PartnerCategorySet) bool) PartnerCategorySet
	...
	SortedByField(namer models.FieldName, reverse bool) PartnerCategorySet
	...
	SortedDefault() PartnerCategorySet
	...
	Subtract(other PartnerCategorySet) PartnerCategorySet
	// Sudo returns a new RecordSet with the given userID
	// or the superuser ID if not specified
	Sudo(userID ...int64) PartnerCategorySet
	...
	Union(other PartnerCategorySet) PartnerCategorySet
	...
	WithContext(key string, value interface{}) PartnerCategorySet
	// WithEnv returns a copy of the current RecordSet with the given Environment.
	WithEnv(env models.Environment) PartnerCategorySet
	// WithNewContext returns a copy of the current RecordSet with its context
	// replaced by the given one.
	WithNewContext(context *types.Context) PartnerCategorySet

	Write(data PartnerCategoryData) bool
...
type PartnerCategoryData interface {
	models.RecordData
	...
	MergeWith(other PartnerCategoryData)
	// Keys returns the PartnerCategoryData keys as a slice of strings
	Keys() (res []string)
	// OrderedKeys returns the keys of this PartnerCategoryData ordered.
	//
	...
	OrderedKeys() []string
	// FieldNames returns the PartnerCategoryData keys as a slice of FieldNames.
	...
	SetActive(value bool) PartnerCategoryData
	// UnsetActive removes the value of the Active field if it exists.
	// It returns this PartnerCategoryData so that calls can be chained.
	UnsetActive() PartnerCategoryData
	...
	// It returns this PartnerCategoryData so that calls can be chained.
	SetChildren(value PartnerCategorySet) PartnerCategoryData
	// UnsetChildren removes the value of the Children field if it exists.
	// It returns this PartnerCategoryData so that calls can be chained.
	UnsetChildren() PartnerCategoryData
	...
	CreateChildren(related PartnerCategoryData) PartnerCategoryData
	...
	// It returns this PartnerCategoryData so that calls can be chained.
	SetColor(value int64) PartnerCategoryData
	// UnsetColor removes the value of the Color field if it exists.
	// It returns this PartnerCategoryData so that calls can be chained.
	UnsetColor() PartnerCategoryData
	...
	// It returns this PartnerCategoryData so that calls can be chained.
	SetCreateDate(value dates.DateTime) PartnerCategoryData
	// UnsetCreateDate removes the value of the CreateDate field if it exists.
	// It returns this PartnerCategoryData so that calls can be chained.
	UnsetCreateDate() PartnerCategoryData
	...
	// It returns this PartnerCategoryData so that calls can be chained.
	SetCreateUID(value int64) PartnerCategoryData
	// UnsetCreateUID removes the value of the CreateUID field if it exists.
	// It returns this PartnerCategoryData so that calls can be chained.
	UnsetCreateUID() PartnerCategoryData
	...
	// It returns this PartnerCategoryData so that calls can be chained.
	SetDisplayName(value string) PartnerCategoryData
	// UnsetDisplayName removes the value of the DisplayName field if it exists.
	// It returns this PartnerCategoryData so that calls can be chained.
	UnsetDisplayName() PartnerCategoryData
	...
	// It returns this PartnerCategoryData so that calls can be chained.
	SetHexyaExternalID(value string) PartnerCategoryData
	// UnsetHexyaExternalID removes the value of the HexyaExternalID field if it exists.
	// It returns this PartnerCategoryData so that calls can be chained.
	UnsetHexyaExternalID() PartnerCategoryData
	...
	// It returns this PartnerCategoryData so that calls can be chained.
	SetHexyaVersion(value int) PartnerCategoryData
	// UnsetHexyaVersion removes the value of the HexyaVersion field if it exists.
	// It returns this PartnerCategoryData so that calls can be chained.
	UnsetHexyaVersion() PartnerCategoryData
	...
	// It returns this PartnerCategoryData so that calls can be chained.
	SetID(value int64) PartnerCategoryData
	// UnsetID removes the value of the ID field if it exists.
	// It returns this PartnerCategoryData so that calls can be chained.
	UnsetID() PartnerCategoryData
	...
	// It returns this PartnerCategoryData so that calls can be chained.
	SetLastUpdate(value dates.DateTime) PartnerCategoryData
	// UnsetLastUpdate removes the value of the LastUpdate field if it exists.
	// It returns this PartnerCategoryData so that calls can be chained.
	UnsetLastUpdate() PartnerCategoryData
	...
	// It returns this PartnerCategoryData so that calls can be chained.
	SetName(value string) PartnerCategoryData
	// UnsetName removes the value of the Name field if it exists.
	// It returns this PartnerCategoryData so that calls can be chained.
	UnsetName() PartnerCategoryData
	...
	// It returns this PartnerCategoryData so that calls can be chained.
	SetWriteDate(value dates.DateTime) PartnerCategoryData
	// UnsetWriteDate removes the value of the WriteDate field if it exists.
	// It returns this PartnerCategoryData so that calls can be chained.
	UnsetWriteDate() PartnerCategoryData
