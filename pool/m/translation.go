...
type TranslationSet interface {
	...
	ForceLoad(fields ...models.FieldName) TranslationSet
	...
	AddDomainLimitOffset(domain domains.Domain, limit int, offset int, order string) TranslationSet
	...
	Aggregates(fieldNames ...models.FieldName) []TranslationGroupAggregateRow
	// Browse returns a new RecordSet with only the records with the given ids.
	// Note that this function is just a shorcut for Search on a list of ids.
	Browse(ids []int64) TranslationSet
	...
	BrowseOne(id int64) TranslationSet

	CartesianProduct(others ...TranslationSet) []TranslationSet
	...
	Copy(overrides TranslationData) TranslationSet

	CopyData(overrides TranslationData) TranslationData

	Create(data TranslationData) TranslationSet

	DefaultGet() TranslationData
	...
	Equals(other TranslationSet) bool
	...
	Filtered(test func(TranslationSet) bool) TranslationSet
	...
	Intersect(other TranslationSet) TranslationSet
	// Limit returns a new RecordSet with only the first 'limit' records.
	Limit(limit int) TranslationSet
	...
	// model are retrieved.
	Load(fields ...models.FieldName) TranslationSet
	...
	New(data TranslationData) TranslationSet
	...
	Offset(offset int) TranslationSet
	...
	OrderBy(exprs ...string) TranslationSet
	...
	Search(condition q.TranslationCondition) TranslationSet
	...
	SearchAll() TranslationSet

	SearchByName(name string, op operator.Operator, additionalCond q.TranslationCondition, limit int) TranslationSet
	...
	Sorted(less func(TranslationSet, TranslationSet) bool) TranslationSet
	...
	SortedByField(namer models.FieldName, reverse bool) TranslationSet
	...
	TranslateFields(modelName string, id int64, fieldName models.FieldName) *actions.Action
	...
	Union(other TranslationSet) TranslationSet
	...
	WithContext(key string, value interface{}) TranslationSet
	// WithEnv returns a copy of the current RecordSet with the given Environment.
	WithEnv(env models.Environment) TranslationSet
	// WithNewContext returns a copy of the current RecordSet with its context
	// replaced by the given one.
	WithNewContext(context *types.Context) TranslationSet

	Write(data TranslationData) bool
...
type TranslationData interface {
	models.RecordData
	...
	MergeWith(other TranslationData)
	// Keys returns the TranslationData keys as a slice of strings
	Keys() (res []string)
	// OrderedKeys returns the keys of this TranslationData ordered.
	//
	...
	OrderedKeys() []string
	// FieldNames returns the TranslationData keys as a slice of FieldNames.
	...
	SetCreateDate(value dates.DateTime) TranslationData
	// UnsetCreateDate removes the value of the CreateDate field if it exists.
	// It returns this TranslationData so that calls can be chained.
	UnsetCreateDate() TranslationData
	...
	// It returns this TranslationData so that calls can be chained.
	SetCreateUID(value int64) TranslationData
	// UnsetCreateUID removes the value of the CreateUID field if it exists.
	// It returns this TranslationData so that calls can be chained.
	UnsetCreateUID() TranslationData
	...
	// It returns this TranslationData so that calls can be chained.
	SetDisplayName(value string) TranslationData
	// UnsetDisplayName removes the value of the DisplayName field if it exists.
	// It returns this TranslationData so that calls can be chained.
	UnsetDisplayName() TranslationData
	...
	// It returns this TranslationData so that calls can be chained.
	SetHexyaExternalID(value string) TranslationData
	// UnsetHexyaExternalID removes the value of the HexyaExternalID field if it exists.
	// It returns this TranslationData so that calls can be chained.
	UnsetHexyaExternalID() TranslationData
	...
	// It returns this TranslationData so that calls can be chained.
	SetHexyaVersion(value int) TranslationData
	// UnsetHexyaVersion removes the value of the HexyaVersion field if it exists.
	// It returns this TranslationData so that calls can be chained.
	UnsetHexyaVersion() TranslationData
	...
	// It returns this TranslationData so that calls can be chained.
	SetID(value int64) TranslationData
	// UnsetID removes the value of the ID field if it exists.
	// It returns this TranslationData so that calls can be chained.
	UnsetID() TranslationData
	...
	// It returns this TranslationData so that calls can be chained.
	SetLastUpdate(value dates.DateTime) TranslationData
	// UnsetLastUpdate removes the value of the LastUpdate field if it exists.
	// It returns this TranslationData so that calls can be chained.
	UnsetLastUpdate() TranslationData
	...
	// It returns this TranslationData so that calls can be chained.
	SetWriteDate(value dates.DateTime) TranslationData
	// UnsetWriteDate removes the value of the WriteDate field if it exists.
	// It returns this TranslationData so that calls can be chained.
	UnsetWriteDate() TranslationData
