...
type AutoVacuumSet interface {
	...
	ForceLoad(fields ...models.FieldName) AutoVacuumSet
	...
	AddDomainLimitOffset(domain domains.Domain, limit int, offset int, order string) AutoVacuumSet
	...
	Aggregates(fieldNames ...models.FieldName) []AutoVacuumGroupAggregateRow
	// Browse returns a new RecordSet with only the records with the given ids.
	// Note that this function is just a shorcut for Search on a list of ids.
	Browse(ids []int64) AutoVacuumSet
	...
	BrowseOne(id int64) AutoVacuumSet

	CartesianProduct(others ...AutoVacuumSet) []AutoVacuumSet
	...
	Copy(overrides AutoVacuumData) AutoVacuumSet

	CopyData(overrides AutoVacuumData) AutoVacuumData

	Create(data AutoVacuumData) AutoVacuumSet

	DefaultGet() AutoVacuumData
	...
	Equals(other AutoVacuumSet) bool
	...
	Filtered(test func(AutoVacuumSet) bool) AutoVacuumSet
	...
	Intersect(other AutoVacuumSet) AutoVacuumSet
	// Limit returns a new RecordSet with only the first 'limit' records.
	Limit(limit int) AutoVacuumSet
	...
	// model are retrieved.
	Load(fields ...models.FieldName) AutoVacuumSet
	...
	New(data AutoVacuumData) AutoVacuumSet
	...
	Offset(offset int) AutoVacuumSet
	...
	OrderBy(exprs ...string) AutoVacuumSet
	...
	Search(condition q.AutoVacuumCondition) AutoVacuumSet
	...
	SearchAll() AutoVacuumSet

	SearchByName(name string, op operator.Operator, additionalCond q.AutoVacuumCondition, limit int) AutoVacuumSet
	...
	Sorted(less func(AutoVacuumSet, AutoVacuumSet) bool) AutoVacuumSet
	...
	SortedByField(namer models.FieldName, reverse bool) AutoVacuumSet
	...
	Union(other AutoVacuumSet) AutoVacuumSet
	...
	WithContext(key string, value interface{}) AutoVacuumSet
	// WithEnv returns a copy of the current RecordSet with the given Environment.
	WithEnv(env models.Environment) AutoVacuumSet
	// WithNewContext returns a copy of the current RecordSet with its context
	// replaced by the given one.
	WithNewContext(context *types.Context) AutoVacuumSet

	Write(data AutoVacuumData) bool
...
type AutoVacuumData interface {
	...
	MergeWith(other AutoVacuumData)
	// Keys returns the AutoVacuumData keys as a slice of strings
	Keys() (res []string)
	// OrderedKeys returns the keys of this AutoVacuumData ordered.
	//
	...
	OrderedKeys() []string
	// FieldNames returns the AutoVacuumData keys as a slice of FieldNames.
