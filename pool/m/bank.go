...
type BankSet interface {
	...
	ForceLoad(fields ...models.FieldName) BankSet
	...
	AddDomainLimitOffset(domain domains.Domain, limit int, offset int, order string) BankSet
	...
	Aggregates(fieldNames ...models.FieldName) []BankGroupAggregateRow
	// Browse returns a new RecordSet with only the records with the given ids.
	// Note that this function is just a shorcut for Search on a list of ids.
	Browse(ids []int64) BankSet
	...
	BrowseOne(id int64) BankSet

	CartesianProduct(others ...BankSet) []BankSet
	...
	Copy(overrides BankData) BankSet

	CopyData(overrides BankData) BankData

	Create(data BankData) BankSet
	...
	Filtered(test func(BankSet) bool) BankSet
	...
	Intersect(other BankSet) BankSet
	// Limit returns a new RecordSet with only the first 'limit' records.
	Limit(limit int) BankSet
	...
	// model are retrieved.
	Load(fields ...models.FieldName) BankSet
	...
	Search(condition q.BankCondition) BankSet
	...
	SearchByName(name string, op operator.Operator, additionalCond q.BankCondition, limit int) BankSet
	...
	Sorted(less func(BankSet, BankSet) bool) BankSet
	...
	SortedByField(namer models.FieldName, reverse bool) BankSet
	...
	WithContext(key string, value interface{}) BankSet
	// WithEnv returns a copy of the current RecordSet with the given Environment.
	WithEnv(env models.Environment) BankSet
	// WithNewContext returns a copy of the current RecordSet with its context
	// replaced by the given one.
	WithNewContext(context *types.Context) BankSet

	Write(data BankData) bool
	...
	ModelData(fMap models.FieldMap) BankData
...
type BankData interface {
	...
	MergeWith(other BankData)
	// Keys returns the BankData keys as a slice of strings
	Keys() (res []string)
	// OrderedKeys returns the keys of this BankData ordered.
	//
	...
	OrderedKeys() []string
	// FieldNames returns the BankData keys as a slice of FieldNames.
	...
	CreateCountry(related CountryData) BankData
	...
	// It returns this BankData so that calls can be chained.
	SetEmail(value string) BankData
	...
	// It returns this BankData so that calls can be chained.
	SetPhone(value string) BankData
	...
	// It returns this BankData so that calls can be chained.
	SetState(value CountryStateSet) BankData
	...
	//
	// This method can be called multiple times to create multiple records
	CreateState(related CountryStateData) BankData
...
type BankGroupAggregateRow interface {
