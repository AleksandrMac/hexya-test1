...
type PartnerIndustrySet interface {
	...
	ForceLoad(fields ...models.FieldName) PartnerIndustrySet
	...
	AddDomainLimitOffset(domain domains.Domain, limit int, offset int, order string) PartnerIndustrySet
	...
	Aggregates(fieldNames ...models.FieldName) []PartnerIndustryGroupAggregateRow
	// Browse returns a new RecordSet with only the records with the given ids.
	// Note that this function is just a shorcut for Search on a list of ids.
	Browse(ids []int64) PartnerIndustrySet
	...
	BrowseOne(id int64) PartnerIndustrySet

	CartesianProduct(others ...PartnerIndustrySet) []PartnerIndustrySet
	...
	Copy(overrides PartnerIndustryData) PartnerIndustrySet

	CopyData(overrides PartnerIndustryData) PartnerIndustryData

	Create(data PartnerIndustryData) PartnerIndustrySet

	DefaultGet() PartnerIndustryData
	...
	Equals(other PartnerIndustrySet) bool
	...
	Filtered(test func(PartnerIndustrySet) bool) PartnerIndustrySet
	...
	Intersect(other PartnerIndustrySet) PartnerIndustrySet
	// Limit returns a new RecordSet with only the first 'limit' records.
	Limit(limit int) PartnerIndustrySet
	...
	// model are retrieved.
	Load(fields ...models.FieldName) PartnerIndustrySet
	...
	New(data PartnerIndustryData) PartnerIndustrySet
	...
	Offset(offset int) PartnerIndustrySet
	...
	OrderBy(exprs ...string) PartnerIndustrySet
	...
	Search(condition q.PartnerIndustryCondition) PartnerIndustrySet
	...
	SearchAll() PartnerIndustrySet

	SearchByName(name string, op operator.Operator, additionalCond q.PartnerIndustryCondition, limit int) PartnerIndustrySet
	...
	Sorted(less func(PartnerIndustrySet, PartnerIndustrySet) bool) PartnerIndustrySet
	...
	SortedByField(namer models.FieldName, reverse bool) PartnerIndustrySet
	...
	SortedDefault() PartnerIndustrySet
	...
	Subtract(other PartnerIndustrySet) PartnerIndustrySet
	// Sudo returns a new RecordSet with the given userID
	// or the superuser ID if not specified
	Sudo(userID ...int64) PartnerIndustrySet
	...
	Union(other PartnerIndustrySet) PartnerIndustrySet
	...
	WithContext(key string, value interface{}) PartnerIndustrySet
	// WithEnv returns a copy of the current RecordSet with the given Environment.
	WithEnv(env models.Environment) PartnerIndustrySet
	// WithNewContext returns a copy of the current RecordSet with its context
	// replaced by the given one.
	WithNewContext(context *types.Context) PartnerIndustrySet

	Write(data PartnerIndustryData) bool
...
type PartnerIndustryData interface {
	models.RecordData
	...
	MergeWith(other PartnerIndustryData)
	// Keys returns the PartnerIndustryData keys as a slice of strings
	Keys() (res []string)
	// OrderedKeys returns the keys of this PartnerIndustryData ordered.
	//
	...
	OrderedKeys() []string
	// FieldNames returns the PartnerIndustryData keys as a slice of FieldNames.
	...
	SetActive(value bool) PartnerIndustryData
	// UnsetActive removes the value of the Active field if it exists.
	// It returns this PartnerIndustryData so that calls can be chained.
	UnsetActive() PartnerIndustryData
	...
	// It returns this PartnerIndustryData so that calls can be chained.
	SetCreateDate(value dates.DateTime) PartnerIndustryData
	// UnsetCreateDate removes the value of the CreateDate field if it exists.
	// It returns this PartnerIndustryData so that calls can be chained.
	UnsetCreateDate() PartnerIndustryData
	...
	// It returns this PartnerIndustryData so that calls can be chained.
	SetCreateUID(value int64) PartnerIndustryData
	// UnsetCreateUID removes the value of the CreateUID field if it exists.
	// It returns this PartnerIndustryData so that calls can be chained.
	UnsetCreateUID() PartnerIndustryData
	...
	// It returns this PartnerIndustryData so that calls can be chained.
	SetDisplayName(value string) PartnerIndustryData
	// UnsetDisplayName removes the value of the DisplayName field if it exists.
	// It returns this PartnerIndustryData so that calls can be chained.
	UnsetDisplayName() PartnerIndustryData
	...
	// It returns this PartnerIndustryData so that calls can be chained.
	SetFullName(value string) PartnerIndustryData
	// UnsetFullName removes the value of the FullName field if it exists.
	// It returns this PartnerIndustryData so that calls can be chained.
	UnsetFullName() PartnerIndustryData
	...
	// It returns this PartnerIndustryData so that calls can be chained.
	SetHexyaExternalID(value string) PartnerIndustryData
	// UnsetHexyaExternalID removes the value of the HexyaExternalID field if it exists.
	// It returns this PartnerIndustryData so that calls can be chained.
	UnsetHexyaExternalID() PartnerIndustryData
	...
	// It returns this PartnerIndustryData so that calls can be chained.
	SetHexyaVersion(value int) PartnerIndustryData
	// UnsetHexyaVersion removes the value of the HexyaVersion field if it exists.
	// It returns this PartnerIndustryData so that calls can be chained.
	UnsetHexyaVersion() PartnerIndustryData
	...
	// It returns this PartnerIndustryData so that calls can be chained.
	SetID(value int64) PartnerIndustryData
	// UnsetID removes the value of the ID field if it exists.
	// It returns this PartnerIndustryData so that calls can be chained.
	UnsetID() PartnerIndustryData
	...
	// It returns this PartnerIndustryData so that calls can be chained.
	SetLastUpdate(value dates.DateTime) PartnerIndustryData
	// UnsetLastUpdate removes the value of the LastUpdate field if it exists.
	// It returns this PartnerIndustryData so that calls can be chained.
	UnsetLastUpdate() PartnerIndustryData
	...
	// It returns this PartnerIndustryData so that calls can be chained.
	SetName(value string) PartnerIndustryData
	// UnsetName removes the value of the Name field if it exists.
	// It returns this PartnerIndustryData so that calls can be chained.
	UnsetName() PartnerIndustryData
	...
	// It returns this PartnerIndustryData so that calls can be chained.
	SetWriteDate(value dates.DateTime) PartnerIndustryData
	// UnsetWriteDate removes the value of the WriteDate field if it exists.
	// It returns this PartnerIndustryData so that calls can be chained.
	UnsetWriteDate() PartnerIndustryData
