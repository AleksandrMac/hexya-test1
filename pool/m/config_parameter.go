...
type ConfigParameterSet interface {
	...
	ForceLoad(fields ...models.FieldName) ConfigParameterSet
	...
	AddDomainLimitOffset(domain domains.Domain, limit int, offset int, order string) ConfigParameterSet
	...
	Aggregates(fieldNames ...models.FieldName) []ConfigParameterGroupAggregateRow
	// Browse returns a new RecordSet with only the records with the given ids.
	// Note that this function is just a shorcut for Search on a list of ids.
	Browse(ids []int64) ConfigParameterSet
	...
	BrowseOne(id int64) ConfigParameterSet

	CartesianProduct(others ...ConfigParameterSet) []ConfigParameterSet
	...
	Copy(overrides ConfigParameterData) ConfigParameterSet

	CopyData(overrides ConfigParameterData) ConfigParameterData

	Create(data ConfigParameterData) ConfigParameterSet

	DefaultGet() ConfigParameterData
	...
	Equals(other ConfigParameterSet) bool
	...
	Filtered(test func(ConfigParameterSet) bool) ConfigParameterSet
	...
	Intersect(other ConfigParameterSet) ConfigParameterSet
	// Limit returns a new RecordSet with only the first 'limit' records.
	Limit(limit int) ConfigParameterSet
	// LimitToGroups limits the access to this key to the given list of groups
	LimitToGroups(groups GroupSet)
	...
	// model are retrieved.
	Load(fields ...models.FieldName) ConfigParameterSet
	...
	New(data ConfigParameterData) ConfigParameterSet
	...
	Offset(offset int) ConfigParameterSet
	...
	OrderBy(exprs ...string) ConfigParameterSet
	...
	Search(condition q.ConfigParameterCondition) ConfigParameterSet
	...
	SearchAll() ConfigParameterSet

	SearchByName(name string, op operator.Operator, additionalCond q.ConfigParameterCondition, limit int) ConfigParameterSet
	...
	SetParam(key string, value string) ConfigParameterSet

	Sorted(less func(ConfigParameterSet, ConfigParameterSet) bool) ConfigParameterSet
	...
	SortedByField(namer models.FieldName, reverse bool) ConfigParameterSet
	...
	SortedDefault() ConfigParameterSet
	...
	Subtract(other ConfigParameterSet) ConfigParameterSet
	// Sudo returns a new RecordSet with the given userID
	// or the superuser ID if not specified
	Sudo(userID ...int64) ConfigParameterSet
	...
	Union(other ConfigParameterSet) ConfigParameterSet
	...
	WithContext(key string, value interface{}) ConfigParameterSet
	// WithEnv returns a copy of the current RecordSet with the given Environment.
	WithEnv(env models.Environment) ConfigParameterSet
	// WithNewContext returns a copy of the current RecordSet with its context
	// replaced by the given one.
	WithNewContext(context *types.Context) ConfigParameterSet

	Write(data ConfigParameterData) bool
...
type ConfigParameterData interface {
	models.RecordData
	...
	MergeWith(other ConfigParameterData)
	// Keys returns the ConfigParameterData keys as a slice of strings
	Keys() (res []string)
	// OrderedKeys returns the keys of this ConfigParameterData ordered.
	//
	...
	OrderedKeys() []string
	// FieldNames returns the ConfigParameterData keys as a slice of FieldNames.
	...
	SetCreateDate(value dates.DateTime) ConfigParameterData
	// UnsetCreateDate removes the value of the CreateDate field if it exists.
	// It returns this ConfigParameterData so that calls can be chained.
	UnsetCreateDate() ConfigParameterData
	...
	// It returns this ConfigParameterData so that calls can be chained.
	SetCreateUID(value int64) ConfigParameterData
	// UnsetCreateUID removes the value of the CreateUID field if it exists.
	// It returns this ConfigParameterData so that calls can be chained.
	UnsetCreateUID() ConfigParameterData
	...
	// It returns this ConfigParameterData so that calls can be chained.
	SetDisplayName(value string) ConfigParameterData
	// UnsetDisplayName removes the value of the DisplayName field if it exists.
	// It returns this ConfigParameterData so that calls can be chained.
	UnsetDisplayName() ConfigParameterData
	...
	// It returns this ConfigParameterData so that calls can be chained.
	SetGroups(value GroupSet) ConfigParameterData
	// UnsetGroups removes the value of the Groups field if it exists.
	// It returns this ConfigParameterData so that calls can be chained.
	UnsetGroups() ConfigParameterData
	...
	CreateGroups(related GroupData) ConfigParameterData
	...
	// It returns this ConfigParameterData so that calls can be chained.
	SetHexyaExternalID(value string) ConfigParameterData
	// UnsetHexyaExternalID removes the value of the HexyaExternalID field if it exists.
	// It returns this ConfigParameterData so that calls can be chained.
	UnsetHexyaExternalID() ConfigParameterData
	...
	// It returns this ConfigParameterData so that calls can be chained.
	SetHexyaVersion(value int) ConfigParameterData
	// UnsetHexyaVersion removes the value of the HexyaVersion field if it exists.
	// It returns this ConfigParameterData so that calls can be chained.
	UnsetHexyaVersion() ConfigParameterData
	...
	// It returns this ConfigParameterData so that calls can be chained.
	SetID(value int64) ConfigParameterData
	// UnsetID removes the value of the ID field if it exists.
	// It returns this ConfigParameterData so that calls can be chained.
	UnsetID() ConfigParameterData
	...
	// It returns this ConfigParameterData so that calls can be chained.
	SetKey(value string) ConfigParameterData
	// UnsetKey removes the value of the Key field if it exists.
	// It returns this ConfigParameterData so that calls can be chained.
	UnsetKey() ConfigParameterData
	...
	// It returns this ConfigParameterData so that calls can be chained.
	SetLastUpdate(value dates.DateTime) ConfigParameterData
	// UnsetLastUpdate removes the value of the LastUpdate field if it exists.
	// It returns this ConfigParameterData so that calls can be chained.
	UnsetLastUpdate() ConfigParameterData
	...
	// It returns this ConfigParameterData so that calls can be chained.
	SetValue(value string) ConfigParameterData
	// UnsetValue removes the value of the Value field if it exists.
	// It returns this ConfigParameterData so that calls can be chained.
	UnsetValue() ConfigParameterData
	...
	// It returns this ConfigParameterData so that calls can be chained.
	SetWriteDate(value dates.DateTime) ConfigParameterData
	// UnsetWriteDate removes the value of the WriteDate field if it exists.
	// It returns this ConfigParameterData so that calls can be chained.
	UnsetWriteDate() ConfigParameterData
