...
type UserLogSet interface {
	...
	ForceLoad(fields ...models.FieldName) UserLogSet
	...
	AddDomainLimitOffset(domain domains.Domain, limit int, offset int, order string) UserLogSet
	...
	Aggregates(fieldNames ...models.FieldName) []UserLogGroupAggregateRow
	// Browse returns a new RecordSet with only the records with the given ids.
	// Note that this function is just a shorcut for Search on a list of ids.
	Browse(ids []int64) UserLogSet
	...
	BrowseOne(id int64) UserLogSet

	CartesianProduct(others ...UserLogSet) []UserLogSet
	...
	Copy(overrides UserLogData) UserLogSet

	CopyData(overrides UserLogData) UserLogData

	Create(data UserLogData) UserLogSet

	DefaultGet() UserLogData
	...
	Filtered(test func(UserLogSet) bool) UserLogSet
	...
	Intersect(other UserLogSet) UserLogSet
	// Limit returns a new RecordSet with only the first 'limit' records.
	Limit(limit int) UserLogSet
	...
	// model are retrieved.
	Load(fields ...models.FieldName) UserLogSet
	...
	New(data UserLogData) UserLogSet
	...
	OrderBy(exprs ...string) UserLogSet
	...
	Search(condition q.UserLogCondition) UserLogSet
	...
	SearchAll() UserLogSet

	SearchByName(name string, op operator.Operator, additionalCond q.UserLogCondition, limit int) UserLogSet
	...
	Sorted(less func(UserLogSet, UserLogSet) bool) UserLogSet
	...
	SortedByField(namer models.FieldName, reverse bool) UserLogSet
	...
	Union(other UserLogSet) UserLogSet
	...
	WithContext(key string, value interface{}) UserLogSet
	// WithEnv returns a copy of the current RecordSet with the given Environment.
	WithEnv(env models.Environment) UserLogSet
	// WithNewContext returns a copy of the current RecordSet with its context
	// replaced by the given one.
	WithNewContext(context *types.Context) UserLogSet

	Write(data UserLogData) bool
	...
	ModelData(fMap models.FieldMap) UserLogData
...
type UserLogData interface {
	...
	MergeWith(other UserLogData)
	// Keys returns the UserLogData keys as a slice of strings
	Keys() (res []string)
	// OrderedKeys returns the keys of this UserLogData ordered.
	//
	...
	OrderedKeys() []string
	// FieldNames returns the UserLogData keys as a slice of FieldNames.
	...
	SetCreateDate(value dates.DateTime) UserLogData
	// UnsetCreateDate removes the value of the CreateDate field if it exists.
	// It returns this UserLogData so that calls can be chained.
	UnsetCreateDate() UserLogData
	...
	// It returns this UserLogData so that calls can be chained.
	SetLastUpdate(value dates.DateTime) UserLogData
	// UnsetLastUpdate removes the value of the LastUpdate field if it exists.
	// It returns this UserLogData so that calls can be chained.
	UnsetLastUpdate() UserLogData
	...
	// It returns this UserLogData so that calls can be chained.
	SetWriteDate(value dates.DateTime) UserLogData
	// UnsetWriteDate removes the value of the WriteDate field if it exists.
	// It returns this UserLogData so that calls can be chained.
	UnsetWriteDate() UserLogData
