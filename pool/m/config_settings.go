...
type ConfigSettingsSet interface {
	...
	ForceLoad(fields ...models.FieldName) ConfigSettingsSet
	...
	AddDomainLimitOffset(domain domains.Domain, limit int, offset int, order string) ConfigSettingsSet
	...
	Aggregates(fieldNames ...models.FieldName) []ConfigSettingsGroupAggregateRow
	// Browse returns a new RecordSet with only the records with the given ids.
	// Note that this function is just a shorcut for Search on a list of ids.
	Browse(ids []int64) ConfigSettingsSet
	...
	BrowseOne(id int64) ConfigSettingsSet
	// Cancel ignores the current record, and send the action to reopen the view
	Cancel() *actions.Action

	CartesianProduct(others ...ConfigSettingsSet) []ConfigSettingsSet
	...
	ConfigFields() basetypes.ConfigFieldsMap

	Copy(overrides ConfigSettingsData) ConfigSettingsSet

	CopyData(overrides ConfigSettingsData) ConfigSettingsData

	Create(data ConfigSettingsData) ConfigSettingsSet

	DefaultGet() ConfigSettingsData
	...
	Equals(other ConfigSettingsSet) bool
	...
	Filtered(test func(ConfigSettingsSet) bool) ConfigSettingsSet
	...
	GetRecord(externalID string) ConfigSettingsSet
	...
	GetValues() ConfigSettingsData
	// GroupBy returns a new RecordSet grouped with the given GROUP BY expressions.
	GroupBy(exprs ...models.FieldName) ConfigSettingsSet
	...
	Intersect(other ConfigSettingsSet) ConfigSettingsSet
	// Limit returns a new RecordSet with only the first 'limit' records.
	Limit(limit int) ConfigSettingsSet
	...
	// model are retrieved.
	Load(fields ...models.FieldName) ConfigSettingsSet
	...
	New(data ConfigSettingsData) ConfigSettingsSet
	...
	Offset(offset int) ConfigSettingsSet
	...
	OrderBy(exprs ...string) ConfigSettingsSet
	...
	Search(condition q.ConfigSettingsCondition) ConfigSettingsSet
	...
	SearchAll() ConfigSettingsSet

	SearchByName(name string, op operator.Operator, additionalCond q.ConfigSettingsCondition, limit int) ConfigSettingsSet
	...
	Sorted(less func(ConfigSettingsSet, ConfigSettingsSet) bool) ConfigSettingsSet
	...
	SortedByField(namer models.FieldName, reverse bool) ConfigSettingsSet
	...
	SortedDefault() ConfigSettingsSet
	...
	Union(other ConfigSettingsSet) ConfigSettingsSet
	...
	WithContext(key string, value interface{}) ConfigSettingsSet
	// WithEnv returns a copy of the current RecordSet with the given Environment.
	WithEnv(env models.Environment) ConfigSettingsSet
	// WithNewContext returns a copy of the current RecordSet with its context
	// replaced by the given one.
	WithNewContext(context *types.Context) ConfigSettingsSet

	Write(data ConfigSettingsData) bool
...
type ConfigSettingsData interface {
	models.RecordData
	...
	MergeWith(other ConfigSettingsData)
	// Keys returns the ConfigSettingsData keys as a slice of strings
	Keys() (res []string)
	// OrderedKeys returns the keys of this ConfigSettingsData ordered.
	//
	...
	OrderedKeys() []string
	// FieldNames returns the ConfigSettingsData keys as a slice of FieldNames.
	...
	SetCreateDate(value dates.DateTime) ConfigSettingsData
	// UnsetCreateDate removes the value of the CreateDate field if it exists.
	// It returns this ConfigSettingsData so that calls can be chained.
	UnsetCreateDate() ConfigSettingsData
	...
	// It returns this ConfigSettingsData so that calls can be chained.
	SetCreateUID(value int64) ConfigSettingsData
	// UnsetCreateUID removes the value of the CreateUID field if it exists.
	// It returns this ConfigSettingsData so that calls can be chained.
	UnsetCreateUID() ConfigSettingsData
	...
	// It returns this ConfigSettingsData so that calls can be chained.
	SetDisplayName(value string) ConfigSettingsData
	// UnsetDisplayName removes the value of the DisplayName field if it exists.
	// It returns this ConfigSettingsData so that calls can be chained.
	UnsetDisplayName() ConfigSettingsData
	...
	// It returns this ConfigSettingsData so that calls can be chained.
	SetID(value int64) ConfigSettingsData
	// UnsetID removes the value of the ID field if it exists.
	// It returns this ConfigSettingsData so that calls can be chained.
	UnsetID() ConfigSettingsData
	...
	// It returns this ConfigSettingsData so that calls can be chained.
	SetLastUpdate(value dates.DateTime) ConfigSettingsData
	// UnsetLastUpdate removes the value of the LastUpdate field if it exists.
	// It returns this ConfigSettingsData so that calls can be chained.
	UnsetLastUpdate() ConfigSettingsData
	...
	// It returns this ConfigSettingsData so that calls can be chained.
	SetWriteDate(value dates.DateTime) ConfigSettingsData
	// UnsetWriteDate removes the value of the WriteDate field if it exists.
	// It returns this ConfigSettingsData so that calls can be chained.
	UnsetWriteDate() ConfigSettingsData
