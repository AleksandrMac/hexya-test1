...
// GroupID returns a pointer to the GroupID Field.
func (c FieldsCollection) GroupID() *models.Field {
	return c.MustGet("GroupID")
}
...
// pActionArchive holds the metadata of the Group.ActionArchive() method
type pActionArchive struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pActionArchive) Extend(fnct func(m.GroupSet)) pActionArchive {
...
// pActionUnarchive holds the metadata of the Group.ActionUnarchive() method
type pActionUnarchive struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pActionUnarchive) Extend(fnct func(m.GroupSet)) pActionUnarchive {
...
// pAddDomainLimitOffset holds the metadata of the Group.AddDomainLimitOffset() method
type pAddDomainLimitOffset struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pAddDomainLimitOffset) Extend(fnct func(m.GroupSet, domains.Domain, int, int, string) m.GroupSet) pAddDomainLimitOffset {
...
// pAddModifiers holds the metadata of the Group.AddModifiers() method
type pAddModifiers struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pAddModifiers) Extend(fnct func(m.GroupSet, *etree.Document, map[string]*models.FieldInfo)) pAddModifiers {
...
// pAddNamesToRelations holds the metadata of the Group.AddNamesToRelations() method
type pAddNamesToRelations struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pAddNamesToRelations) Extend(fnct func(m.GroupSet, models.RecordData, map[string]*models.FieldInfo) models.RecordData) pAddNamesToRelations {
...
// pAggregates holds the metadata of the Group.Aggregates() method
type pAggregates struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pAggregates) Extend(fnct func(m.GroupSet, ...models.FieldName) []m.GroupGroupAggregateRow) pAggregates {
	return pAggregates{
		Method: m.Method.Extend(fnct),
	}
}
...
// pBrowse holds the metadata of the Group.Browse() method
type pBrowse struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pBrowse) Extend(fnct func(m.GroupSet, []int64) m.GroupSet) pBrowse {
	return pBrowse{
		Method: m.Method.Extend(fnct),
	}
}
...
// pBrowseOne holds the metadata of the Group.BrowseOne() method
type pBrowseOne struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pBrowseOne) Extend(fnct func(m.GroupSet, int64) m.GroupSet) pBrowseOne {
	return pBrowseOne{
		Method: m.Method.Extend(fnct),
	}
}
...
// pCartesianProduct holds the metadata of the Group.CartesianProduct() method
type pCartesianProduct struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCartesianProduct) Extend(fnct func(m.GroupSet, ...m.GroupSet) []m.GroupSet) pCartesianProduct {
...
// pCheckAccessRights holds the metadata of the Group.CheckAccessRights() method
type pCheckAccessRights struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCheckAccessRights) Extend(fnct func(m.GroupSet, webtypes.CheckAccessRightsArgs) bool) pCheckAccessRights {
...
// pCheckExecutionPermission holds the metadata of the Group.CheckExecutionPermission() method
type pCheckExecutionPermission struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCheckExecutionPermission) Extend(fnct func(m.GroupSet, *models.Method, ...bool) bool) pCheckExecutionPermission {
...
// pCheckRecursion holds the metadata of the Group.CheckRecursion() method
type pCheckRecursion struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCheckRecursion) Extend(fnct func(m.GroupSet) bool) pCheckRecursion {
...
// pComputeDisplayName holds the metadata of the Group.ComputeDisplayName() method
type pComputeDisplayName struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pComputeDisplayName) Extend(fnct func(m.GroupSet) *models.ModelData) pComputeDisplayName {
...
// pComputeLastUpdate holds the metadata of the Group.ComputeLastUpdate() method
type pComputeLastUpdate struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pComputeLastUpdate) Extend(fnct func(m.GroupSet) *models.ModelData) pComputeLastUpdate {
...
// pCopy holds the metadata of the Group.Copy() method
type pCopy struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCopy) Extend(fnct func(m.GroupSet, m.GroupData) m.GroupSet) pCopy {
	return pCopy{
		Method: m.Method.Extend(fnct),
	}
}
...
// pCopyData holds the metadata of the Group.CopyData() method
type pCopyData struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCopyData) Extend(fnct func(m.GroupSet, m.GroupData) m.GroupData) pCopyData {
	return pCopyData{
		Method: m.Method.Extend(fnct),
	}
}
...
// pCreate holds the metadata of the Group.Create() method
type pCreate struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCreate) Extend(fnct func(m.GroupSet, m.GroupData) m.GroupSet) pCreate {
	return pCreate{
		Method: m.Method.Extend(fnct),
	}
}
...
// pDefaultGet holds the metadata of the Group.DefaultGet() method
type pDefaultGet struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pDefaultGet) Extend(fnct func(m.GroupSet) m.GroupData) pDefaultGet {
	return pDefaultGet{
		Method: m.Method.Extend(fnct),
	}
}
...
// pEnqueue holds the metadata of the Group.Enqueue() method
type pEnqueue struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pEnqueue) Extend(fnct func(m.GroupSet, string, models.Methoder, ...interface{}) m.QueueJobSet) pEnqueue {
	return pEnqueue{
		Method: m.Method.Extend(fnct),
	}
}
...
// pEquals holds the metadata of the Group.Equals() method
type pEquals struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pEquals) Extend(fnct func(m.GroupSet, m.GroupSet) bool) pEquals {
	return pEquals{
		Method: m.Method.Extend(fnct),
	}
}
...
// pExecuteO2MActions holds the metadata of the Group.ExecuteO2MActions() method
type pExecuteO2MActions struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pExecuteO2MActions) Extend(fnct func(m.GroupSet, models.FieldName, *models.FieldInfo, interface{}) interface{}) pExecuteO2MActions {
...
// pFetch holds the metadata of the Group.Fetch() method
type pFetch struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFetch) Extend(fnct func(m.GroupSet) m.GroupSet) pFetch {
	return pFetch{
		Method: m.Method.Extend(fnct),
	}
}
...
// pFieldGet holds the metadata of the Group.FieldGet() method
type pFieldGet struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFieldGet) Extend(fnct func(m.GroupSet, models.FieldName) *models.FieldInfo) pFieldGet {
	return pFieldGet{
		Method: m.Method.Extend(fnct),
	}
}
...
// pFieldsGet holds the metadata of the Group.FieldsGet() method
type pFieldsGet struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFieldsGet) Extend(fnct func(m.GroupSet, models.FieldsGetArgs) map[string]*models.FieldInfo) pFieldsGet {
	return pFieldsGet{
		Method: m.Method.Extend(fnct),
	}
}
...
// pFieldsViewGet holds the metadata of the Group.FieldsViewGet() method
type pFieldsViewGet struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFieldsViewGet) Extend(fnct func(m.GroupSet, webtypes.FieldsViewGetParams) *webtypes.FieldsViewData) pFieldsViewGet {
...
// pFiltered holds the metadata of the Group.Filtered() method
type pFiltered struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFiltered) Extend(fnct func(m.GroupSet, func(m.GroupSet) bool) m.GroupSet) pFiltered {
	return pFiltered{
		Method: m.Method.Extend(fnct),
	}
}
...
// pFormatRelationFields holds the metadata of the Group.FormatRelationFields() method
type pFormatRelationFields struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFormatRelationFields) Extend(fnct func(m.GroupSet, models.RecordData, map[string]*models.FieldInfo) models.RecordData) pFormatRelationFields {
...
// pGetFormviewAction holds the metadata of the Group.GetFormviewAction() method
type pGetFormviewAction struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pGetFormviewAction) Extend(fnct func(m.GroupSet) *actions.Action) pGetFormviewAction {
...
// pGetFormviewId holds the metadata of the Group.GetFormviewId() method
type pGetFormviewId struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pGetFormviewId) Extend(fnct func(m.GroupSet) string) pGetFormviewId {
...
// pGetRecord holds the metadata of the Group.GetRecord() method
type pGetRecord struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pGetRecord) Extend(fnct func(m.GroupSet, string) m.GroupSet) pGetRecord {
	return pGetRecord{
		Method: m.Method.Extend(fnct),
	}
}
...
// pGetToolbar holds the metadata of the Group.GetToolbar() method
type pGetToolbar struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pGetToolbar) Extend(fnct func(m.GroupSet) webtypes.Toolbar) pGetToolbar {
	return pGetToolbar{
		Method: m.Method.Extend(fnct),
	}
}
...
// pGroupBy holds the metadata of the Group.GroupBy() method
type pGroupBy struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pGroupBy) Extend(fnct func(m.GroupSet, ...models.FieldName) m.GroupSet) pGroupBy {
	return pGroupBy{
		Method: m.Method.Extend(fnct),
	}
}
...
// pIntersect holds the metadata of the Group.Intersect() method
type pIntersect struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pIntersect) Extend(fnct func(m.GroupSet, m.GroupSet) m.GroupSet) pIntersect {
	return pIntersect{
		Method: m.Method.Extend(fnct),
	}
}
...
// pLimit holds the metadata of the Group.Limit() method
type pLimit struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pLimit) Extend(fnct func(m.GroupSet, int) m.GroupSet) pLimit {
	return pLimit{
		Method: m.Method.Extend(fnct),
	}
}
...
// pLoad holds the metadata of the Group.Load() method
type pLoad struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pLoad) Extend(fnct func(m.GroupSet, ...models.FieldName) m.GroupSet) pLoad {
	return pLoad{
		Method: m.Method.Extend(fnct),
	}
}
...
// pLoadViews holds the metadata of the Group.LoadViews() method
type pLoadViews struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pLoadViews) Extend(fnct func(m.GroupSet, webtypes.LoadViewsArgs) *webtypes.LoadViewsData) pLoadViews {
	return pLoadViews{
		Method: m.Method.Extend(fnct),
	}
}
...
// pManageGroupsOnFields holds the metadata of the Group.ManageGroupsOnFields() method
type pManageGroupsOnFields struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pManageGroupsOnFields) Extend(fnct func(m.GroupSet, *etree.Document, map[string]*models.FieldInfo)) pManageGroupsOnFields {
...
// pNameGet holds the metadata of the Group.NameGet() method
type pNameGet struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pNameGet) Extend(fnct func(m.GroupSet) string) pNameGet {
	return pNameGet{
		Method: m.Method.Extend(fnct),
	}
}
...
// pNameSearch holds the metadata of the Group.NameSearch() method
type pNameSearch struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pNameSearch) Extend(fnct func(m.GroupSet, webtypes.NameSearchParams) []webtypes.RecordIDWithName) pNameSearch {
	return pNameSearch{
		Method: m.Method.Extend(fnct),
	}
}
...
// pNew holds the metadata of the Group.New() method
type pNew struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pNew) Extend(fnct func(m.GroupSet, m.GroupData) m.GroupSet) pNew {
	return pNew{
		Method: m.Method.Extend(fnct),
	}
}
...
// pNormalizeM2MData holds the metadata of the Group.NormalizeM2MData() method
type pNormalizeM2MData struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pNormalizeM2MData) Extend(fnct func(m.GroupSet, models.FieldName, *models.FieldInfo, interface{}) interface{}) pNormalizeM2MData {
...
// pOffset holds the metadata of the Group.Offset() method
type pOffset struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pOffset) Extend(fnct func(m.GroupSet, int) m.GroupSet) pOffset {
	return pOffset{
		Method: m.Method.Extend(fnct),
	}
}
...
// pOnchange holds the metadata of the Group.Onchange() method
type pOnchange struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pOnchange) Extend(fnct func(m.GroupSet, models.OnchangeParams) models.OnchangeResult) pOnchange {
	return pOnchange{
		Method: m.Method.Extend(fnct),
	}
}
...
// pOrderBy holds the metadata of the Group.OrderBy() method
type pOrderBy struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pOrderBy) Extend(fnct func(m.GroupSet, ...string) m.GroupSet) pOrderBy {
	return pOrderBy{
		Method: m.Method.Extend(fnct),
	}
}
...
// pPostProcessCreateValues holds the metadata of the Group.PostProcessCreateValues() method
type pPostProcessCreateValues struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pPostProcessCreateValues) Extend(fnct func(m.GroupSet, models.RecordData)) pPostProcessCreateValues {
...
// pPostProcessFilters holds the metadata of the Group.PostProcessFilters() method
type pPostProcessFilters struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pPostProcessFilters) Extend(fnct func(m.GroupSet, map[models.FieldName]models.Conditioner) map[string][]interface{}) pPostProcessFilters {
...
// pProcessCreateValues holds the metadata of the Group.ProcessCreateValues() method
type pProcessCreateValues struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pProcessCreateValues) Extend(fnct func(m.GroupSet, models.RecordData) (models.RecordData, models.RecordData)) pProcessCreateValues {
...
// pProcessElementAttrs holds the metadata of the Group.ProcessElementAttrs() method
type pProcessElementAttrs struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pProcessElementAttrs) Extend(fnct func(m.GroupSet, *etree.Element, map[string]*models.FieldInfo) map[string]interface{}) pProcessElementAttrs {
...
// pProcessFieldElementModifiers holds the metadata of the Group.ProcessFieldElementModifiers() method
type pProcessFieldElementModifiers struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pProcessFieldElementModifiers) Extend(fnct func(m.GroupSet, *etree.Element, map[string]*models.FieldInfo, map[string]interface{}) map[string]interface{}) pProcessFieldElementModifiers {
...
// pProcessView holds the metadata of the Group.ProcessView() method
type pProcessView struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pProcessView) Extend(fnct func(m.GroupSet, *etree.Document, map[string]*models.FieldInfo) string) pProcessView {
	return pProcessView{
		Method: m.Method.Extend(fnct),
	}
}
...
// pProcessWriteValues holds the metadata of the Group.ProcessWriteValues() method
type pProcessWriteValues struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pProcessWriteValues) Extend(fnct func(m.GroupSet, models.RecordData) models.RecordData) pProcessWriteValues {
...
// pRead holds the metadata of the Group.Read() method
type pRead struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pRead) Extend(fnct func(m.GroupSet, models.FieldNames) []models.RecordData) pRead {
	return pRead{
		Method: m.Method.Extend(fnct),
	}
}
...
// pReadGroup holds the metadata of the Group.ReadGroup() method
type pReadGroup struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pReadGroup) Extend(fnct func(m.GroupSet, webtypes.ReadGroupParams) []models.FieldMap) pReadGroup {
	return pReadGroup{
		Method: m.Method.Extend(fnct),
	}
}
...
// pReloadGroups holds the metadata of the Group.ReloadGroups() method
type pReloadGroups struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pReloadGroups) Extend(fnct func(m.GroupSet)) pReloadGroups {
...
// Underlying returns a pointer to the underlying Method data object.
func (m pReloadGroups) Underlying() *models.Method {
	return m.Method
}

var _ models.Methoder = pReloadGroups{}

// ReloadGroups returns a pointer to the ReloadGroups Method.
func (c MethodsCollection) ReloadGroups() pReloadGroups {
	return pReloadGroups{
		Method: c.MustGet("ReloadGroups"),
	}
}

// pSQLFromCondition holds the metadata of the Group.SQLFromCondition() method
type pSQLFromCondition struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSQLFromCondition) Extend(fnct func(m.GroupSet, *models.Condition) (string, models.SQLParams)) pSQLFromCondition {
...
// pSearch holds the metadata of the Group.Search() method
type pSearch struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearch) Extend(fnct func(m.GroupSet, q.GroupCondition) m.GroupSet) pSearch {
	return pSearch{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSearchAll holds the metadata of the Group.SearchAll() method
type pSearchAll struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearchAll) Extend(fnct func(m.GroupSet) m.GroupSet) pSearchAll {
	return pSearchAll{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSearchByName holds the metadata of the Group.SearchByName() method
type pSearchByName struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearchByName) Extend(fnct func(m.GroupSet, string, operator.Operator, q.GroupCondition, int) m.GroupSet) pSearchByName {
...
// pSearchCount holds the metadata of the Group.SearchCount() method
type pSearchCount struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearchCount) Extend(fnct func(m.GroupSet) int) pSearchCount {
	return pSearchCount{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSearchDomain holds the metadata of the Group.SearchDomain() method
type pSearchDomain struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearchDomain) Extend(fnct func(m.GroupSet, domains.Domain) m.CommonMixinSet) pSearchDomain {
...
// pSearchRead holds the metadata of the Group.SearchRead() method
type pSearchRead struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearchRead) Extend(fnct func(m.GroupSet, webtypes.SearchParams) []models.RecordData) pSearchRead {
	return pSearchRead{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSorted holds the metadata of the Group.Sorted() method
type pSorted struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSorted) Extend(fnct func(m.GroupSet, func(m.GroupSet, m.GroupSet) bool) m.GroupSet) pSorted {
	return pSorted{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSortedByField holds the metadata of the Group.SortedByField() method
type pSortedByField struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSortedByField) Extend(fnct func(m.GroupSet, models.FieldName, bool) m.GroupSet) pSortedByField {
...
// pSortedDefault holds the metadata of the Group.SortedDefault() method
type pSortedDefault struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSortedDefault) Extend(fnct func(m.GroupSet) m.GroupSet) pSortedDefault {
...
// pSubtract holds the metadata of the Group.Subtract() method
type pSubtract struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSubtract) Extend(fnct func(m.GroupSet, m.GroupSet) m.GroupSet) pSubtract {
	return pSubtract{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSudo holds the metadata of the Group.Sudo() method
type pSudo struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSudo) Extend(fnct func(m.GroupSet, ...int64) m.GroupSet) pSudo {
	return pSudo{
		Method: m.Method.Extend(fnct),
	}
}
...
// pToggleActive holds the metadata of the Group.ToggleActive() method
type pToggleActive struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pToggleActive) Extend(fnct func(m.GroupSet)) pToggleActive {
...
// pUnion holds the metadata of the Group.Union() method
type pUnion struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pUnion) Extend(fnct func(m.GroupSet, m.GroupSet) m.GroupSet) pUnion {
	return pUnion{
		Method: m.Method.Extend(fnct),
	}
}
...
// pUnlink holds the metadata of the Group.Unlink() method
type pUnlink struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pUnlink) Extend(fnct func(m.GroupSet) int64) pUnlink {
	return pUnlink{
		Method: m.Method.Extend(fnct),
	}
}
...
// pWebReadGroup holds the metadata of the Group.WebReadGroup() method
type pWebReadGroup struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWebReadGroup) Extend(fnct func(m.GroupSet, webtypes.WebReadGroupParams) webtypes.WebReadGroupResult) pWebReadGroup {
...
// pWebReadGroupPrivate holds the metadata of the Group.WebReadGroupPrivate() method
type pWebReadGroupPrivate struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWebReadGroupPrivate) Extend(fnct func(m.GroupSet, webtypes.WebReadGroupParams) []models.FieldMap) pWebReadGroupPrivate {
...
// pWebSearchRead holds the metadata of the Group.WebSearchRead() method
type pWebSearchRead struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWebSearchRead) Extend(fnct func(m.GroupSet, webtypes.SearchParams) webtypes.SearchReadResult) pWebSearchRead {
...
// pWithContext holds the metadata of the Group.WithContext() method
type pWithContext struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWithContext) Extend(fnct func(m.GroupSet, string, interface{}) m.GroupSet) pWithContext {
	return pWithContext{
		Method: m.Method.Extend(fnct),
	}
}
...
// pWithEnv holds the metadata of the Group.WithEnv() method
type pWithEnv struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWithEnv) Extend(fnct func(m.GroupSet, models.Environment) m.GroupSet) pWithEnv {
	return pWithEnv{
		Method: m.Method.Extend(fnct),
	}
}
...
// pWithNewContext holds the metadata of the Group.WithNewContext() method
type pWithNewContext struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWithNewContext) Extend(fnct func(m.GroupSet, *types.Context) m.GroupSet) pWithNewContext {
...
// pWrite holds the metadata of the Group.Write() method
type pWrite struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWrite) Extend(fnct func(m.GroupSet, m.GroupData) bool) pWrite {
	return pWrite{
		Method: m.Method.Extend(fnct),
	}
}
...
func (d GroupData) Set(field models.FieldName, value interface{}) m.GroupData {
	return &GroupData{
...
func (d GroupData) Unset(field models.FieldName) m.GroupData {
	return &GroupData{
...
func (d GroupData) Copy() m.GroupData {
	return &GroupData{
		d.ModelData.Copy(),
	}
}
...
func (d GroupData) MergeWith(other m.GroupData) {
...
func (d GroupData) CreateDate() dates.DateTime {
...
func (d GroupData) HasCreateDate() bool {
...
func (d GroupData) SetCreateDate(value dates.DateTime) m.GroupData {
...
// It returns this GroupData so that calls can be chained.
func (d GroupData) UnsetCreateDate() m.GroupData {
...
// the Go zero value for the type is returned.
func (d GroupData) CreateUID() int64 {
...
func (d GroupData) HasCreateUID() bool {
...
// It returns this GroupData so that calls can be chained.
func (d GroupData) SetCreateUID(value int64) m.GroupData {
...
// It returns this GroupData so that calls can be chained.
func (d GroupData) UnsetCreateUID() m.GroupData {
...
// the Go zero value for the type is returned.
func (d GroupData) DisplayName() string {
...
func (d GroupData) HasDisplayName() bool {
...
// It returns this GroupData so that calls can be chained.
func (d GroupData) SetDisplayName(value string) m.GroupData {
...
// It returns this GroupData so that calls can be chained.
func (d GroupData) UnsetDisplayName() m.GroupData {
...
// the Go zero value for the type is returned.
func (d GroupData) GroupID() string {
	val := d.ModelData.Get(models.NewFieldName("GroupID", "group_id"))
	if !d.Has(models.NewFieldName("GroupID", "group_id")) {
		return *new(string)
	}
	return val.(string)
}
...
func (d GroupData) HasGroupID() bool {
	return d.ModelData.Has(models.NewFieldName("GroupID", "group_id"))
}

// SetGroupID sets the GroupID field with the given value.
// It returns this GroupData so that calls can be chained.
func (d GroupData) SetGroupID(value string) m.GroupData {
	d.ModelData.Set(models.NewFieldName("GroupID", "group_id"), value)
	return d
}

// UnsetGroupID removes the value of the GroupID field if it exists.
// It returns this GroupData so that calls can be chained.
func (d GroupData) UnsetGroupID() m.GroupData {
	d.ModelData.Unset(models.NewFieldName("GroupID", "group_id"))
	return d
}
...
// the Go zero value for the type is returned.
func (d GroupData) HexyaExternalID() string {
...
func (d GroupData) HasHexyaExternalID() bool {
...
// It returns this GroupData so that calls can be chained.
func (d GroupData) SetHexyaExternalID(value string) m.GroupData {
...
// It returns this GroupData so that calls can be chained.
func (d GroupData) UnsetHexyaExternalID() m.GroupData {
...
// the Go zero value for the type is returned.
func (d GroupData) HexyaVersion() int {
...
func (d GroupData) HasHexyaVersion() bool {
...
// It returns this GroupData so that calls can be chained.
func (d GroupData) SetHexyaVersion(value int) m.GroupData {
...
// It returns this GroupData so that calls can be chained.
func (d GroupData) UnsetHexyaVersion() m.GroupData {
...
// It returns this GroupData so that calls can be chained.
func (d GroupData) UnsetID() m.GroupData {
...
// the Go zero value for the type is returned.
func (d GroupData) LastUpdate() dates.DateTime {
...
func (d GroupData) HasLastUpdate() bool {
...
// It returns this GroupData so that calls can be chained.
func (d GroupData) SetLastUpdate(value dates.DateTime) m.GroupData {
...
// It returns this GroupData so that calls can be chained.
func (d GroupData) UnsetLastUpdate() m.GroupData {
...
// It returns this GroupData so that calls can be chained.
func (d GroupData) UnsetName() m.GroupData {
...
// the Go zero value for the type is returned.
func (d GroupData) WriteDate() dates.DateTime {
...
func (d GroupData) HasWriteDate() bool {
...
// It returns this GroupData so that calls can be chained.
func (d GroupData) SetWriteDate(value dates.DateTime) m.GroupData {
...
// It returns this GroupData so that calls can be chained.
func (d GroupData) UnsetWriteDate() m.GroupData {
...
// the Go zero value for the type is returned.
func (d GroupData) WriteUID() int64 {
...
// It returns this GroupData so that calls can be chained.
func (d GroupData) UnsetWriteUID() m.GroupData {
	d.ModelData.Unset(models.NewFieldName("WriteUID", "write_uid"))
	return d
}

var _ m.GroupData = new(GroupData)
var _ m.GroupData = GroupData{}
...
type GroupGroupAggregateRow struct {
	values    m.GroupData
	count     int
...
func (a GroupGroupAggregateRow) Values() m.GroupData {
	return a.values
}

// Count returns the number of lines aggregated into this one
func (a GroupGroupAggregateRow) Count() int {
	return a.count
}

// Condition can be used to query the aggregated rows separately if needed
func (a GroupGroupAggregateRow) Condition() q.GroupCondition {
	return a.condition
}
...
func (s GroupSet) ForceLoad(fields ...models.FieldName) m.GroupSet {
...
// RecordSets
func (s GroupSet) Records() []m.GroupSet {
	recs := s.RecordCollection.Records()
	res := make([]m.GroupSet, len(recs))
	for i, rec := range recs {
		res[i] = rec.Wrap("Group").(m.GroupSet)
	}
	return res
}

// CartesianProduct returns the cartesian product of this GroupSet with others.
func (s GroupSet) CartesianProduct(others ...m.GroupSet) []m.GroupSet {
...
func (s GroupSet) First() m.GroupData {
	return &GroupData{
...
func (s GroupSet) All() []m.GroupData {
	allSlice := s.RecordCollection.All()
	res := make([]m.GroupData, len(allSlice))
...
// Sorted returns a new GroupSet sorted according to the given less function.
//
// The less function should return true if rs1 < rs2
func (s GroupSet) Sorted(less func(rs1, rs2 m.GroupSet) bool) m.GroupSet {
	res := s.RecordCollection.Sorted(func(rc1 models.RecordSet, rc2 models.RecordSet) bool {
		return less(GroupSet{RecordCollection: rc1.Collection()}, GroupSet{RecordCollection: rc2.Collection()})
	})
	return res.Wrap("Group").(m.GroupSet)
}

// Filtered returns a new GroupSet with only the elements of this record set
// for which test is true.
//
// Note that if this GroupSet is not fully loaded, this function will call the database
...
func (s GroupSet) Filtered(test func(rs m.GroupSet) bool) m.GroupSet {
	res := s.RecordCollection.Filtered(func(rc models.RecordSet) bool {
		return test(GroupSet{RecordCollection: rc.Collection()})
	})
	return res.Wrap("Group").(m.GroupSet)
}
...
func (s GroupSet) CreateDate() dates.DateTime {
...
func (s GroupSet) SetCreateDate(value dates.DateTime) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s GroupSet) CreateUID() int64 {
...
func (s GroupSet) SetCreateUID(value int64) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s GroupSet) DisplayName() string {
...
func (s GroupSet) SetDisplayName(value string) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s GroupSet) GroupID() string {
	res, _ := s.RecordCollection.Get(models.NewFieldName("GroupID", "group_id")).(string)
	return res
}
...
func (s GroupSet) SetGroupID(value string) {
	s.RecordCollection.Set(models.NewFieldName("GroupID", "group_id"), value)
}

// HexyaExternalID is a getter for the value of the "HexyaExternalID" field of the first
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s GroupSet) HexyaExternalID() string {
...
func (s GroupSet) SetHexyaExternalID(value string) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s GroupSet) HexyaVersion() int {
...
func (s GroupSet) SetHexyaVersion(value int) {
...
func (s GroupSet) SetID(value int64) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s GroupSet) LastUpdate() dates.DateTime {
...
func (s GroupSet) SetLastUpdate(value dates.DateTime) {
...
func (s GroupSet) SetName(value string) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s GroupSet) WriteDate() dates.DateTime {
...
func (s GroupSet) SetWriteDate(value dates.DateTime) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s GroupSet) WriteUID() int64 {
...
func (s GroupSet) SetWriteUID(value int64) {
...
func (s GroupSet) Super() m.GroupSet {
	return s.RecordCollection.Super().Wrap("Group").(m.GroupSet)
}

// ModelData returns a new GroupData object populated with the values
// of the given FieldMap.
func (s GroupSet) ModelData(fMap models.FieldMap) m.GroupData {
	res := &GroupData{
		models.NewModelData(models.Registry.MustGet("Group")),
	}
	for k, v := range fMap {
		res.Set(models.Registry.MustGet("Group").FieldName(k), v)
	}
	return res
}
...
func (s GroupSet) AddDomainLimitOffset(domain domains.Domain, limit int, offset int, order string) m.GroupSet {
	res := s.Collection().Call("AddDomainLimitOffset", domain, limit, offset, order)
	resTyped := res.(models.RecordSet).Collection().Wrap("Group").(m.GroupSet)
	return resTyped
}

// AddModifiers adds the modifiers attribute nodes to given xml doc.
func (s GroupSet) AddModifiers(doc *etree.Document, fieldInfos map[string]*models.FieldInfo) {
...
func (s GroupSet) AddNamesToRelations(data models.RecordData, fInfos map[string]*models.FieldInfo) models.RecordData {
...
func (s GroupSet) Aggregates(fieldNames ...models.FieldName) []m.GroupGroupAggregateRow {
	res := s.Collection().Call("Aggregates", fieldNames)
	resTyped, _ := res.([]m.GroupGroupAggregateRow)
	return resTyped
}

// Browse returns a new RecordSet with only the records with the given ids.
// Note that this function is just a shorcut for Search on a list of ids.
func (s GroupSet) Browse(ids []int64) m.GroupSet {
...
func (s GroupSet) BrowseOne(id int64) m.GroupSet {
...
func (s GroupSet) CheckAccessRights(args webtypes.CheckAccessRightsArgs) bool {
...
func (s GroupSet) CheckExecutionPermission(method *models.Method, dontPanic ...bool) bool {
...
func (s GroupSet) CheckRecursion() bool {
...
func (s GroupSet) ComputeDisplayName() *models.ModelData {
...
func (s GroupSet) ComputeLastUpdate() *models.ModelData {
	res := s.Collection().Call("ComputeLastUpdate")
	resTyped, _ := res.(*models.ModelData)
	return resTyped
}

// Copy duplicates the given Group record, overridding values with overrides.
func (s GroupSet) Copy(overrides m.GroupData) m.GroupSet {
...
func (s GroupSet) CopyData(overrides m.GroupData) m.GroupData {
	res := s.Collection().Call("CopyData", overrides)
	resTyped, _ := res.(models.RecordData)
	return resTyped.Underlying().Wrap().(m.GroupData)
}

// Create inserts a Group record in the database from the given data.
// Returns the created GroupSet.
func (s GroupSet) Create(data m.GroupData) m.GroupSet {
	res := s.Collection().Call("Create", data)
	resTyped := res.(models.RecordSet).Collection().Wrap("Group").(m.GroupSet)
	return resTyped
}

// DefaultGet returns a GroupData with the default values for the model.
func (s GroupSet) DefaultGet() m.GroupData {
...
func (s GroupSet) Enqueue(description string, method models.Methoder, arguments ...interface{}) m.QueueJobSet {
...
func (s GroupSet) Equals(other m.GroupSet) bool {
...
func (s GroupSet) ExecuteO2MActions(fieldName models.FieldName, info *models.FieldInfo, value interface{}) interface{} {
...
func (s GroupSet) Fetch() m.GroupSet {
...
func (s GroupSet) FieldGet(field models.FieldName) *models.FieldInfo {
...
func (s GroupSet) FieldsGet(args models.FieldsGetArgs) map[string]*models.FieldInfo {
...
// view architecture.
func (s GroupSet) FieldsViewGet(args webtypes.FieldsViewGetParams) *webtypes.FieldsViewData {
...
func (s GroupSet) FormatRelationFields(data models.RecordData, fInfos map[string]*models.FieldInfo) models.RecordData {
...
func (s GroupSet) GetFormviewAction() *actions.Action {
...
// This method is meant to be overridden in addons that want
// to give specific view ids for example.
func (s GroupSet) GetFormviewId() string {
...
func (s GroupSet) GetRecord(externalID string) m.GroupSet {
...
func (s GroupSet) GetToolbar() webtypes.Toolbar {
...
func (s GroupSet) GroupBy(exprs ...models.FieldName) m.GroupSet {
...
func (s GroupSet) Intersect(other m.GroupSet) m.GroupSet {
...
func (s GroupSet) Limit(limit int) m.GroupSet {
...
// model are retrieved.
func (s GroupSet) Load(fields ...models.FieldName) m.GroupSet {
...
func (s GroupSet) LoadViews(args webtypes.LoadViewsArgs) *webtypes.LoadViewsData {
...
func (s GroupSet) ManageGroupsOnFields(doc *etree.Document, fieldInfos map[string]*models.FieldInfo) {
	s.Collection().Call("ManageGroupsOnFields", doc, fieldInfos)
}

// NameGet retrieves the human readable name of this record.`,
func (s GroupSet) NameGet() string {
...
func (s GroupSet) NameSearch(params webtypes.NameSearchParams) []webtypes.RecordIDWithName {
	res := s.Collection().Call("NameSearch", params)
	resTyped, _ := res.([]webtypes.RecordIDWithName)
	return resTyped
}

// New creates a Group record in memory from the given data.
// Such GroupSet has a negative ID and cannot be reloaded from the database
func (s GroupSet) New(data m.GroupData) m.GroupSet {
...
func (s GroupSet) NormalizeM2MData(fieldName models.FieldName, info *models.FieldInfo, value interface{}) interface{} {
...
func (s GroupSet) Offset(offset int) m.GroupSet {
...
func (s GroupSet) Onchange(params models.OnchangeParams) models.OnchangeResult {
...
func (s GroupSet) OrderBy(exprs ...string) m.GroupSet {
...
func (s GroupSet) PostProcessCreateValues(data models.RecordData) {
...
func (s GroupSet) PostProcessFilters(in map[models.FieldName]models.Conditioner) map[string][]interface{} {
...
func (s GroupSet) ProcessCreateValues(data models.RecordData) (models.RecordData, models.RecordData) {
...
func (s GroupSet) ProcessElementAttrs(element *etree.Element, fieldInfos map[string]*models.FieldInfo) map[string]interface{} {
...
func (s GroupSet) ProcessFieldElementModifiers(element *etree.Element, fieldInfos map[string]*models.FieldInfo, modifiers map[string]interface{}) map[string]interface{} {
...
func (s GroupSet) ProcessView(arch *etree.Document, fieldInfos map[string]*models.FieldInfo) string {
...
// compatible with the ORM, in particular for relation fields
func (s GroupSet) ProcessWriteValues(data models.RecordData) models.RecordData {
...
func (s GroupSet) Read(fields models.FieldNames) []models.RecordData {
...
func (s GroupSet) ReadGroup(params webtypes.ReadGroupParams) []models.FieldMap {
...
func (s GroupSet) ReloadGroups() {
	s.Collection().Call("ReloadGroups")
}

// SQLFromCondition returns the WHERE clause sql and arguments corresponding to
// the given condition.`,
func (s GroupSet) SQLFromCondition(c *models.Condition) (string, models.SQLParams) {
...
// Search returns a new GroupSet filtering on the current one with the additional given Condition
func (s GroupSet) Search(condition q.GroupCondition) m.GroupSet {
...
func (s GroupSet) SearchAll() m.GroupSet {
	res := s.Collection().Call("SearchAll")
	resTyped := res.(models.RecordSet).Collection().Wrap("Group").(m.GroupSet)
	return resTyped
}

// SearchByName searches for Group records that have a display name matching the given
...
// value for a relational field. Sometimes be seen as the inverse
// function of NameGet but it is not guaranteed to be.
func (s GroupSet) SearchByName(name string, op operator.Operator, additionalCond q.GroupCondition, limit int) m.GroupSet {
...
func (s GroupSet) SearchCount() int {
...
func (s GroupSet) SearchDomain(domain domains.Domain) m.CommonMixinSet {
...
func (s GroupSet) SearchRead(params webtypes.SearchParams) []models.RecordData {
...
func (s GroupSet) SortedByField(namer models.FieldName, reverse bool) m.GroupSet {
...
func (s GroupSet) SortedDefault() m.GroupSet {
...
func (s GroupSet) Subtract(other m.GroupSet) m.GroupSet {
...
func (s GroupSet) Sudo(userID ...int64) m.GroupSet {
...
func (s GroupSet) Union(other m.GroupSet) m.GroupSet {
...
func (s GroupSet) WebReadGroup(params webtypes.WebReadGroupParams) webtypes.WebReadGroupResult {
...
func (s GroupSet) WebReadGroupPrivate(params webtypes.WebReadGroupParams) []models.FieldMap {
...
func (s GroupSet) WebSearchRead(params webtypes.SearchParams) webtypes.SearchReadResult {
...
func (s GroupSet) WithContext(key string, value interface{}) m.GroupSet {
...
func (s GroupSet) WithEnv(env models.Environment) m.GroupSet {
...
func (s GroupSet) WithNewContext(context *types.Context) m.GroupSet {
...
// Group records in the database with the given data.
func (s GroupSet) Write(data m.GroupData) bool {
...
// Aggregates returns the result of this RecordSet query, which must by a grouped query.
func m_Group_Aggregates(rs GroupSet, fieldNames ...models.FieldName) []m.GroupGroupAggregateRow {
	lines := rs.RecordCollection.Aggregates(fieldNames...)
	res := make([]m.GroupGroupAggregateRow, len(lines))
	for i, l := range lines {
		res[i] = GroupGroupAggregateRow{
			values: l.Values.Wrap().(m.GroupData),
			count:  l.Count,
			condition: q.GroupCondition{
...
func init() {
	models.CreateModel("Group", 0)
	models.Registry.MustGet("Group").AddFields(map[string]models.FieldDefinition{
	...
	models.Registry.MustGet("Group").AddEmptyMethod("ActionArchive")
	models.Registry.MustGet("Group").AddEmptyMethod("ActionUnarchive")
	models.Registry.MustGet("Group").AddEmptyMethod("AddDomainLimitOffset")
	models.Registry.MustGet("Group").AddEmptyMethod("AddModifiers")
	models.Registry.MustGet("Group").AddEmptyMethod("AddNamesToRelations")
	models.Registry.MustGet("Group").AddEmptyMethod("Browse")
	models.Registry.MustGet("Group").AddEmptyMethod("BrowseOne")
	models.Registry.MustGet("Group").AddEmptyMethod("CheckAccessRights")
	models.Registry.MustGet("Group").AddEmptyMethod("CheckExecutionPermission")
	models.Registry.MustGet("Group").AddEmptyMethod("CheckRecursion")
	models.Registry.MustGet("Group").AddEmptyMethod("ComputeDisplayName")
	models.Registry.MustGet("Group").AddEmptyMethod("ComputeLastUpdate")
	models.Registry.MustGet("Group").AddEmptyMethod("Copy")
	models.Registry.MustGet("Group").AddEmptyMethod("CopyData")
	models.Registry.MustGet("Group").AddEmptyMethod("Create")
	models.Registry.MustGet("Group").AddEmptyMethod("DefaultGet")
	models.Registry.MustGet("Group").AddEmptyMethod("Enqueue")
	models.Registry.MustGet("Group").AddEmptyMethod("Equals")
	models.Registry.MustGet("Group").AddEmptyMethod("ExecuteO2MActions")
	models.Registry.MustGet("Group").AddEmptyMethod("Fetch")
	models.Registry.MustGet("Group").AddEmptyMethod("FieldGet")
	models.Registry.MustGet("Group").AddEmptyMethod("FieldsGet")
	models.Registry.MustGet("Group").AddEmptyMethod("FieldsViewGet")
	models.Registry.MustGet("Group").AddEmptyMethod("FormatRelationFields")
	models.Registry.MustGet("Group").AddEmptyMethod("GetFormviewAction")
	models.Registry.MustGet("Group").AddEmptyMethod("GetFormviewId")
	models.Registry.MustGet("Group").AddEmptyMethod("GetRecord")
	models.Registry.MustGet("Group").AddEmptyMethod("GetToolbar")
	models.Registry.MustGet("Group").AddEmptyMethod("GroupBy")
	models.Registry.MustGet("Group").AddEmptyMethod("Intersect")
	models.Registry.MustGet("Group").AddEmptyMethod("Limit")
	models.Registry.MustGet("Group").AddEmptyMethod("Load")
	models.Registry.MustGet("Group").AddEmptyMethod("LoadViews")
	models.Registry.MustGet("Group").AddEmptyMethod("ManageGroupsOnFields")
	models.Registry.MustGet("Group").AddEmptyMethod("NameGet")
	models.Registry.MustGet("Group").AddEmptyMethod("NameSearch")
	models.Registry.MustGet("Group").AddEmptyMethod("New")
	models.Registry.MustGet("Group").AddEmptyMethod("NormalizeM2MData")
	models.Registry.MustGet("Group").AddEmptyMethod("Offset")
	models.Registry.MustGet("Group").AddEmptyMethod("Onchange")
	models.Registry.MustGet("Group").AddEmptyMethod("OrderBy")
	models.Registry.MustGet("Group").AddEmptyMethod("PostProcessCreateValues")
	models.Registry.MustGet("Group").AddEmptyMethod("PostProcessFilters")
	models.Registry.MustGet("Group").AddEmptyMethod("ProcessCreateValues")
	models.Registry.MustGet("Group").AddEmptyMethod("ProcessElementAttrs")
	models.Registry.MustGet("Group").AddEmptyMethod("ProcessFieldElementModifiers")
	models.Registry.MustGet("Group").AddEmptyMethod("ProcessView")
	models.Registry.MustGet("Group").AddEmptyMethod("ProcessWriteValues")
	models.Registry.MustGet("Group").AddEmptyMethod("Read")
	models.Registry.MustGet("Group").AddEmptyMethod("ReadGroup")
	models.Registry.MustGet("Group").AddEmptyMethod("ReloadGroups")
	models.Registry.MustGet("Group").AddEmptyMethod("SQLFromCondition")
	models.Registry.MustGet("Group").AddEmptyMethod("Search")
	models.Registry.MustGet("Group").AddEmptyMethod("SearchAll")
	models.Registry.MustGet("Group").AddEmptyMethod("SearchByName")
	models.Registry.MustGet("Group").AddEmptyMethod("SearchCount")
	models.Registry.MustGet("Group").AddEmptyMethod("SearchDomain")
	models.Registry.MustGet("Group").AddEmptyMethod("SearchRead")
	models.Registry.MustGet("Group").AddEmptyMethod("SortedByField")
	models.Registry.MustGet("Group").AddEmptyMethod("SortedDefault")
	models.Registry.MustGet("Group").AddEmptyMethod("Subtract")
	models.Registry.MustGet("Group").AddEmptyMethod("Sudo")
	models.Registry.MustGet("Group").AddEmptyMethod("ToggleActive")
	models.Registry.MustGet("Group").AddEmptyMethod("Union")
	models.Registry.MustGet("Group").AddEmptyMethod("Unlink")
	models.Registry.MustGet("Group").AddEmptyMethod("WebReadGroup")
	models.Registry.MustGet("Group").AddEmptyMethod("WebReadGroupPrivate")
	models.Registry.MustGet("Group").AddEmptyMethod("WebSearchRead")
	models.Registry.MustGet("Group").AddEmptyMethod("WithContext")
	models.Registry.MustGet("Group").AddEmptyMethod("WithEnv")
	models.Registry.MustGet("Group").AddEmptyMethod("WithNewContext")
	models.Registry.MustGet("Group").AddEmptyMethod("Write")
	models.Registry.MustGet("Group").NewMethod("Aggregates", m_Group_Aggregates)
	models.RegisterRecordSetWrapper("Group", GroupSet{})
	models.RegisterModelDataWrapper("Group", GroupData{})
}
