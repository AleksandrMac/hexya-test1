...
// pAddDomainLimitOffset holds the metadata of the AutoVacuum.AddDomainLimitOffset() method
type pAddDomainLimitOffset struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pAddDomainLimitOffset) Extend(fnct func(m.AutoVacuumSet, domains.Domain, int, int, string) m.AutoVacuumSet) pAddDomainLimitOffset {
...
// pAddModifiers holds the metadata of the AutoVacuum.AddModifiers() method
type pAddModifiers struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pAddModifiers) Extend(fnct func(m.AutoVacuumSet, *etree.Document, map[string]*models.FieldInfo)) pAddModifiers {
...
// pAddNamesToRelations holds the metadata of the AutoVacuum.AddNamesToRelations() method
type pAddNamesToRelations struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pAddNamesToRelations) Extend(fnct func(m.AutoVacuumSet, models.RecordData, map[string]*models.FieldInfo) models.RecordData) pAddNamesToRelations {
...
// pAggregates holds the metadata of the AutoVacuum.Aggregates() method
type pAggregates struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pAggregates) Extend(fnct func(m.AutoVacuumSet, ...models.FieldName) []m.AutoVacuumGroupAggregateRow) pAggregates {
	return pAggregates{
		Method: m.Method.Extend(fnct),
	}
}
...
// pBrowse holds the metadata of the AutoVacuum.Browse() method
type pBrowse struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pBrowse) Extend(fnct func(m.AutoVacuumSet, []int64) m.AutoVacuumSet) pBrowse {
	return pBrowse{
		Method: m.Method.Extend(fnct),
	}
}
...
// pBrowseOne holds the metadata of the AutoVacuum.BrowseOne() method
type pBrowseOne struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pBrowseOne) Extend(fnct func(m.AutoVacuumSet, int64) m.AutoVacuumSet) pBrowseOne {
	return pBrowseOne{
		Method: m.Method.Extend(fnct),
	}
}
...
// pCartesianProduct holds the metadata of the AutoVacuum.CartesianProduct() method
type pCartesianProduct struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCartesianProduct) Extend(fnct func(m.AutoVacuumSet, ...m.AutoVacuumSet) []m.AutoVacuumSet) pCartesianProduct {
...
// pCheckAccessRights holds the metadata of the AutoVacuum.CheckAccessRights() method
type pCheckAccessRights struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCheckAccessRights) Extend(fnct func(m.AutoVacuumSet, webtypes.CheckAccessRightsArgs) bool) pCheckAccessRights {
...
// pCheckExecutionPermission holds the metadata of the AutoVacuum.CheckExecutionPermission() method
type pCheckExecutionPermission struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCheckExecutionPermission) Extend(fnct func(m.AutoVacuumSet, *models.Method, ...bool) bool) pCheckExecutionPermission {
...
// pCheckRecursion holds the metadata of the AutoVacuum.CheckRecursion() method
type pCheckRecursion struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCheckRecursion) Extend(fnct func(m.AutoVacuumSet) bool) pCheckRecursion {
...
// pCopy holds the metadata of the AutoVacuum.Copy() method
type pCopy struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCopy) Extend(fnct func(m.AutoVacuumSet, m.AutoVacuumData) m.AutoVacuumSet) pCopy {
	return pCopy{
		Method: m.Method.Extend(fnct),
	}
}
...
// pCopyData holds the metadata of the AutoVacuum.CopyData() method
type pCopyData struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCopyData) Extend(fnct func(m.AutoVacuumSet, m.AutoVacuumData) m.AutoVacuumData) pCopyData {
	return pCopyData{
		Method: m.Method.Extend(fnct),
	}
}
...
// pCreate holds the metadata of the AutoVacuum.Create() method
type pCreate struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCreate) Extend(fnct func(m.AutoVacuumSet, m.AutoVacuumData) m.AutoVacuumSet) pCreate {
	return pCreate{
		Method: m.Method.Extend(fnct),
	}
}
...
// pDefaultGet holds the metadata of the AutoVacuum.DefaultGet() method
type pDefaultGet struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pDefaultGet) Extend(fnct func(m.AutoVacuumSet) m.AutoVacuumData) pDefaultGet {
	return pDefaultGet{
		Method: m.Method.Extend(fnct),
	}
}
...
// pEnqueue holds the metadata of the AutoVacuum.Enqueue() method
type pEnqueue struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pEnqueue) Extend(fnct func(m.AutoVacuumSet, string, models.Methoder, ...interface{}) m.QueueJobSet) pEnqueue {
	return pEnqueue{
		Method: m.Method.Extend(fnct),
	}
}
...
// pEquals holds the metadata of the AutoVacuum.Equals() method
type pEquals struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pEquals) Extend(fnct func(m.AutoVacuumSet, m.AutoVacuumSet) bool) pEquals {
	return pEquals{
		Method: m.Method.Extend(fnct),
	}
}
...
// pExecuteO2MActions holds the metadata of the AutoVacuum.ExecuteO2MActions() method
type pExecuteO2MActions struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pExecuteO2MActions) Extend(fnct func(m.AutoVacuumSet, models.FieldName, *models.FieldInfo, interface{}) interface{}) pExecuteO2MActions {
...
// pFetch holds the metadata of the AutoVacuum.Fetch() method
type pFetch struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFetch) Extend(fnct func(m.AutoVacuumSet) m.AutoVacuumSet) pFetch {
	return pFetch{
		Method: m.Method.Extend(fnct),
	}
}
...
// pFieldGet holds the metadata of the AutoVacuum.FieldGet() method
type pFieldGet struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFieldGet) Extend(fnct func(m.AutoVacuumSet, models.FieldName) *models.FieldInfo) pFieldGet {
	return pFieldGet{
		Method: m.Method.Extend(fnct),
	}
}
...
// pFieldsGet holds the metadata of the AutoVacuum.FieldsGet() method
type pFieldsGet struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFieldsGet) Extend(fnct func(m.AutoVacuumSet, models.FieldsGetArgs) map[string]*models.FieldInfo) pFieldsGet {
	return pFieldsGet{
		Method: m.Method.Extend(fnct),
	}
}
...
// pFieldsViewGet holds the metadata of the AutoVacuum.FieldsViewGet() method
type pFieldsViewGet struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFieldsViewGet) Extend(fnct func(m.AutoVacuumSet, webtypes.FieldsViewGetParams) *webtypes.FieldsViewData) pFieldsViewGet {
...
// pFiltered holds the metadata of the AutoVacuum.Filtered() method
type pFiltered struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFiltered) Extend(fnct func(m.AutoVacuumSet, func(m.AutoVacuumSet) bool) m.AutoVacuumSet) pFiltered {
	return pFiltered{
		Method: m.Method.Extend(fnct),
	}
}
...
// pFormatRelationFields holds the metadata of the AutoVacuum.FormatRelationFields() method
type pFormatRelationFields struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFormatRelationFields) Extend(fnct func(m.AutoVacuumSet, models.RecordData, map[string]*models.FieldInfo) models.RecordData) pFormatRelationFields {
...
// pGCUserLogs holds the metadata of the AutoVacuum.GCUserLogs() method
type pGCUserLogs struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pGCUserLogs) Extend(fnct func(m.AutoVacuumSet)) pGCUserLogs {
	return pGCUserLogs{
		Method: m.Method.Extend(fnct),
	}
}
...
// Underlying returns a pointer to the underlying Method data object.
func (m pGCUserLogs) Underlying() *models.Method {
	return m.Method
}

var _ models.Methoder = pGCUserLogs{}

// GCUserLogs returns a pointer to the GCUserLogs Method.
func (c MethodsCollection) GCUserLogs() pGCUserLogs {
	return pGCUserLogs{
		Method: c.MustGet("GCUserLogs"),
	}
}

// pGetFormviewAction holds the metadata of the AutoVacuum.GetFormviewAction() method
type pGetFormviewAction struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pGetFormviewAction) Extend(fnct func(m.AutoVacuumSet) *actions.Action) pGetFormviewAction {
...
// pGetFormviewId holds the metadata of the AutoVacuum.GetFormviewId() method
type pGetFormviewId struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pGetFormviewId) Extend(fnct func(m.AutoVacuumSet) string) pGetFormviewId {
...
// pGetRecord holds the metadata of the AutoVacuum.GetRecord() method
type pGetRecord struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pGetRecord) Extend(fnct func(m.AutoVacuumSet, string) m.AutoVacuumSet) pGetRecord {
	return pGetRecord{
		Method: m.Method.Extend(fnct),
	}
}
...
// pGetToolbar holds the metadata of the AutoVacuum.GetToolbar() method
type pGetToolbar struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pGetToolbar) Extend(fnct func(m.AutoVacuumSet) webtypes.Toolbar) pGetToolbar {
	return pGetToolbar{
		Method: m.Method.Extend(fnct),
	}
}
...
// pGroupBy holds the metadata of the AutoVacuum.GroupBy() method
type pGroupBy struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pGroupBy) Extend(fnct func(m.AutoVacuumSet, ...models.FieldName) m.AutoVacuumSet) pGroupBy {
	return pGroupBy{
		Method: m.Method.Extend(fnct),
	}
}
...
// pIntersect holds the metadata of the AutoVacuum.Intersect() method
type pIntersect struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pIntersect) Extend(fnct func(m.AutoVacuumSet, m.AutoVacuumSet) m.AutoVacuumSet) pIntersect {
	return pIntersect{
		Method: m.Method.Extend(fnct),
	}
}
...
// pLimit holds the metadata of the AutoVacuum.Limit() method
type pLimit struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pLimit) Extend(fnct func(m.AutoVacuumSet, int) m.AutoVacuumSet) pLimit {
	return pLimit{
		Method: m.Method.Extend(fnct),
	}
}
...
// pLoad holds the metadata of the AutoVacuum.Load() method
type pLoad struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pLoad) Extend(fnct func(m.AutoVacuumSet, ...models.FieldName) m.AutoVacuumSet) pLoad {
	return pLoad{
		Method: m.Method.Extend(fnct),
	}
}
...
// pLoadViews holds the metadata of the AutoVacuum.LoadViews() method
type pLoadViews struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pLoadViews) Extend(fnct func(m.AutoVacuumSet, webtypes.LoadViewsArgs) *webtypes.LoadViewsData) pLoadViews {
	return pLoadViews{
		Method: m.Method.Extend(fnct),
	}
}
...
// pManageGroupsOnFields holds the metadata of the AutoVacuum.ManageGroupsOnFields() method
type pManageGroupsOnFields struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pManageGroupsOnFields) Extend(fnct func(m.AutoVacuumSet, *etree.Document, map[string]*models.FieldInfo)) pManageGroupsOnFields {
...
// pNameGet holds the metadata of the AutoVacuum.NameGet() method
type pNameGet struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pNameGet) Extend(fnct func(m.AutoVacuumSet) string) pNameGet {
	return pNameGet{
		Method: m.Method.Extend(fnct),
	}
}
...
// pNameSearch holds the metadata of the AutoVacuum.NameSearch() method
type pNameSearch struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pNameSearch) Extend(fnct func(m.AutoVacuumSet, webtypes.NameSearchParams) []webtypes.RecordIDWithName) pNameSearch {
	return pNameSearch{
		Method: m.Method.Extend(fnct),
	}
}
...
// pNew holds the metadata of the AutoVacuum.New() method
type pNew struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pNew) Extend(fnct func(m.AutoVacuumSet, m.AutoVacuumData) m.AutoVacuumSet) pNew {
	return pNew{
		Method: m.Method.Extend(fnct),
	}
}
...
// pNormalizeM2MData holds the metadata of the AutoVacuum.NormalizeM2MData() method
type pNormalizeM2MData struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pNormalizeM2MData) Extend(fnct func(m.AutoVacuumSet, models.FieldName, *models.FieldInfo, interface{}) interface{}) pNormalizeM2MData {
...
// pOffset holds the metadata of the AutoVacuum.Offset() method
type pOffset struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pOffset) Extend(fnct func(m.AutoVacuumSet, int) m.AutoVacuumSet) pOffset {
	return pOffset{
		Method: m.Method.Extend(fnct),
	}
}
...
// pOnchange holds the metadata of the AutoVacuum.Onchange() method
type pOnchange struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pOnchange) Extend(fnct func(m.AutoVacuumSet, models.OnchangeParams) models.OnchangeResult) pOnchange {
	return pOnchange{
		Method: m.Method.Extend(fnct),
	}
}
...
// pOrderBy holds the metadata of the AutoVacuum.OrderBy() method
type pOrderBy struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pOrderBy) Extend(fnct func(m.AutoVacuumSet, ...string) m.AutoVacuumSet) pOrderBy {
	return pOrderBy{
		Method: m.Method.Extend(fnct),
	}
}
...
// pPostProcessCreateValues holds the metadata of the AutoVacuum.PostProcessCreateValues() method
type pPostProcessCreateValues struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pPostProcessCreateValues) Extend(fnct func(m.AutoVacuumSet, models.RecordData)) pPostProcessCreateValues {
...
// pPostProcessFilters holds the metadata of the AutoVacuum.PostProcessFilters() method
type pPostProcessFilters struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pPostProcessFilters) Extend(fnct func(m.AutoVacuumSet, map[models.FieldName]models.Conditioner) map[string][]interface{}) pPostProcessFilters {
...
// pPowerOn holds the metadata of the AutoVacuum.PowerOn() method
type pPowerOn struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pPowerOn) Extend(fnct func(m.AutoVacuumSet)) pPowerOn {
	return pPowerOn{
		Method: m.Method.Extend(fnct),
	}
}
...
// Underlying returns a pointer to the underlying Method data object.
func (m pPowerOn) Underlying() *models.Method {
	return m.Method
}

var _ models.Methoder = pPowerOn{}

// PowerOn returns a pointer to the PowerOn Method.
func (c MethodsCollection) PowerOn() pPowerOn {
	return pPowerOn{
		Method: c.MustGet("PowerOn"),
	}
}

// pProcessCreateValues holds the metadata of the AutoVacuum.ProcessCreateValues() method
type pProcessCreateValues struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pProcessCreateValues) Extend(fnct func(m.AutoVacuumSet, models.RecordData) (models.RecordData, models.RecordData)) pProcessCreateValues {
...
// pProcessElementAttrs holds the metadata of the AutoVacuum.ProcessElementAttrs() method
type pProcessElementAttrs struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pProcessElementAttrs) Extend(fnct func(m.AutoVacuumSet, *etree.Element, map[string]*models.FieldInfo) map[string]interface{}) pProcessElementAttrs {
...
// pProcessFieldElementModifiers holds the metadata of the AutoVacuum.ProcessFieldElementModifiers() method
type pProcessFieldElementModifiers struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pProcessFieldElementModifiers) Extend(fnct func(m.AutoVacuumSet, *etree.Element, map[string]*models.FieldInfo, map[string]interface{}) map[string]interface{}) pProcessFieldElementModifiers {
...
// pProcessView holds the metadata of the AutoVacuum.ProcessView() method
type pProcessView struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pProcessView) Extend(fnct func(m.AutoVacuumSet, *etree.Document, map[string]*models.FieldInfo) string) pProcessView {
	return pProcessView{
		Method: m.Method.Extend(fnct),
	}
}
...
// pProcessWriteValues holds the metadata of the AutoVacuum.ProcessWriteValues() method
type pProcessWriteValues struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pProcessWriteValues) Extend(fnct func(m.AutoVacuumSet, models.RecordData) models.RecordData) pProcessWriteValues {
...
// pRead holds the metadata of the AutoVacuum.Read() method
type pRead struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pRead) Extend(fnct func(m.AutoVacuumSet, models.FieldNames) []models.RecordData) pRead {
	return pRead{
		Method: m.Method.Extend(fnct),
	}
}
...
// pReadGroup holds the metadata of the AutoVacuum.ReadGroup() method
type pReadGroup struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pReadGroup) Extend(fnct func(m.AutoVacuumSet, webtypes.ReadGroupParams) []models.FieldMap) pReadGroup {
	return pReadGroup{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSQLFromCondition holds the metadata of the AutoVacuum.SQLFromCondition() method
type pSQLFromCondition struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSQLFromCondition) Extend(fnct func(m.AutoVacuumSet, *models.Condition) (string, models.SQLParams)) pSQLFromCondition {
...
// pSearch holds the metadata of the AutoVacuum.Search() method
type pSearch struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearch) Extend(fnct func(m.AutoVacuumSet, q.AutoVacuumCondition) m.AutoVacuumSet) pSearch {
	return pSearch{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSearchAll holds the metadata of the AutoVacuum.SearchAll() method
type pSearchAll struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearchAll) Extend(fnct func(m.AutoVacuumSet) m.AutoVacuumSet) pSearchAll {
	return pSearchAll{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSearchByName holds the metadata of the AutoVacuum.SearchByName() method
type pSearchByName struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearchByName) Extend(fnct func(m.AutoVacuumSet, string, operator.Operator, q.AutoVacuumCondition, int) m.AutoVacuumSet) pSearchByName {
...
// pSearchCount holds the metadata of the AutoVacuum.SearchCount() method
type pSearchCount struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearchCount) Extend(fnct func(m.AutoVacuumSet) int) pSearchCount {
	return pSearchCount{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSearchDomain holds the metadata of the AutoVacuum.SearchDomain() method
type pSearchDomain struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearchDomain) Extend(fnct func(m.AutoVacuumSet, domains.Domain) m.CommonMixinSet) pSearchDomain {
...
// pSearchRead holds the metadata of the AutoVacuum.SearchRead() method
type pSearchRead struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearchRead) Extend(fnct func(m.AutoVacuumSet, webtypes.SearchParams) []models.RecordData) pSearchRead {
	return pSearchRead{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSorted holds the metadata of the AutoVacuum.Sorted() method
type pSorted struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSorted) Extend(fnct func(m.AutoVacuumSet, func(m.AutoVacuumSet, m.AutoVacuumSet) bool) m.AutoVacuumSet) pSorted {
	return pSorted{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSortedByField holds the metadata of the AutoVacuum.SortedByField() method
type pSortedByField struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSortedByField) Extend(fnct func(m.AutoVacuumSet, models.FieldName, bool) m.AutoVacuumSet) pSortedByField {
...
// pSortedDefault holds the metadata of the AutoVacuum.SortedDefault() method
type pSortedDefault struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSortedDefault) Extend(fnct func(m.AutoVacuumSet) m.AutoVacuumSet) pSortedDefault {
...
// pSubtract holds the metadata of the AutoVacuum.Subtract() method
type pSubtract struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSubtract) Extend(fnct func(m.AutoVacuumSet, m.AutoVacuumSet) m.AutoVacuumSet) pSubtract {
	return pSubtract{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSudo holds the metadata of the AutoVacuum.Sudo() method
type pSudo struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSudo) Extend(fnct func(m.AutoVacuumSet, ...int64) m.AutoVacuumSet) pSudo {
	return pSudo{
		Method: m.Method.Extend(fnct),
	}
}
...
// pUnion holds the metadata of the AutoVacuum.Union() method
type pUnion struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pUnion) Extend(fnct func(m.AutoVacuumSet, m.AutoVacuumSet) m.AutoVacuumSet) pUnion {
	return pUnion{
		Method: m.Method.Extend(fnct),
	}
}
...
// pUnlink holds the metadata of the AutoVacuum.Unlink() method
type pUnlink struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pUnlink) Extend(fnct func(m.AutoVacuumSet) int64) pUnlink {
	return pUnlink{
		Method: m.Method.Extend(fnct),
	}
}
...
// pWebReadGroup holds the metadata of the AutoVacuum.WebReadGroup() method
type pWebReadGroup struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWebReadGroup) Extend(fnct func(m.AutoVacuumSet, webtypes.WebReadGroupParams) webtypes.WebReadGroupResult) pWebReadGroup {
...
// pWebReadGroupPrivate holds the metadata of the AutoVacuum.WebReadGroupPrivate() method
type pWebReadGroupPrivate struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWebReadGroupPrivate) Extend(fnct func(m.AutoVacuumSet, webtypes.WebReadGroupParams) []models.FieldMap) pWebReadGroupPrivate {
...
// pWebSearchRead holds the metadata of the AutoVacuum.WebSearchRead() method
type pWebSearchRead struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWebSearchRead) Extend(fnct func(m.AutoVacuumSet, webtypes.SearchParams) webtypes.SearchReadResult) pWebSearchRead {
...
// pWithContext holds the metadata of the AutoVacuum.WithContext() method
type pWithContext struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWithContext) Extend(fnct func(m.AutoVacuumSet, string, interface{}) m.AutoVacuumSet) pWithContext {
	return pWithContext{
		Method: m.Method.Extend(fnct),
	}
}
...
// pWithEnv holds the metadata of the AutoVacuum.WithEnv() method
type pWithEnv struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWithEnv) Extend(fnct func(m.AutoVacuumSet, models.Environment) m.AutoVacuumSet) pWithEnv {
	return pWithEnv{
		Method: m.Method.Extend(fnct),
	}
}
...
// pWithNewContext holds the metadata of the AutoVacuum.WithNewContext() method
type pWithNewContext struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWithNewContext) Extend(fnct func(m.AutoVacuumSet, *types.Context) m.AutoVacuumSet) pWithNewContext {
...
// pWrite holds the metadata of the AutoVacuum.Write() method
type pWrite struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWrite) Extend(fnct func(m.AutoVacuumSet, m.AutoVacuumData) bool) pWrite {
	return pWrite{
		Method: m.Method.Extend(fnct),
	}
}
...
// AutoVacuumData is used to hold values of an AutoVacuum object instance
// when creating or updating a AutoVacuumSet.
type AutoVacuumData struct {
	*models.ModelData
}
...
//
// It returns the given AutoVacuumData so that calls can be chained
func (d AutoVacuumData) Set(field models.FieldName, value interface{}) m.AutoVacuumData {
	return &AutoVacuumData{
...
func (d AutoVacuumData) Unset(field models.FieldName) m.AutoVacuumData {
	return &AutoVacuumData{
		d.ModelData.Unset(field),
	}
}

// Copy returns a copy of this AutoVacuumData
func (d AutoVacuumData) Copy() m.AutoVacuumData {
	return &AutoVacuumData{
		d.ModelData.Copy(),
	}
}

// MergeWith updates this AutoVacuumData with the given other AutoVacuumData
// If a field of the other AutoVacuumData already exists here, the value is overridden,
// otherwise, the field is inserted.
func (d AutoVacuumData) MergeWith(other m.AutoVacuumData) {
	d.ModelData.MergeWith(other.Underlying())
}

// ID returns the value of the ID field.
// If this ID is not set in this AutoVacuumData, then
// the Go zero value for the type is returned.
func (d AutoVacuumData) ID() int64 {
...
// HasID returns true if ID is set in this AutoVacuumData
func (d AutoVacuumData) HasID() bool {
	return d.ModelData.Has(models.NewFieldName("ID", "id"))
}

// SetID sets the ID field with the given value.
// It returns this AutoVacuumData so that calls can be chained.
func (d AutoVacuumData) SetID(value int64) m.AutoVacuumData {
...
// It returns this AutoVacuumData so that calls can be chained.
func (d AutoVacuumData) UnsetID() m.AutoVacuumData {
	d.ModelData.Unset(models.NewFieldName("ID", "id"))
	return d
}

var _ m.AutoVacuumData = new(AutoVacuumData)
var _ m.AutoVacuumData = AutoVacuumData{}

// ------ AGGREGATE ROW --------

// A AutoVacuumGroupAggregateRow holds a row of results of a query with a group by clause
...
type AutoVacuumGroupAggregateRow struct {
	values    m.AutoVacuumData
	count     int
	condition q.AutoVacuumCondition
}

// Values returns the values of the actual query
func (a AutoVacuumGroupAggregateRow) Values() m.AutoVacuumData {
	return a.values
}

// Count returns the number of lines aggregated into this one
func (a AutoVacuumGroupAggregateRow) Count() int {
	return a.count
}

// Condition can be used to query the aggregated rows separately if needed
func (a AutoVacuumGroupAggregateRow) Condition() q.AutoVacuumCondition {
	return a.condition
}

// ------- RECORD SET ---------

// AutoVacuumSet is an autogenerated type to handle AutoVacuum objects.
type AutoVacuumSet struct {
	*models.RecordCollection
}

var _ models.RecordSet = AutoVacuumSet{}

// AutoVacuumSetHexyaFunc is a dummy function to uniquely match interfaces.
func (s AutoVacuumSet) AutoVacuumSetHexyaFunc() {}

// IsValid returns true if this RecordSet has been initialized.
func (s AutoVacuumSet) IsValid() bool {
...
// ForceLoad reloads the cache for the given fields and updates the ids of this AutoVacuumSet.
//
// If no fields are given, all DB columns of the AutoVacuum model are retrieved.
//
// It also returns this AutoVacuumSet.
func (s AutoVacuumSet) ForceLoad(fields ...models.FieldName) m.AutoVacuumSet {
...
// RecordSets
func (s AutoVacuumSet) Records() []m.AutoVacuumSet {
	recs := s.RecordCollection.Records()
	res := make([]m.AutoVacuumSet, len(recs))
	for i, rec := range recs {
		res[i] = rec.Wrap("AutoVacuum").(m.AutoVacuumSet)
	}
	return res
}

// CartesianProduct returns the cartesian product of this AutoVacuumSet with others.
func (s AutoVacuumSet) CartesianProduct(others ...m.AutoVacuumSet) []m.AutoVacuumSet {
...
// First returns the values of the first Record of the RecordSet as a pointer to a AutoVacuumData.
//
// If this RecordSet is empty, it returns an empty AutoVacuumData.
func (s AutoVacuumSet) First() m.AutoVacuumData {
	return &AutoVacuumData{
		s.RecordCollection.First(),
	}
}

// All returns the values of all Records of the RecordCollection as a slice of AutoVacuumData pointers.
func (s AutoVacuumSet) All() []m.AutoVacuumData {
	allSlice := s.RecordCollection.All()
	res := make([]m.AutoVacuumData, len(allSlice))
	for i, v := range allSlice {
		res[i] = &AutoVacuumData{v}
	}
	return res
}

// Sorted returns a new AutoVacuumSet sorted according to the given less function.
//
// The less function should return true if rs1 < rs2
func (s AutoVacuumSet) Sorted(less func(rs1, rs2 m.AutoVacuumSet) bool) m.AutoVacuumSet {
	res := s.RecordCollection.Sorted(func(rc1 models.RecordSet, rc2 models.RecordSet) bool {
		return less(AutoVacuumSet{RecordCollection: rc1.Collection()}, AutoVacuumSet{RecordCollection: rc2.Collection()})
	})
	return res.Wrap("AutoVacuum").(m.AutoVacuumSet)
}

// Filtered returns a new AutoVacuumSet with only the elements of this record set
// for which test is true.
//
// Note that if this AutoVacuumSet is not fully loaded, this function will call the database
...
func (s AutoVacuumSet) Filtered(test func(rs m.AutoVacuumSet) bool) m.AutoVacuumSet {
	res := s.RecordCollection.Filtered(func(rc models.RecordSet) bool {
		return test(AutoVacuumSet{RecordCollection: rc.Collection()})
	})
	return res.Wrap("AutoVacuum").(m.AutoVacuumSet)
}
...
func (s AutoVacuumSet) SetID(value int64) {
...
func (s AutoVacuumSet) Super() m.AutoVacuumSet {
	return s.RecordCollection.Super().Wrap("AutoVacuum").(m.AutoVacuumSet)
}

// ModelData returns a new AutoVacuumData object populated with the values
// of the given FieldMap.
func (s AutoVacuumSet) ModelData(fMap models.FieldMap) m.AutoVacuumData {
	res := &AutoVacuumData{
		models.NewModelData(models.Registry.MustGet("AutoVacuum")),
	}
	for k, v := range fMap {
		res.Set(models.Registry.MustGet("AutoVacuum").FieldName(k), v)
	}
	return res
}
...
func (s AutoVacuumSet) AddDomainLimitOffset(domain domains.Domain, limit int, offset int, order string) m.AutoVacuumSet {
	res := s.Collection().Call("AddDomainLimitOffset", domain, limit, offset, order)
	resTyped := res.(models.RecordSet).Collection().Wrap("AutoVacuum").(m.AutoVacuumSet)
	return resTyped
}

// AddModifiers adds the modifiers attribute nodes to given xml doc.
func (s AutoVacuumSet) AddModifiers(doc *etree.Document, fieldInfos map[string]*models.FieldInfo) {
...
func (s AutoVacuumSet) AddNamesToRelations(data models.RecordData, fInfos map[string]*models.FieldInfo) models.RecordData {
...
func (s AutoVacuumSet) Aggregates(fieldNames ...models.FieldName) []m.AutoVacuumGroupAggregateRow {
	res := s.Collection().Call("Aggregates", fieldNames)
	resTyped, _ := res.([]m.AutoVacuumGroupAggregateRow)
	return resTyped
}

// Browse returns a new RecordSet with only the records with the given ids.
// Note that this function is just a shorcut for Search on a list of ids.
func (s AutoVacuumSet) Browse(ids []int64) m.AutoVacuumSet {
...
func (s AutoVacuumSet) BrowseOne(id int64) m.AutoVacuumSet {
...
func (s AutoVacuumSet) CheckAccessRights(args webtypes.CheckAccessRightsArgs) bool {
...
func (s AutoVacuumSet) CheckExecutionPermission(method *models.Method, dontPanic ...bool) bool {
...
func (s AutoVacuumSet) CheckRecursion() bool {
	res := s.Collection().Call("CheckRecursion")
	resTyped, _ := res.(bool)
	return resTyped
}

// Copy duplicates the given AutoVacuum record, overridding values with overrides.
func (s AutoVacuumSet) Copy(overrides m.AutoVacuumData) m.AutoVacuumSet {
...
func (s AutoVacuumSet) CopyData(overrides m.AutoVacuumData) m.AutoVacuumData {
	res := s.Collection().Call("CopyData", overrides)
	resTyped, _ := res.(models.RecordData)
	return resTyped.Underlying().Wrap().(m.AutoVacuumData)
}

// Create inserts a AutoVacuum record in the database from the given data.
// Returns the created AutoVacuumSet.
func (s AutoVacuumSet) Create(data m.AutoVacuumData) m.AutoVacuumSet {
	res := s.Collection().Call("Create", data)
	resTyped := res.(models.RecordSet).Collection().Wrap("AutoVacuum").(m.AutoVacuumSet)
	return resTyped
}

// DefaultGet returns a AutoVacuumData with the default values for the model.
func (s AutoVacuumSet) DefaultGet() m.AutoVacuumData {
...
func (s AutoVacuumSet) Enqueue(description string, method models.Methoder, arguments ...interface{}) m.QueueJobSet {
...
func (s AutoVacuumSet) Equals(other m.AutoVacuumSet) bool {
...
func (s AutoVacuumSet) ExecuteO2MActions(fieldName models.FieldName, info *models.FieldInfo, value interface{}) interface{} {
...
func (s AutoVacuumSet) Fetch() m.AutoVacuumSet {
...
func (s AutoVacuumSet) FieldGet(field models.FieldName) *models.FieldInfo {
...
func (s AutoVacuumSet) FieldsGet(args models.FieldsGetArgs) map[string]*models.FieldInfo {
...
// view architecture.
func (s AutoVacuumSet) FieldsViewGet(args webtypes.FieldsViewGetParams) *webtypes.FieldsViewData {
...
func (s AutoVacuumSet) FormatRelationFields(data models.RecordData, fInfos map[string]*models.FieldInfo) models.RecordData {
...
func (s AutoVacuumSet) GCUserLogs() {
	s.Collection().Call("GCUserLogs")
}
...
func (s AutoVacuumSet) GetFormviewAction() *actions.Action {
...
// This method is meant to be overridden in addons that want
// to give specific view ids for example.
func (s AutoVacuumSet) GetFormviewId() string {
...
func (s AutoVacuumSet) GetRecord(externalID string) m.AutoVacuumSet {
...
func (s AutoVacuumSet) GetToolbar() webtypes.Toolbar {
...
func (s AutoVacuumSet) GroupBy(exprs ...models.FieldName) m.AutoVacuumSet {
...
func (s AutoVacuumSet) Intersect(other m.AutoVacuumSet) m.AutoVacuumSet {
...
func (s AutoVacuumSet) Limit(limit int) m.AutoVacuumSet {
...
// model are retrieved.
func (s AutoVacuumSet) Load(fields ...models.FieldName) m.AutoVacuumSet {
...
func (s AutoVacuumSet) LoadViews(args webtypes.LoadViewsArgs) *webtypes.LoadViewsData {
...
func (s AutoVacuumSet) ManageGroupsOnFields(doc *etree.Document, fieldInfos map[string]*models.FieldInfo) {
	s.Collection().Call("ManageGroupsOnFields", doc, fieldInfos)
}

// NameGet retrieves the human readable name of this record.`,
func (s AutoVacuumSet) NameGet() string {
...
func (s AutoVacuumSet) NameSearch(params webtypes.NameSearchParams) []webtypes.RecordIDWithName {
	res := s.Collection().Call("NameSearch", params)
	resTyped, _ := res.([]webtypes.RecordIDWithName)
	return resTyped
}

// New creates a AutoVacuum record in memory from the given data.
// Such AutoVacuumSet has a negative ID and cannot be reloaded from the database
func (s AutoVacuumSet) New(data m.AutoVacuumData) m.AutoVacuumSet {
...
func (s AutoVacuumSet) NormalizeM2MData(fieldName models.FieldName, info *models.FieldInfo, value interface{}) interface{} {
...
func (s AutoVacuumSet) Offset(offset int) m.AutoVacuumSet {
...
func (s AutoVacuumSet) Onchange(params models.OnchangeParams) models.OnchangeResult {
...
func (s AutoVacuumSet) OrderBy(exprs ...string) m.AutoVacuumSet {
...
func (s AutoVacuumSet) PostProcessCreateValues(data models.RecordData) {
...
func (s AutoVacuumSet) PostProcessFilters(in map[models.FieldName]models.Conditioner) map[string][]interface{} {
...
func (s AutoVacuumSet) PowerOn() {
	s.Collection().Call("PowerOn")
}
...
func (s AutoVacuumSet) ProcessCreateValues(data models.RecordData) (models.RecordData, models.RecordData) {
...
func (s AutoVacuumSet) ProcessElementAttrs(element *etree.Element, fieldInfos map[string]*models.FieldInfo) map[string]interface{} {
...
func (s AutoVacuumSet) ProcessFieldElementModifiers(element *etree.Element, fieldInfos map[string]*models.FieldInfo, modifiers map[string]interface{}) map[string]interface{} {
...
func (s AutoVacuumSet) ProcessView(arch *etree.Document, fieldInfos map[string]*models.FieldInfo) string {
...
// compatible with the ORM, in particular for relation fields
func (s AutoVacuumSet) ProcessWriteValues(data models.RecordData) models.RecordData {
...
func (s AutoVacuumSet) Read(fields models.FieldNames) []models.RecordData {
...
func (s AutoVacuumSet) ReadGroup(params webtypes.ReadGroupParams) []models.FieldMap {
...
// the given condition.`,
func (s AutoVacuumSet) SQLFromCondition(c *models.Condition) (string, models.SQLParams) {
...
// Search returns a new AutoVacuumSet filtering on the current one with the additional given Condition
func (s AutoVacuumSet) Search(condition q.AutoVacuumCondition) m.AutoVacuumSet {
...
func (s AutoVacuumSet) SearchAll() m.AutoVacuumSet {
	res := s.Collection().Call("SearchAll")
	resTyped := res.(models.RecordSet).Collection().Wrap("AutoVacuum").(m.AutoVacuumSet)
	return resTyped
}

// SearchByName searches for AutoVacuum records that have a display name matching the given
...
// value for a relational field. Sometimes be seen as the inverse
// function of NameGet but it is not guaranteed to be.
func (s AutoVacuumSet) SearchByName(name string, op operator.Operator, additionalCond q.AutoVacuumCondition, limit int) m.AutoVacuumSet {
...
func (s AutoVacuumSet) SearchCount() int {
...
func (s AutoVacuumSet) SearchDomain(domain domains.Domain) m.CommonMixinSet {
...
func (s AutoVacuumSet) SearchRead(params webtypes.SearchParams) []models.RecordData {
...
func (s AutoVacuumSet) SortedByField(namer models.FieldName, reverse bool) m.AutoVacuumSet {
...
func (s AutoVacuumSet) SortedDefault() m.AutoVacuumSet {
...
func (s AutoVacuumSet) Subtract(other m.AutoVacuumSet) m.AutoVacuumSet {
...
func (s AutoVacuumSet) Sudo(userID ...int64) m.AutoVacuumSet {
...
func (s AutoVacuumSet) Union(other m.AutoVacuumSet) m.AutoVacuumSet {
...
func (s AutoVacuumSet) Unlink() int64 {
...
func (s AutoVacuumSet) WebReadGroup(params webtypes.WebReadGroupParams) webtypes.WebReadGroupResult {
...
func (s AutoVacuumSet) WebReadGroupPrivate(params webtypes.WebReadGroupParams) []models.FieldMap {
...
func (s AutoVacuumSet) WebSearchRead(params webtypes.SearchParams) webtypes.SearchReadResult {
...
func (s AutoVacuumSet) WithContext(key string, value interface{}) m.AutoVacuumSet {
...
func (s AutoVacuumSet) WithEnv(env models.Environment) m.AutoVacuumSet {
...
func (s AutoVacuumSet) WithNewContext(context *types.Context) m.AutoVacuumSet {
...
// AutoVacuum records in the database with the given data.
func (s AutoVacuumSet) Write(data m.AutoVacuumData) bool {
...
// Aggregates returns the result of this RecordSet query, which must by a grouped query.
func m_AutoVacuum_Aggregates(rs AutoVacuumSet, fieldNames ...models.FieldName) []m.AutoVacuumGroupAggregateRow {
	lines := rs.RecordCollection.Aggregates(fieldNames...)
	res := make([]m.AutoVacuumGroupAggregateRow, len(lines))
	for i, l := range lines {
		res[i] = AutoVacuumGroupAggregateRow{
			values: l.Values.Wrap().(m.AutoVacuumData),
			count:  l.Count,
			condition: q.AutoVacuumCondition{
...
func init() {
	models.CreateModel("AutoVacuum", models.ManualModel)
	models.Registry.MustGet("AutoVacuum").AddFields(map[string]models.FieldDefinition{})
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("AddDomainLimitOffset")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("AddModifiers")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("AddNamesToRelations")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("Browse")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("BrowseOne")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("CheckAccessRights")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("CheckExecutionPermission")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("CheckRecursion")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("Copy")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("CopyData")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("Create")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("DefaultGet")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("Enqueue")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("Equals")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("ExecuteO2MActions")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("Fetch")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("FieldGet")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("FieldsGet")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("FieldsViewGet")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("FormatRelationFields")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("GCUserLogs")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("GetFormviewAction")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("GetFormviewId")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("GetRecord")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("GetToolbar")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("GroupBy")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("Intersect")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("Limit")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("Load")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("LoadViews")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("ManageGroupsOnFields")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("NameGet")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("NameSearch")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("New")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("NormalizeM2MData")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("Offset")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("Onchange")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("OrderBy")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("PostProcessCreateValues")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("PostProcessFilters")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("PowerOn")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("ProcessCreateValues")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("ProcessElementAttrs")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("ProcessFieldElementModifiers")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("ProcessView")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("ProcessWriteValues")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("Read")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("ReadGroup")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("SQLFromCondition")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("Search")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("SearchAll")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("SearchByName")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("SearchCount")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("SearchDomain")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("SearchRead")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("SortedByField")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("SortedDefault")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("Subtract")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("Sudo")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("Union")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("Unlink")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("WebReadGroup")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("WebReadGroupPrivate")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("WebSearchRead")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("WithContext")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("WithEnv")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("WithNewContext")
	models.Registry.MustGet("AutoVacuum").AddEmptyMethod("Write")
	models.Registry.MustGet("AutoVacuum").NewMethod("Aggregates", m_AutoVacuum_Aggregates)
	models.RegisterRecordSetWrapper("AutoVacuum", AutoVacuumSet{})
	models.RegisterModelDataWrapper("AutoVacuum", AutoVacuumData{})
}
