...
// pActionArchive holds the metadata of the CurrencyRate.ActionArchive() method
type pActionArchive struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pActionArchive) Extend(fnct func(m.CurrencyRateSet)) pActionArchive {
...
// pActionUnarchive holds the metadata of the CurrencyRate.ActionUnarchive() method
type pActionUnarchive struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pActionUnarchive) Extend(fnct func(m.CurrencyRateSet)) pActionUnarchive {
...
// pAddDomainLimitOffset holds the metadata of the CurrencyRate.AddDomainLimitOffset() method
type pAddDomainLimitOffset struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pAddDomainLimitOffset) Extend(fnct func(m.CurrencyRateSet, domains.Domain, int, int, string) m.CurrencyRateSet) pAddDomainLimitOffset {
...
// pAddModifiers holds the metadata of the CurrencyRate.AddModifiers() method
type pAddModifiers struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pAddModifiers) Extend(fnct func(m.CurrencyRateSet, *etree.Document, map[string]*models.FieldInfo)) pAddModifiers {
...
// pAddNamesToRelations holds the metadata of the CurrencyRate.AddNamesToRelations() method
type pAddNamesToRelations struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pAddNamesToRelations) Extend(fnct func(m.CurrencyRateSet, models.RecordData, map[string]*models.FieldInfo) models.RecordData) pAddNamesToRelations {
...
// pAggregates holds the metadata of the CurrencyRate.Aggregates() method
type pAggregates struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pAggregates) Extend(fnct func(m.CurrencyRateSet, ...models.FieldName) []m.CurrencyRateGroupAggregateRow) pAggregates {
	return pAggregates{
		Method: m.Method.Extend(fnct),
	}
}
...
// pBrowse holds the metadata of the CurrencyRate.Browse() method
type pBrowse struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pBrowse) Extend(fnct func(m.CurrencyRateSet, []int64) m.CurrencyRateSet) pBrowse {
	return pBrowse{
		Method: m.Method.Extend(fnct),
	}
}
...
// pBrowseOne holds the metadata of the CurrencyRate.BrowseOne() method
type pBrowseOne struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pBrowseOne) Extend(fnct func(m.CurrencyRateSet, int64) m.CurrencyRateSet) pBrowseOne {
	return pBrowseOne{
		Method: m.Method.Extend(fnct),
	}
}
...
// pCartesianProduct holds the metadata of the CurrencyRate.CartesianProduct() method
type pCartesianProduct struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCartesianProduct) Extend(fnct func(m.CurrencyRateSet, ...m.CurrencyRateSet) []m.CurrencyRateSet) pCartesianProduct {
...
// pCheckAccessRights holds the metadata of the CurrencyRate.CheckAccessRights() method
type pCheckAccessRights struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCheckAccessRights) Extend(fnct func(m.CurrencyRateSet, webtypes.CheckAccessRightsArgs) bool) pCheckAccessRights {
...
// pCheckExecutionPermission holds the metadata of the CurrencyRate.CheckExecutionPermission() method
type pCheckExecutionPermission struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCheckExecutionPermission) Extend(fnct func(m.CurrencyRateSet, *models.Method, ...bool) bool) pCheckExecutionPermission {
...
// pCheckRecursion holds the metadata of the CurrencyRate.CheckRecursion() method
type pCheckRecursion struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCheckRecursion) Extend(fnct func(m.CurrencyRateSet) bool) pCheckRecursion {
...
// pComputeDisplayName holds the metadata of the CurrencyRate.ComputeDisplayName() method
type pComputeDisplayName struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pComputeDisplayName) Extend(fnct func(m.CurrencyRateSet) *models.ModelData) pComputeDisplayName {
...
// pComputeLastUpdate holds the metadata of the CurrencyRate.ComputeLastUpdate() method
type pComputeLastUpdate struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pComputeLastUpdate) Extend(fnct func(m.CurrencyRateSet) *models.ModelData) pComputeLastUpdate {
...
// pCopy holds the metadata of the CurrencyRate.Copy() method
type pCopy struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCopy) Extend(fnct func(m.CurrencyRateSet, m.CurrencyRateData) m.CurrencyRateSet) pCopy {
	return pCopy{
		Method: m.Method.Extend(fnct),
	}
}
...
// pCopyData holds the metadata of the CurrencyRate.CopyData() method
type pCopyData struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCopyData) Extend(fnct func(m.CurrencyRateSet, m.CurrencyRateData) m.CurrencyRateData) pCopyData {
	return pCopyData{
		Method: m.Method.Extend(fnct),
	}
}
...
// pCreate holds the metadata of the CurrencyRate.Create() method
type pCreate struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCreate) Extend(fnct func(m.CurrencyRateSet, m.CurrencyRateData) m.CurrencyRateSet) pCreate {
	return pCreate{
		Method: m.Method.Extend(fnct),
	}
}
...
// pDefaultGet holds the metadata of the CurrencyRate.DefaultGet() method
type pDefaultGet struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pDefaultGet) Extend(fnct func(m.CurrencyRateSet) m.CurrencyRateData) pDefaultGet {
	return pDefaultGet{
		Method: m.Method.Extend(fnct),
	}
}
...
// pEnqueue holds the metadata of the CurrencyRate.Enqueue() method
type pEnqueue struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pEnqueue) Extend(fnct func(m.CurrencyRateSet, string, models.Methoder, ...interface{}) m.QueueJobSet) pEnqueue {
	return pEnqueue{
		Method: m.Method.Extend(fnct),
	}
}
...
// pEquals holds the metadata of the CurrencyRate.Equals() method
type pEquals struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pEquals) Extend(fnct func(m.CurrencyRateSet, m.CurrencyRateSet) bool) pEquals {
	return pEquals{
		Method: m.Method.Extend(fnct),
	}
}
...
// pExecuteO2MActions holds the metadata of the CurrencyRate.ExecuteO2MActions() method
type pExecuteO2MActions struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pExecuteO2MActions) Extend(fnct func(m.CurrencyRateSet, models.FieldName, *models.FieldInfo, interface{}) interface{}) pExecuteO2MActions {
...
// pFetch holds the metadata of the CurrencyRate.Fetch() method
type pFetch struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFetch) Extend(fnct func(m.CurrencyRateSet) m.CurrencyRateSet) pFetch {
	return pFetch{
		Method: m.Method.Extend(fnct),
	}
}
...
// pFieldGet holds the metadata of the CurrencyRate.FieldGet() method
type pFieldGet struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFieldGet) Extend(fnct func(m.CurrencyRateSet, models.FieldName) *models.FieldInfo) pFieldGet {
	return pFieldGet{
		Method: m.Method.Extend(fnct),
	}
}
...
// pFieldsGet holds the metadata of the CurrencyRate.FieldsGet() method
type pFieldsGet struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFieldsGet) Extend(fnct func(m.CurrencyRateSet, models.FieldsGetArgs) map[string]*models.FieldInfo) pFieldsGet {
	return pFieldsGet{
		Method: m.Method.Extend(fnct),
	}
}
...
// pFieldsViewGet holds the metadata of the CurrencyRate.FieldsViewGet() method
type pFieldsViewGet struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFieldsViewGet) Extend(fnct func(m.CurrencyRateSet, webtypes.FieldsViewGetParams) *webtypes.FieldsViewData) pFieldsViewGet {
...
// pFiltered holds the metadata of the CurrencyRate.Filtered() method
type pFiltered struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFiltered) Extend(fnct func(m.CurrencyRateSet, func(m.CurrencyRateSet) bool) m.CurrencyRateSet) pFiltered {
	return pFiltered{
		Method: m.Method.Extend(fnct),
	}
}
...
// pFormatRelationFields holds the metadata of the CurrencyRate.FormatRelationFields() method
type pFormatRelationFields struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFormatRelationFields) Extend(fnct func(m.CurrencyRateSet, models.RecordData, map[string]*models.FieldInfo) models.RecordData) pFormatRelationFields {
...
// pGetFormviewAction holds the metadata of the CurrencyRate.GetFormviewAction() method
type pGetFormviewAction struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pGetFormviewAction) Extend(fnct func(m.CurrencyRateSet) *actions.Action) pGetFormviewAction {
...
// pGetFormviewId holds the metadata of the CurrencyRate.GetFormviewId() method
type pGetFormviewId struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pGetFormviewId) Extend(fnct func(m.CurrencyRateSet) string) pGetFormviewId {
...
// pGetRecord holds the metadata of the CurrencyRate.GetRecord() method
type pGetRecord struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pGetRecord) Extend(fnct func(m.CurrencyRateSet, string) m.CurrencyRateSet) pGetRecord {
	return pGetRecord{
		Method: m.Method.Extend(fnct),
	}
}
...
// pGetToolbar holds the metadata of the CurrencyRate.GetToolbar() method
type pGetToolbar struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pGetToolbar) Extend(fnct func(m.CurrencyRateSet) webtypes.Toolbar) pGetToolbar {
	return pGetToolbar{
		Method: m.Method.Extend(fnct),
	}
}
...
// pGroupBy holds the metadata of the CurrencyRate.GroupBy() method
type pGroupBy struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pGroupBy) Extend(fnct func(m.CurrencyRateSet, ...models.FieldName) m.CurrencyRateSet) pGroupBy {
	return pGroupBy{
		Method: m.Method.Extend(fnct),
	}
}
...
// pIntersect holds the metadata of the CurrencyRate.Intersect() method
type pIntersect struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pIntersect) Extend(fnct func(m.CurrencyRateSet, m.CurrencyRateSet) m.CurrencyRateSet) pIntersect {
	return pIntersect{
		Method: m.Method.Extend(fnct),
	}
}
...
// pLimit holds the metadata of the CurrencyRate.Limit() method
type pLimit struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pLimit) Extend(fnct func(m.CurrencyRateSet, int) m.CurrencyRateSet) pLimit {
	return pLimit{
		Method: m.Method.Extend(fnct),
	}
}
...
// pLoad holds the metadata of the CurrencyRate.Load() method
type pLoad struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pLoad) Extend(fnct func(m.CurrencyRateSet, ...models.FieldName) m.CurrencyRateSet) pLoad {
	return pLoad{
		Method: m.Method.Extend(fnct),
	}
}
...
// pLoadViews holds the metadata of the CurrencyRate.LoadViews() method
type pLoadViews struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pLoadViews) Extend(fnct func(m.CurrencyRateSet, webtypes.LoadViewsArgs) *webtypes.LoadViewsData) pLoadViews {
	return pLoadViews{
		Method: m.Method.Extend(fnct),
	}
}
...
// pManageGroupsOnFields holds the metadata of the CurrencyRate.ManageGroupsOnFields() method
type pManageGroupsOnFields struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pManageGroupsOnFields) Extend(fnct func(m.CurrencyRateSet, *etree.Document, map[string]*models.FieldInfo)) pManageGroupsOnFields {
...
// pNameGet holds the metadata of the CurrencyRate.NameGet() method
type pNameGet struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pNameGet) Extend(fnct func(m.CurrencyRateSet) string) pNameGet {
	return pNameGet{
		Method: m.Method.Extend(fnct),
	}
}
...
// pNameSearch holds the metadata of the CurrencyRate.NameSearch() method
type pNameSearch struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pNameSearch) Extend(fnct func(m.CurrencyRateSet, webtypes.NameSearchParams) []webtypes.RecordIDWithName) pNameSearch {
	return pNameSearch{
		Method: m.Method.Extend(fnct),
	}
}
...
// pNew holds the metadata of the CurrencyRate.New() method
type pNew struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pNew) Extend(fnct func(m.CurrencyRateSet, m.CurrencyRateData) m.CurrencyRateSet) pNew {
	return pNew{
		Method: m.Method.Extend(fnct),
	}
}
...
// pNormalizeM2MData holds the metadata of the CurrencyRate.NormalizeM2MData() method
type pNormalizeM2MData struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pNormalizeM2MData) Extend(fnct func(m.CurrencyRateSet, models.FieldName, *models.FieldInfo, interface{}) interface{}) pNormalizeM2MData {
...
// pOffset holds the metadata of the CurrencyRate.Offset() method
type pOffset struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pOffset) Extend(fnct func(m.CurrencyRateSet, int) m.CurrencyRateSet) pOffset {
	return pOffset{
		Method: m.Method.Extend(fnct),
	}
}
...
// pOnchange holds the metadata of the CurrencyRate.Onchange() method
type pOnchange struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pOnchange) Extend(fnct func(m.CurrencyRateSet, models.OnchangeParams) models.OnchangeResult) pOnchange {
	return pOnchange{
		Method: m.Method.Extend(fnct),
	}
}
...
// pOrderBy holds the metadata of the CurrencyRate.OrderBy() method
type pOrderBy struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pOrderBy) Extend(fnct func(m.CurrencyRateSet, ...string) m.CurrencyRateSet) pOrderBy {
	return pOrderBy{
		Method: m.Method.Extend(fnct),
	}
}
...
// pPostProcessCreateValues holds the metadata of the CurrencyRate.PostProcessCreateValues() method
type pPostProcessCreateValues struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pPostProcessCreateValues) Extend(fnct func(m.CurrencyRateSet, models.RecordData)) pPostProcessCreateValues {
...
// pPostProcessFilters holds the metadata of the CurrencyRate.PostProcessFilters() method
type pPostProcessFilters struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pPostProcessFilters) Extend(fnct func(m.CurrencyRateSet, map[models.FieldName]models.Conditioner) map[string][]interface{}) pPostProcessFilters {
...
// pProcessCreateValues holds the metadata of the CurrencyRate.ProcessCreateValues() method
type pProcessCreateValues struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pProcessCreateValues) Extend(fnct func(m.CurrencyRateSet, models.RecordData) (models.RecordData, models.RecordData)) pProcessCreateValues {
...
// pProcessElementAttrs holds the metadata of the CurrencyRate.ProcessElementAttrs() method
type pProcessElementAttrs struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pProcessElementAttrs) Extend(fnct func(m.CurrencyRateSet, *etree.Element, map[string]*models.FieldInfo) map[string]interface{}) pProcessElementAttrs {
...
// pProcessFieldElementModifiers holds the metadata of the CurrencyRate.ProcessFieldElementModifiers() method
type pProcessFieldElementModifiers struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pProcessFieldElementModifiers) Extend(fnct func(m.CurrencyRateSet, *etree.Element, map[string]*models.FieldInfo, map[string]interface{}) map[string]interface{}) pProcessFieldElementModifiers {
...
// pProcessView holds the metadata of the CurrencyRate.ProcessView() method
type pProcessView struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pProcessView) Extend(fnct func(m.CurrencyRateSet, *etree.Document, map[string]*models.FieldInfo) string) pProcessView {
	return pProcessView{
		Method: m.Method.Extend(fnct),
	}
}
...
// pProcessWriteValues holds the metadata of the CurrencyRate.ProcessWriteValues() method
type pProcessWriteValues struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pProcessWriteValues) Extend(fnct func(m.CurrencyRateSet, models.RecordData) models.RecordData) pProcessWriteValues {
...
// pRead holds the metadata of the CurrencyRate.Read() method
type pRead struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pRead) Extend(fnct func(m.CurrencyRateSet, models.FieldNames) []models.RecordData) pRead {
	return pRead{
		Method: m.Method.Extend(fnct),
	}
}
...
// pReadGroup holds the metadata of the CurrencyRate.ReadGroup() method
type pReadGroup struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pReadGroup) Extend(fnct func(m.CurrencyRateSet, webtypes.ReadGroupParams) []models.FieldMap) pReadGroup {
	return pReadGroup{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSQLFromCondition holds the metadata of the CurrencyRate.SQLFromCondition() method
type pSQLFromCondition struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSQLFromCondition) Extend(fnct func(m.CurrencyRateSet, *models.Condition) (string, models.SQLParams)) pSQLFromCondition {
...
// pSearch holds the metadata of the CurrencyRate.Search() method
type pSearch struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearch) Extend(fnct func(m.CurrencyRateSet, q.CurrencyRateCondition) m.CurrencyRateSet) pSearch {
	return pSearch{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSearchAll holds the metadata of the CurrencyRate.SearchAll() method
type pSearchAll struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearchAll) Extend(fnct func(m.CurrencyRateSet) m.CurrencyRateSet) pSearchAll {
	return pSearchAll{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSearchByName holds the metadata of the CurrencyRate.SearchByName() method
type pSearchByName struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearchByName) Extend(fnct func(m.CurrencyRateSet, string, operator.Operator, q.CurrencyRateCondition, int) m.CurrencyRateSet) pSearchByName {
...
// pSearchCount holds the metadata of the CurrencyRate.SearchCount() method
type pSearchCount struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearchCount) Extend(fnct func(m.CurrencyRateSet) int) pSearchCount {
	return pSearchCount{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSearchDomain holds the metadata of the CurrencyRate.SearchDomain() method
type pSearchDomain struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearchDomain) Extend(fnct func(m.CurrencyRateSet, domains.Domain) m.CommonMixinSet) pSearchDomain {
...
// pSearchRead holds the metadata of the CurrencyRate.SearchRead() method
type pSearchRead struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearchRead) Extend(fnct func(m.CurrencyRateSet, webtypes.SearchParams) []models.RecordData) pSearchRead {
	return pSearchRead{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSorted holds the metadata of the CurrencyRate.Sorted() method
type pSorted struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSorted) Extend(fnct func(m.CurrencyRateSet, func(m.CurrencyRateSet, m.CurrencyRateSet) bool) m.CurrencyRateSet) pSorted {
	return pSorted{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSortedByField holds the metadata of the CurrencyRate.SortedByField() method
type pSortedByField struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSortedByField) Extend(fnct func(m.CurrencyRateSet, models.FieldName, bool) m.CurrencyRateSet) pSortedByField {
...
// pSortedDefault holds the metadata of the CurrencyRate.SortedDefault() method
type pSortedDefault struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSortedDefault) Extend(fnct func(m.CurrencyRateSet) m.CurrencyRateSet) pSortedDefault {
...
// pSubtract holds the metadata of the CurrencyRate.Subtract() method
type pSubtract struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSubtract) Extend(fnct func(m.CurrencyRateSet, m.CurrencyRateSet) m.CurrencyRateSet) pSubtract {
	return pSubtract{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSudo holds the metadata of the CurrencyRate.Sudo() method
type pSudo struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSudo) Extend(fnct func(m.CurrencyRateSet, ...int64) m.CurrencyRateSet) pSudo {
	return pSudo{
		Method: m.Method.Extend(fnct),
	}
}
...
// pToggleActive holds the metadata of the CurrencyRate.ToggleActive() method
type pToggleActive struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pToggleActive) Extend(fnct func(m.CurrencyRateSet)) pToggleActive {
...
// pUnion holds the metadata of the CurrencyRate.Union() method
type pUnion struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pUnion) Extend(fnct func(m.CurrencyRateSet, m.CurrencyRateSet) m.CurrencyRateSet) pUnion {
	return pUnion{
		Method: m.Method.Extend(fnct),
	}
}
...
// pUnlink holds the metadata of the CurrencyRate.Unlink() method
type pUnlink struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pUnlink) Extend(fnct func(m.CurrencyRateSet) int64) pUnlink {
	return pUnlink{
		Method: m.Method.Extend(fnct),
	}
}
...
// pWebReadGroup holds the metadata of the CurrencyRate.WebReadGroup() method
type pWebReadGroup struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWebReadGroup) Extend(fnct func(m.CurrencyRateSet, webtypes.WebReadGroupParams) webtypes.WebReadGroupResult) pWebReadGroup {
...
// pWebReadGroupPrivate holds the metadata of the CurrencyRate.WebReadGroupPrivate() method
type pWebReadGroupPrivate struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWebReadGroupPrivate) Extend(fnct func(m.CurrencyRateSet, webtypes.WebReadGroupParams) []models.FieldMap) pWebReadGroupPrivate {
...
// pWebSearchRead holds the metadata of the CurrencyRate.WebSearchRead() method
type pWebSearchRead struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWebSearchRead) Extend(fnct func(m.CurrencyRateSet, webtypes.SearchParams) webtypes.SearchReadResult) pWebSearchRead {
...
// pWithContext holds the metadata of the CurrencyRate.WithContext() method
type pWithContext struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWithContext) Extend(fnct func(m.CurrencyRateSet, string, interface{}) m.CurrencyRateSet) pWithContext {
	return pWithContext{
		Method: m.Method.Extend(fnct),
	}
}
...
// pWithEnv holds the metadata of the CurrencyRate.WithEnv() method
type pWithEnv struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWithEnv) Extend(fnct func(m.CurrencyRateSet, models.Environment) m.CurrencyRateSet) pWithEnv {
	return pWithEnv{
		Method: m.Method.Extend(fnct),
	}
}
...
// pWithNewContext holds the metadata of the CurrencyRate.WithNewContext() method
type pWithNewContext struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWithNewContext) Extend(fnct func(m.CurrencyRateSet, *types.Context) m.CurrencyRateSet) pWithNewContext {
...
// pWrite holds the metadata of the CurrencyRate.Write() method
type pWrite struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWrite) Extend(fnct func(m.CurrencyRateSet, m.CurrencyRateData) bool) pWrite {
	return pWrite{
		Method: m.Method.Extend(fnct),
	}
}
...
func (d CurrencyRateData) Set(field models.FieldName, value interface{}) m.CurrencyRateData {
...
func (d CurrencyRateData) Unset(field models.FieldName) m.CurrencyRateData {
	return &CurrencyRateData{
...
func (d CurrencyRateData) Copy() m.CurrencyRateData {
	return &CurrencyRateData{
		d.ModelData.Copy(),
	}
}
...
func (d CurrencyRateData) MergeWith(other m.CurrencyRateData) {
...
func (d CurrencyRateData) Company() m.CompanySet {
...
func (d CurrencyRateData) HasCompany() bool {
...
func (d CurrencyRateData) SetCompany(value m.CompanySet) m.CurrencyRateData {
...
// It returns this CurrencyRateData so that calls can be chained.
func (d CurrencyRateData) UnsetCompany() m.CurrencyRateData {
...
func (d CurrencyRateData) CreateCompany(related m.CompanyData) m.CurrencyRateData {
...
// the Go zero value for the type is returned.
func (d CurrencyRateData) CreateDate() dates.DateTime {
...
func (d CurrencyRateData) HasCreateDate() bool {
...
// It returns this CurrencyRateData so that calls can be chained.
func (d CurrencyRateData) SetCreateDate(value dates.DateTime) m.CurrencyRateData {
...
// It returns this CurrencyRateData so that calls can be chained.
func (d CurrencyRateData) UnsetCreateDate() m.CurrencyRateData {
...
// the Go zero value for the type is returned.
func (d CurrencyRateData) CreateUID() int64 {
...
func (d CurrencyRateData) HasCreateUID() bool {
...
// It returns this CurrencyRateData so that calls can be chained.
func (d CurrencyRateData) SetCreateUID(value int64) m.CurrencyRateData {
...
// It returns this CurrencyRateData so that calls can be chained.
func (d CurrencyRateData) UnsetCreateUID() m.CurrencyRateData {
...
// the Go zero value for the type is returned.
func (d CurrencyRateData) Currency() m.CurrencySet {
...
// It returns this CurrencyRateData so that calls can be chained.
func (d CurrencyRateData) UnsetCurrency() m.CurrencyRateData {
...
//
// This method can be called multiple times to create multiple records
func (d CurrencyRateData) CreateCurrency(related m.CurrencyData) m.CurrencyRateData {
...
// the Go zero value for the type is returned.
func (d CurrencyRateData) DisplayName() string {
...
func (d CurrencyRateData) HasDisplayName() bool {
...
// It returns this CurrencyRateData so that calls can be chained.
func (d CurrencyRateData) SetDisplayName(value string) m.CurrencyRateData {
...
// It returns this CurrencyRateData so that calls can be chained.
func (d CurrencyRateData) UnsetDisplayName() m.CurrencyRateData {
...
// the Go zero value for the type is returned.
func (d CurrencyRateData) HexyaExternalID() string {
...
func (d CurrencyRateData) HasHexyaExternalID() bool {
...
// It returns this CurrencyRateData so that calls can be chained.
func (d CurrencyRateData) SetHexyaExternalID(value string) m.CurrencyRateData {
...
// It returns this CurrencyRateData so that calls can be chained.
func (d CurrencyRateData) UnsetHexyaExternalID() m.CurrencyRateData {
...
// the Go zero value for the type is returned.
func (d CurrencyRateData) HexyaVersion() int {
...
func (d CurrencyRateData) HasHexyaVersion() bool {
...
// It returns this CurrencyRateData so that calls can be chained.
func (d CurrencyRateData) SetHexyaVersion(value int) m.CurrencyRateData {
...
// It returns this CurrencyRateData so that calls can be chained.
func (d CurrencyRateData) UnsetHexyaVersion() m.CurrencyRateData {
...
// the Go zero value for the type is returned.
func (d CurrencyRateData) ID() int64 {
...
func (d CurrencyRateData) HasID() bool {
	return d.ModelData.Has(models.NewFieldName("ID", "id"))
}

// SetID sets the ID field with the given value.
// It returns this CurrencyRateData so that calls can be chained.
func (d CurrencyRateData) SetID(value int64) m.CurrencyRateData {
...
// It returns this CurrencyRateData so that calls can be chained.
func (d CurrencyRateData) UnsetID() m.CurrencyRateData {
...
// the Go zero value for the type is returned.
func (d CurrencyRateData) LastUpdate() dates.DateTime {
...
func (d CurrencyRateData) HasLastUpdate() bool {
...
// It returns this CurrencyRateData so that calls can be chained.
func (d CurrencyRateData) SetLastUpdate(value dates.DateTime) m.CurrencyRateData {
...
// It returns this CurrencyRateData so that calls can be chained.
func (d CurrencyRateData) UnsetLastUpdate() m.CurrencyRateData {
...
// the Go zero value for the type is returned.
func (d CurrencyRateData) Name() dates.DateTime {
...
func (d CurrencyRateData) HasName() bool {
	return d.ModelData.Has(models.NewFieldName("Name", "name"))
}

// SetName sets the Name field with the given value.
// It returns this CurrencyRateData so that calls can be chained.
func (d CurrencyRateData) SetName(value dates.DateTime) m.CurrencyRateData {
...
// It returns this CurrencyRateData so that calls can be chained.
func (d CurrencyRateData) UnsetName() m.CurrencyRateData {
...
// the Go zero value for the type is returned.
func (d CurrencyRateData) Rate() float64 {
...
func (d CurrencyRateData) HasRate() bool {
	return d.ModelData.Has(models.NewFieldName("Rate", "rate"))
}

// SetRate sets the Rate field with the given value.
// It returns this CurrencyRateData so that calls can be chained.
func (d CurrencyRateData) SetRate(value float64) m.CurrencyRateData {
...
// It returns this CurrencyRateData so that calls can be chained.
func (d CurrencyRateData) UnsetRate() m.CurrencyRateData {
...
// the Go zero value for the type is returned.
func (d CurrencyRateData) WriteDate() dates.DateTime {
...
func (d CurrencyRateData) HasWriteDate() bool {
...
// It returns this CurrencyRateData so that calls can be chained.
func (d CurrencyRateData) SetWriteDate(value dates.DateTime) m.CurrencyRateData {
...
// It returns this CurrencyRateData so that calls can be chained.
func (d CurrencyRateData) UnsetWriteDate() m.CurrencyRateData {
...
// the Go zero value for the type is returned.
func (d CurrencyRateData) WriteUID() int64 {
...
// It returns this CurrencyRateData so that calls can be chained.
func (d CurrencyRateData) UnsetWriteUID() m.CurrencyRateData {
	d.ModelData.Unset(models.NewFieldName("WriteUID", "write_uid"))
	return d
}

var _ m.CurrencyRateData = new(CurrencyRateData)
var _ m.CurrencyRateData = CurrencyRateData{}
...
type CurrencyRateGroupAggregateRow struct {
	values    m.CurrencyRateData
	count     int
	condition q.CurrencyRateCondition
}

// Values returns the values of the actual query
func (a CurrencyRateGroupAggregateRow) Values() m.CurrencyRateData {
	return a.values
}

// Count returns the number of lines aggregated into this one
func (a CurrencyRateGroupAggregateRow) Count() int {
	return a.count
}

// Condition can be used to query the aggregated rows separately if needed
func (a CurrencyRateGroupAggregateRow) Condition() q.CurrencyRateCondition {
	return a.condition
}
...
func (s CurrencyRateSet) ForceLoad(fields ...models.FieldName) m.CurrencyRateSet {
...
// RecordSets
func (s CurrencyRateSet) Records() []m.CurrencyRateSet {
	recs := s.RecordCollection.Records()
	res := make([]m.CurrencyRateSet, len(recs))
	for i, rec := range recs {
		res[i] = rec.Wrap("CurrencyRate").(m.CurrencyRateSet)
	}
	return res
}

// CartesianProduct returns the cartesian product of this CurrencyRateSet with others.
func (s CurrencyRateSet) CartesianProduct(others ...m.CurrencyRateSet) []m.CurrencyRateSet {
...
func (s CurrencyRateSet) First() m.CurrencyRateData {
	return &CurrencyRateData{
...
func (s CurrencyRateSet) All() []m.CurrencyRateData {
	allSlice := s.RecordCollection.All()
	res := make([]m.CurrencyRateData, len(allSlice))
	for i, v := range allSlice {
		res[i] = &CurrencyRateData{v}
	}
	return res
}

// Sorted returns a new CurrencyRateSet sorted according to the given less function.
//
// The less function should return true if rs1 < rs2
func (s CurrencyRateSet) Sorted(less func(rs1, rs2 m.CurrencyRateSet) bool) m.CurrencyRateSet {
	res := s.RecordCollection.Sorted(func(rc1 models.RecordSet, rc2 models.RecordSet) bool {
		return less(CurrencyRateSet{RecordCollection: rc1.Collection()}, CurrencyRateSet{RecordCollection: rc2.Collection()})
	})
	return res.Wrap("CurrencyRate").(m.CurrencyRateSet)
}

// Filtered returns a new CurrencyRateSet with only the elements of this record set
// for which test is true.
//
// Note that if this CurrencyRateSet is not fully loaded, this function will call the database
...
func (s CurrencyRateSet) Filtered(test func(rs m.CurrencyRateSet) bool) m.CurrencyRateSet {
	res := s.RecordCollection.Filtered(func(rc models.RecordSet) bool {
		return test(CurrencyRateSet{RecordCollection: rc.Collection()})
	})
	return res.Wrap("CurrencyRate").(m.CurrencyRateSet)
}
...
func (s CurrencyRateSet) Company() m.CompanySet {
...
func (s CurrencyRateSet) SetCompany(value m.CompanySet) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s CurrencyRateSet) CreateDate() dates.DateTime {
...
func (s CurrencyRateSet) SetCreateDate(value dates.DateTime) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s CurrencyRateSet) CreateUID() int64 {
...
func (s CurrencyRateSet) SetCreateUID(value int64) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s CurrencyRateSet) Currency() m.CurrencySet {
...
func (s CurrencyRateSet) SetCurrency(value m.CurrencySet) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s CurrencyRateSet) DisplayName() string {
...
func (s CurrencyRateSet) SetDisplayName(value string) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s CurrencyRateSet) HexyaExternalID() string {
...
func (s CurrencyRateSet) SetHexyaExternalID(value string) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s CurrencyRateSet) HexyaVersion() int {
...
func (s CurrencyRateSet) SetHexyaVersion(value int) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s CurrencyRateSet) ID() int64 {
...
func (s CurrencyRateSet) SetID(value int64) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s CurrencyRateSet) LastUpdate() dates.DateTime {
...
func (s CurrencyRateSet) SetLastUpdate(value dates.DateTime) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s CurrencyRateSet) Name() dates.DateTime {
	res, _ := s.RecordCollection.Get(models.NewFieldName("Name", "name")).(dates.DateTime)
	return res
}
...
func (s CurrencyRateSet) SetRate(value float64) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s CurrencyRateSet) WriteDate() dates.DateTime {
...
func (s CurrencyRateSet) SetWriteDate(value dates.DateTime) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s CurrencyRateSet) WriteUID() int64 {
...
func (s CurrencyRateSet) SetWriteUID(value int64) {
...
func (s CurrencyRateSet) Super() m.CurrencyRateSet {
	return s.RecordCollection.Super().Wrap("CurrencyRate").(m.CurrencyRateSet)
}

// ModelData returns a new CurrencyRateData object populated with the values
// of the given FieldMap.
func (s CurrencyRateSet) ModelData(fMap models.FieldMap) m.CurrencyRateData {
	res := &CurrencyRateData{
		models.NewModelData(models.Registry.MustGet("CurrencyRate")),
	}
	for k, v := range fMap {
		res.Set(models.Registry.MustGet("CurrencyRate").FieldName(k), v)
	}
	return res
}
...
func (s CurrencyRateSet) AddDomainLimitOffset(domain domains.Domain, limit int, offset int, order string) m.CurrencyRateSet {
	res := s.Collection().Call("AddDomainLimitOffset", domain, limit, offset, order)
	resTyped := res.(models.RecordSet).Collection().Wrap("CurrencyRate").(m.CurrencyRateSet)
	return resTyped
}

// AddModifiers adds the modifiers attribute nodes to given xml doc.
func (s CurrencyRateSet) AddModifiers(doc *etree.Document, fieldInfos map[string]*models.FieldInfo) {
...
func (s CurrencyRateSet) AddNamesToRelations(data models.RecordData, fInfos map[string]*models.FieldInfo) models.RecordData {
...
func (s CurrencyRateSet) Aggregates(fieldNames ...models.FieldName) []m.CurrencyRateGroupAggregateRow {
	res := s.Collection().Call("Aggregates", fieldNames)
	resTyped, _ := res.([]m.CurrencyRateGroupAggregateRow)
	return resTyped
}

// Browse returns a new RecordSet with only the records with the given ids.
// Note that this function is just a shorcut for Search on a list of ids.
func (s CurrencyRateSet) Browse(ids []int64) m.CurrencyRateSet {
...
func (s CurrencyRateSet) BrowseOne(id int64) m.CurrencyRateSet {
...
func (s CurrencyRateSet) CheckAccessRights(args webtypes.CheckAccessRightsArgs) bool {
...
func (s CurrencyRateSet) CheckExecutionPermission(method *models.Method, dontPanic ...bool) bool {
...
func (s CurrencyRateSet) CheckRecursion() bool {
...
func (s CurrencyRateSet) ComputeDisplayName() *models.ModelData {
...
func (s CurrencyRateSet) ComputeLastUpdate() *models.ModelData {
	res := s.Collection().Call("ComputeLastUpdate")
	resTyped, _ := res.(*models.ModelData)
	return resTyped
}

// Copy duplicates the given CurrencyRate record, overridding values with overrides.
func (s CurrencyRateSet) Copy(overrides m.CurrencyRateData) m.CurrencyRateSet {
...
func (s CurrencyRateSet) CopyData(overrides m.CurrencyRateData) m.CurrencyRateData {
	res := s.Collection().Call("CopyData", overrides)
	resTyped, _ := res.(models.RecordData)
	return resTyped.Underlying().Wrap().(m.CurrencyRateData)
}

// Create inserts a CurrencyRate record in the database from the given data.
// Returns the created CurrencyRateSet.
func (s CurrencyRateSet) Create(data m.CurrencyRateData) m.CurrencyRateSet {
	res := s.Collection().Call("Create", data)
	resTyped := res.(models.RecordSet).Collection().Wrap("CurrencyRate").(m.CurrencyRateSet)
	return resTyped
}

// DefaultGet returns a CurrencyRateData with the default values for the model.
func (s CurrencyRateSet) DefaultGet() m.CurrencyRateData {
...
func (s CurrencyRateSet) Enqueue(description string, method models.Methoder, arguments ...interface{}) m.QueueJobSet {
...
func (s CurrencyRateSet) Equals(other m.CurrencyRateSet) bool {
...
func (s CurrencyRateSet) ExecuteO2MActions(fieldName models.FieldName, info *models.FieldInfo, value interface{}) interface{} {
...
func (s CurrencyRateSet) Fetch() m.CurrencyRateSet {
...
func (s CurrencyRateSet) FieldGet(field models.FieldName) *models.FieldInfo {
...
func (s CurrencyRateSet) FieldsGet(args models.FieldsGetArgs) map[string]*models.FieldInfo {
...
// view architecture.
func (s CurrencyRateSet) FieldsViewGet(args webtypes.FieldsViewGetParams) *webtypes.FieldsViewData {
...
func (s CurrencyRateSet) FormatRelationFields(data models.RecordData, fInfos map[string]*models.FieldInfo) models.RecordData {
...
func (s CurrencyRateSet) GetFormviewAction() *actions.Action {
...
// This method is meant to be overridden in addons that want
// to give specific view ids for example.
func (s CurrencyRateSet) GetFormviewId() string {
...
func (s CurrencyRateSet) GetRecord(externalID string) m.CurrencyRateSet {
...
func (s CurrencyRateSet) GetToolbar() webtypes.Toolbar {
...
func (s CurrencyRateSet) GroupBy(exprs ...models.FieldName) m.CurrencyRateSet {
...
func (s CurrencyRateSet) Intersect(other m.CurrencyRateSet) m.CurrencyRateSet {
...
func (s CurrencyRateSet) Limit(limit int) m.CurrencyRateSet {
...
// model are retrieved.
func (s CurrencyRateSet) Load(fields ...models.FieldName) m.CurrencyRateSet {
...
func (s CurrencyRateSet) LoadViews(args webtypes.LoadViewsArgs) *webtypes.LoadViewsData {
...
func (s CurrencyRateSet) ManageGroupsOnFields(doc *etree.Document, fieldInfos map[string]*models.FieldInfo) {
	s.Collection().Call("ManageGroupsOnFields", doc, fieldInfos)
}

// NameGet retrieves the human readable name of this record.`,
func (s CurrencyRateSet) NameGet() string {
...
func (s CurrencyRateSet) NameSearch(params webtypes.NameSearchParams) []webtypes.RecordIDWithName {
	res := s.Collection().Call("NameSearch", params)
	resTyped, _ := res.([]webtypes.RecordIDWithName)
	return resTyped
}

// New creates a CurrencyRate record in memory from the given data.
// Such CurrencyRateSet has a negative ID and cannot be reloaded from the database
func (s CurrencyRateSet) New(data m.CurrencyRateData) m.CurrencyRateSet {
...
func (s CurrencyRateSet) NormalizeM2MData(fieldName models.FieldName, info *models.FieldInfo, value interface{}) interface{} {
...
func (s CurrencyRateSet) Offset(offset int) m.CurrencyRateSet {
...
func (s CurrencyRateSet) Onchange(params models.OnchangeParams) models.OnchangeResult {
...
func (s CurrencyRateSet) OrderBy(exprs ...string) m.CurrencyRateSet {
...
func (s CurrencyRateSet) PostProcessCreateValues(data models.RecordData) {
...
func (s CurrencyRateSet) PostProcessFilters(in map[models.FieldName]models.Conditioner) map[string][]interface{} {
...
func (s CurrencyRateSet) ProcessCreateValues(data models.RecordData) (models.RecordData, models.RecordData) {
...
func (s CurrencyRateSet) ProcessElementAttrs(element *etree.Element, fieldInfos map[string]*models.FieldInfo) map[string]interface{} {
...
func (s CurrencyRateSet) ProcessFieldElementModifiers(element *etree.Element, fieldInfos map[string]*models.FieldInfo, modifiers map[string]interface{}) map[string]interface{} {
...
func (s CurrencyRateSet) ProcessView(arch *etree.Document, fieldInfos map[string]*models.FieldInfo) string {
...
// compatible with the ORM, in particular for relation fields
func (s CurrencyRateSet) ProcessWriteValues(data models.RecordData) models.RecordData {
...
func (s CurrencyRateSet) Read(fields models.FieldNames) []models.RecordData {
...
func (s CurrencyRateSet) ReadGroup(params webtypes.ReadGroupParams) []models.FieldMap {
...
// the given condition.`,
func (s CurrencyRateSet) SQLFromCondition(c *models.Condition) (string, models.SQLParams) {
...
// Search returns a new CurrencyRateSet filtering on the current one with the additional given Condition
func (s CurrencyRateSet) Search(condition q.CurrencyRateCondition) m.CurrencyRateSet {
...
func (s CurrencyRateSet) SearchAll() m.CurrencyRateSet {
	res := s.Collection().Call("SearchAll")
	resTyped := res.(models.RecordSet).Collection().Wrap("CurrencyRate").(m.CurrencyRateSet)
	return resTyped
}

// SearchByName searches for CurrencyRate records that have a display name matching the given
...
// value for a relational field. Sometimes be seen as the inverse
// function of NameGet but it is not guaranteed to be.
func (s CurrencyRateSet) SearchByName(name string, op operator.Operator, additionalCond q.CurrencyRateCondition, limit int) m.CurrencyRateSet {
...
func (s CurrencyRateSet) SearchCount() int {
...
func (s CurrencyRateSet) SearchDomain(domain domains.Domain) m.CommonMixinSet {
...
func (s CurrencyRateSet) SearchRead(params webtypes.SearchParams) []models.RecordData {
...
func (s CurrencyRateSet) SortedByField(namer models.FieldName, reverse bool) m.CurrencyRateSet {
...
func (s CurrencyRateSet) SortedDefault() m.CurrencyRateSet {
...
func (s CurrencyRateSet) Subtract(other m.CurrencyRateSet) m.CurrencyRateSet {
...
func (s CurrencyRateSet) Sudo(userID ...int64) m.CurrencyRateSet {
...
func (s CurrencyRateSet) ToggleActive() {
...
func (s CurrencyRateSet) Union(other m.CurrencyRateSet) m.CurrencyRateSet {
...
func (s CurrencyRateSet) Unlink() int64 {
...
func (s CurrencyRateSet) WebReadGroup(params webtypes.WebReadGroupParams) webtypes.WebReadGroupResult {
...
func (s CurrencyRateSet) WebReadGroupPrivate(params webtypes.WebReadGroupParams) []models.FieldMap {
...
func (s CurrencyRateSet) WebSearchRead(params webtypes.SearchParams) webtypes.SearchReadResult {
...
func (s CurrencyRateSet) WithContext(key string, value interface{}) m.CurrencyRateSet {
...
func (s CurrencyRateSet) WithEnv(env models.Environment) m.CurrencyRateSet {
...
func (s CurrencyRateSet) WithNewContext(context *types.Context) m.CurrencyRateSet {
...
// CurrencyRate records in the database with the given data.
func (s CurrencyRateSet) Write(data m.CurrencyRateData) bool {
...
// Aggregates returns the result of this RecordSet query, which must by a grouped query.
func m_CurrencyRate_Aggregates(rs CurrencyRateSet, fieldNames ...models.FieldName) []m.CurrencyRateGroupAggregateRow {
	lines := rs.RecordCollection.Aggregates(fieldNames...)
	res := make([]m.CurrencyRateGroupAggregateRow, len(lines))
	for i, l := range lines {
		res[i] = CurrencyRateGroupAggregateRow{
			values: l.Values.Wrap().(m.CurrencyRateData),
			count:  l.Count,
			condition: q.CurrencyRateCondition{
...
func init() {
	models.CreateModel("CurrencyRate", 0)
	models.Registry.MustGet("CurrencyRate").AddFields(map[string]models.FieldDefinition{
	...
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("ActionArchive")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("ActionUnarchive")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("AddDomainLimitOffset")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("AddModifiers")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("AddNamesToRelations")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("Browse")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("BrowseOne")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("CheckAccessRights")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("CheckExecutionPermission")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("CheckRecursion")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("ComputeDisplayName")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("ComputeLastUpdate")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("Copy")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("CopyData")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("Create")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("DefaultGet")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("Enqueue")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("Equals")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("ExecuteO2MActions")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("Fetch")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("FieldGet")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("FieldsGet")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("FieldsViewGet")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("FormatRelationFields")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("GetFormviewAction")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("GetFormviewId")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("GetRecord")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("GetToolbar")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("GroupBy")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("Intersect")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("Limit")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("Load")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("LoadViews")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("ManageGroupsOnFields")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("NameGet")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("NameSearch")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("New")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("NormalizeM2MData")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("Offset")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("Onchange")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("OrderBy")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("PostProcessCreateValues")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("PostProcessFilters")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("ProcessCreateValues")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("ProcessElementAttrs")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("ProcessFieldElementModifiers")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("ProcessView")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("ProcessWriteValues")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("Read")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("ReadGroup")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("SQLFromCondition")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("Search")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("SearchAll")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("SearchByName")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("SearchCount")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("SearchDomain")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("SearchRead")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("SortedByField")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("SortedDefault")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("Subtract")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("Sudo")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("ToggleActive")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("Union")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("Unlink")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("WebReadGroup")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("WebReadGroupPrivate")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("WebSearchRead")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("WithContext")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("WithEnv")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("WithNewContext")
	models.Registry.MustGet("CurrencyRate").AddEmptyMethod("Write")
	models.Registry.MustGet("CurrencyRate").NewMethod("Aggregates", m_CurrencyRate_Aggregates)
	models.RegisterRecordSetWrapper("CurrencyRate", CurrencyRateSet{})
	models.RegisterModelDataWrapper("CurrencyRate", CurrencyRateData{})
}
