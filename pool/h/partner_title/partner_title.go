...
// Shortcut returns a pointer to the Shortcut Field.
func (c FieldsCollection) Shortcut() *models.Field {
	return c.MustGet("Shortcut")
}
...
// pActionArchive holds the metadata of the PartnerTitle.ActionArchive() method
type pActionArchive struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pActionArchive) Extend(fnct func(m.PartnerTitleSet)) pActionArchive {
...
// pActionUnarchive holds the metadata of the PartnerTitle.ActionUnarchive() method
type pActionUnarchive struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pActionUnarchive) Extend(fnct func(m.PartnerTitleSet)) pActionUnarchive {
...
// pAddDomainLimitOffset holds the metadata of the PartnerTitle.AddDomainLimitOffset() method
type pAddDomainLimitOffset struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pAddDomainLimitOffset) Extend(fnct func(m.PartnerTitleSet, domains.Domain, int, int, string) m.PartnerTitleSet) pAddDomainLimitOffset {
...
// pAddModifiers holds the metadata of the PartnerTitle.AddModifiers() method
type pAddModifiers struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pAddModifiers) Extend(fnct func(m.PartnerTitleSet, *etree.Document, map[string]*models.FieldInfo)) pAddModifiers {
...
// pAddNamesToRelations holds the metadata of the PartnerTitle.AddNamesToRelations() method
type pAddNamesToRelations struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pAddNamesToRelations) Extend(fnct func(m.PartnerTitleSet, models.RecordData, map[string]*models.FieldInfo) models.RecordData) pAddNamesToRelations {
...
// pAggregates holds the metadata of the PartnerTitle.Aggregates() method
type pAggregates struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pAggregates) Extend(fnct func(m.PartnerTitleSet, ...models.FieldName) []m.PartnerTitleGroupAggregateRow) pAggregates {
	return pAggregates{
		Method: m.Method.Extend(fnct),
	}
}
...
// pBrowse holds the metadata of the PartnerTitle.Browse() method
type pBrowse struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pBrowse) Extend(fnct func(m.PartnerTitleSet, []int64) m.PartnerTitleSet) pBrowse {
	return pBrowse{
		Method: m.Method.Extend(fnct),
	}
}
...
// pBrowseOne holds the metadata of the PartnerTitle.BrowseOne() method
type pBrowseOne struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pBrowseOne) Extend(fnct func(m.PartnerTitleSet, int64) m.PartnerTitleSet) pBrowseOne {
	return pBrowseOne{
		Method: m.Method.Extend(fnct),
	}
}
...
// pCartesianProduct holds the metadata of the PartnerTitle.CartesianProduct() method
type pCartesianProduct struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCartesianProduct) Extend(fnct func(m.PartnerTitleSet, ...m.PartnerTitleSet) []m.PartnerTitleSet) pCartesianProduct {
...
// pCheckAccessRights holds the metadata of the PartnerTitle.CheckAccessRights() method
type pCheckAccessRights struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCheckAccessRights) Extend(fnct func(m.PartnerTitleSet, webtypes.CheckAccessRightsArgs) bool) pCheckAccessRights {
...
// pCheckExecutionPermission holds the metadata of the PartnerTitle.CheckExecutionPermission() method
type pCheckExecutionPermission struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCheckExecutionPermission) Extend(fnct func(m.PartnerTitleSet, *models.Method, ...bool) bool) pCheckExecutionPermission {
...
// pCheckRecursion holds the metadata of the PartnerTitle.CheckRecursion() method
type pCheckRecursion struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCheckRecursion) Extend(fnct func(m.PartnerTitleSet) bool) pCheckRecursion {
...
// pComputeDisplayName holds the metadata of the PartnerTitle.ComputeDisplayName() method
type pComputeDisplayName struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pComputeDisplayName) Extend(fnct func(m.PartnerTitleSet) *models.ModelData) pComputeDisplayName {
...
// pComputeLastUpdate holds the metadata of the PartnerTitle.ComputeLastUpdate() method
type pComputeLastUpdate struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pComputeLastUpdate) Extend(fnct func(m.PartnerTitleSet) *models.ModelData) pComputeLastUpdate {
...
// pCopy holds the metadata of the PartnerTitle.Copy() method
type pCopy struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCopy) Extend(fnct func(m.PartnerTitleSet, m.PartnerTitleData) m.PartnerTitleSet) pCopy {
	return pCopy{
		Method: m.Method.Extend(fnct),
	}
}
...
// pCopyData holds the metadata of the PartnerTitle.CopyData() method
type pCopyData struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCopyData) Extend(fnct func(m.PartnerTitleSet, m.PartnerTitleData) m.PartnerTitleData) pCopyData {
	return pCopyData{
		Method: m.Method.Extend(fnct),
	}
}
...
// pCreate holds the metadata of the PartnerTitle.Create() method
type pCreate struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCreate) Extend(fnct func(m.PartnerTitleSet, m.PartnerTitleData) m.PartnerTitleSet) pCreate {
	return pCreate{
		Method: m.Method.Extend(fnct),
	}
}
...
// pDefaultGet holds the metadata of the PartnerTitle.DefaultGet() method
type pDefaultGet struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pDefaultGet) Extend(fnct func(m.PartnerTitleSet) m.PartnerTitleData) pDefaultGet {
	return pDefaultGet{
		Method: m.Method.Extend(fnct),
	}
}
...
// pEnqueue holds the metadata of the PartnerTitle.Enqueue() method
type pEnqueue struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pEnqueue) Extend(fnct func(m.PartnerTitleSet, string, models.Methoder, ...interface{}) m.QueueJobSet) pEnqueue {
	return pEnqueue{
		Method: m.Method.Extend(fnct),
	}
}
...
// pEquals holds the metadata of the PartnerTitle.Equals() method
type pEquals struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pEquals) Extend(fnct func(m.PartnerTitleSet, m.PartnerTitleSet) bool) pEquals {
	return pEquals{
		Method: m.Method.Extend(fnct),
	}
}
...
// pExecuteO2MActions holds the metadata of the PartnerTitle.ExecuteO2MActions() method
type pExecuteO2MActions struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pExecuteO2MActions) Extend(fnct func(m.PartnerTitleSet, models.FieldName, *models.FieldInfo, interface{}) interface{}) pExecuteO2MActions {
...
// pFetch holds the metadata of the PartnerTitle.Fetch() method
type pFetch struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFetch) Extend(fnct func(m.PartnerTitleSet) m.PartnerTitleSet) pFetch {
	return pFetch{
		Method: m.Method.Extend(fnct),
	}
}
...
// pFieldGet holds the metadata of the PartnerTitle.FieldGet() method
type pFieldGet struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFieldGet) Extend(fnct func(m.PartnerTitleSet, models.FieldName) *models.FieldInfo) pFieldGet {
	return pFieldGet{
		Method: m.Method.Extend(fnct),
	}
}
...
// pFieldsGet holds the metadata of the PartnerTitle.FieldsGet() method
type pFieldsGet struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFieldsGet) Extend(fnct func(m.PartnerTitleSet, models.FieldsGetArgs) map[string]*models.FieldInfo) pFieldsGet {
	return pFieldsGet{
		Method: m.Method.Extend(fnct),
	}
}
...
// pFieldsViewGet holds the metadata of the PartnerTitle.FieldsViewGet() method
type pFieldsViewGet struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFieldsViewGet) Extend(fnct func(m.PartnerTitleSet, webtypes.FieldsViewGetParams) *webtypes.FieldsViewData) pFieldsViewGet {
...
// pFiltered holds the metadata of the PartnerTitle.Filtered() method
type pFiltered struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFiltered) Extend(fnct func(m.PartnerTitleSet, func(m.PartnerTitleSet) bool) m.PartnerTitleSet) pFiltered {
	return pFiltered{
		Method: m.Method.Extend(fnct),
	}
}
...
// pFormatRelationFields holds the metadata of the PartnerTitle.FormatRelationFields() method
type pFormatRelationFields struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFormatRelationFields) Extend(fnct func(m.PartnerTitleSet, models.RecordData, map[string]*models.FieldInfo) models.RecordData) pFormatRelationFields {
...
// pGetFormviewAction holds the metadata of the PartnerTitle.GetFormviewAction() method
type pGetFormviewAction struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pGetFormviewAction) Extend(fnct func(m.PartnerTitleSet) *actions.Action) pGetFormviewAction {
...
// pGetFormviewId holds the metadata of the PartnerTitle.GetFormviewId() method
type pGetFormviewId struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pGetFormviewId) Extend(fnct func(m.PartnerTitleSet) string) pGetFormviewId {
...
// pGetRecord holds the metadata of the PartnerTitle.GetRecord() method
type pGetRecord struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pGetRecord) Extend(fnct func(m.PartnerTitleSet, string) m.PartnerTitleSet) pGetRecord {
	return pGetRecord{
		Method: m.Method.Extend(fnct),
	}
}
...
// pGetToolbar holds the metadata of the PartnerTitle.GetToolbar() method
type pGetToolbar struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pGetToolbar) Extend(fnct func(m.PartnerTitleSet) webtypes.Toolbar) pGetToolbar {
	return pGetToolbar{
		Method: m.Method.Extend(fnct),
	}
}
...
// pGroupBy holds the metadata of the PartnerTitle.GroupBy() method
type pGroupBy struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pGroupBy) Extend(fnct func(m.PartnerTitleSet, ...models.FieldName) m.PartnerTitleSet) pGroupBy {
	return pGroupBy{
		Method: m.Method.Extend(fnct),
	}
}
...
// pIntersect holds the metadata of the PartnerTitle.Intersect() method
type pIntersect struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pIntersect) Extend(fnct func(m.PartnerTitleSet, m.PartnerTitleSet) m.PartnerTitleSet) pIntersect {
	return pIntersect{
		Method: m.Method.Extend(fnct),
	}
}
...
// pLimit holds the metadata of the PartnerTitle.Limit() method
type pLimit struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pLimit) Extend(fnct func(m.PartnerTitleSet, int) m.PartnerTitleSet) pLimit {
	return pLimit{
		Method: m.Method.Extend(fnct),
	}
}
...
// pLoad holds the metadata of the PartnerTitle.Load() method
type pLoad struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pLoad) Extend(fnct func(m.PartnerTitleSet, ...models.FieldName) m.PartnerTitleSet) pLoad {
	return pLoad{
		Method: m.Method.Extend(fnct),
	}
}
...
// pLoadViews holds the metadata of the PartnerTitle.LoadViews() method
type pLoadViews struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pLoadViews) Extend(fnct func(m.PartnerTitleSet, webtypes.LoadViewsArgs) *webtypes.LoadViewsData) pLoadViews {
	return pLoadViews{
		Method: m.Method.Extend(fnct),
	}
}
...
// pManageGroupsOnFields holds the metadata of the PartnerTitle.ManageGroupsOnFields() method
type pManageGroupsOnFields struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pManageGroupsOnFields) Extend(fnct func(m.PartnerTitleSet, *etree.Document, map[string]*models.FieldInfo)) pManageGroupsOnFields {
...
// pNameGet holds the metadata of the PartnerTitle.NameGet() method
type pNameGet struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pNameGet) Extend(fnct func(m.PartnerTitleSet) string) pNameGet {
	return pNameGet{
		Method: m.Method.Extend(fnct),
	}
}
...
// pNameSearch holds the metadata of the PartnerTitle.NameSearch() method
type pNameSearch struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pNameSearch) Extend(fnct func(m.PartnerTitleSet, webtypes.NameSearchParams) []webtypes.RecordIDWithName) pNameSearch {
	return pNameSearch{
		Method: m.Method.Extend(fnct),
	}
}
...
// pNew holds the metadata of the PartnerTitle.New() method
type pNew struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pNew) Extend(fnct func(m.PartnerTitleSet, m.PartnerTitleData) m.PartnerTitleSet) pNew {
	return pNew{
		Method: m.Method.Extend(fnct),
	}
}
...
// pNormalizeM2MData holds the metadata of the PartnerTitle.NormalizeM2MData() method
type pNormalizeM2MData struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pNormalizeM2MData) Extend(fnct func(m.PartnerTitleSet, models.FieldName, *models.FieldInfo, interface{}) interface{}) pNormalizeM2MData {
...
// pOffset holds the metadata of the PartnerTitle.Offset() method
type pOffset struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pOffset) Extend(fnct func(m.PartnerTitleSet, int) m.PartnerTitleSet) pOffset {
	return pOffset{
		Method: m.Method.Extend(fnct),
	}
}
...
// pOnchange holds the metadata of the PartnerTitle.Onchange() method
type pOnchange struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pOnchange) Extend(fnct func(m.PartnerTitleSet, models.OnchangeParams) models.OnchangeResult) pOnchange {
	return pOnchange{
		Method: m.Method.Extend(fnct),
	}
}
...
// pOrderBy holds the metadata of the PartnerTitle.OrderBy() method
type pOrderBy struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pOrderBy) Extend(fnct func(m.PartnerTitleSet, ...string) m.PartnerTitleSet) pOrderBy {
	return pOrderBy{
		Method: m.Method.Extend(fnct),
	}
}
...
// pPostProcessCreateValues holds the metadata of the PartnerTitle.PostProcessCreateValues() method
type pPostProcessCreateValues struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pPostProcessCreateValues) Extend(fnct func(m.PartnerTitleSet, models.RecordData)) pPostProcessCreateValues {
...
// pPostProcessFilters holds the metadata of the PartnerTitle.PostProcessFilters() method
type pPostProcessFilters struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pPostProcessFilters) Extend(fnct func(m.PartnerTitleSet, map[models.FieldName]models.Conditioner) map[string][]interface{}) pPostProcessFilters {
...
// pProcessCreateValues holds the metadata of the PartnerTitle.ProcessCreateValues() method
type pProcessCreateValues struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pProcessCreateValues) Extend(fnct func(m.PartnerTitleSet, models.RecordData) (models.RecordData, models.RecordData)) pProcessCreateValues {
...
// pProcessElementAttrs holds the metadata of the PartnerTitle.ProcessElementAttrs() method
type pProcessElementAttrs struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pProcessElementAttrs) Extend(fnct func(m.PartnerTitleSet, *etree.Element, map[string]*models.FieldInfo) map[string]interface{}) pProcessElementAttrs {
...
// pProcessFieldElementModifiers holds the metadata of the PartnerTitle.ProcessFieldElementModifiers() method
type pProcessFieldElementModifiers struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pProcessFieldElementModifiers) Extend(fnct func(m.PartnerTitleSet, *etree.Element, map[string]*models.FieldInfo, map[string]interface{}) map[string]interface{}) pProcessFieldElementModifiers {
...
// pProcessView holds the metadata of the PartnerTitle.ProcessView() method
type pProcessView struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pProcessView) Extend(fnct func(m.PartnerTitleSet, *etree.Document, map[string]*models.FieldInfo) string) pProcessView {
	return pProcessView{
		Method: m.Method.Extend(fnct),
	}
}
...
// pProcessWriteValues holds the metadata of the PartnerTitle.ProcessWriteValues() method
type pProcessWriteValues struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pProcessWriteValues) Extend(fnct func(m.PartnerTitleSet, models.RecordData) models.RecordData) pProcessWriteValues {
...
// pRead holds the metadata of the PartnerTitle.Read() method
type pRead struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pRead) Extend(fnct func(m.PartnerTitleSet, models.FieldNames) []models.RecordData) pRead {
	return pRead{
		Method: m.Method.Extend(fnct),
	}
}
...
// pReadGroup holds the metadata of the PartnerTitle.ReadGroup() method
type pReadGroup struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pReadGroup) Extend(fnct func(m.PartnerTitleSet, webtypes.ReadGroupParams) []models.FieldMap) pReadGroup {
	return pReadGroup{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSQLFromCondition holds the metadata of the PartnerTitle.SQLFromCondition() method
type pSQLFromCondition struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSQLFromCondition) Extend(fnct func(m.PartnerTitleSet, *models.Condition) (string, models.SQLParams)) pSQLFromCondition {
...
// pSearch holds the metadata of the PartnerTitle.Search() method
type pSearch struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearch) Extend(fnct func(m.PartnerTitleSet, q.PartnerTitleCondition) m.PartnerTitleSet) pSearch {
	return pSearch{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSearchAll holds the metadata of the PartnerTitle.SearchAll() method
type pSearchAll struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearchAll) Extend(fnct func(m.PartnerTitleSet) m.PartnerTitleSet) pSearchAll {
	return pSearchAll{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSearchByName holds the metadata of the PartnerTitle.SearchByName() method
type pSearchByName struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearchByName) Extend(fnct func(m.PartnerTitleSet, string, operator.Operator, q.PartnerTitleCondition, int) m.PartnerTitleSet) pSearchByName {
...
// pSearchCount holds the metadata of the PartnerTitle.SearchCount() method
type pSearchCount struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearchCount) Extend(fnct func(m.PartnerTitleSet) int) pSearchCount {
	return pSearchCount{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSearchDomain holds the metadata of the PartnerTitle.SearchDomain() method
type pSearchDomain struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearchDomain) Extend(fnct func(m.PartnerTitleSet, domains.Domain) m.CommonMixinSet) pSearchDomain {
...
// pSearchRead holds the metadata of the PartnerTitle.SearchRead() method
type pSearchRead struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearchRead) Extend(fnct func(m.PartnerTitleSet, webtypes.SearchParams) []models.RecordData) pSearchRead {
	return pSearchRead{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSorted holds the metadata of the PartnerTitle.Sorted() method
type pSorted struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSorted) Extend(fnct func(m.PartnerTitleSet, func(m.PartnerTitleSet, m.PartnerTitleSet) bool) m.PartnerTitleSet) pSorted {
	return pSorted{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSortedByField holds the metadata of the PartnerTitle.SortedByField() method
type pSortedByField struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSortedByField) Extend(fnct func(m.PartnerTitleSet, models.FieldName, bool) m.PartnerTitleSet) pSortedByField {
...
// pSortedDefault holds the metadata of the PartnerTitle.SortedDefault() method
type pSortedDefault struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSortedDefault) Extend(fnct func(m.PartnerTitleSet) m.PartnerTitleSet) pSortedDefault {
...
// pSubtract holds the metadata of the PartnerTitle.Subtract() method
type pSubtract struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSubtract) Extend(fnct func(m.PartnerTitleSet, m.PartnerTitleSet) m.PartnerTitleSet) pSubtract {
	return pSubtract{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSudo holds the metadata of the PartnerTitle.Sudo() method
type pSudo struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSudo) Extend(fnct func(m.PartnerTitleSet, ...int64) m.PartnerTitleSet) pSudo {
	return pSudo{
		Method: m.Method.Extend(fnct),
	}
}
...
// pToggleActive holds the metadata of the PartnerTitle.ToggleActive() method
type pToggleActive struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pToggleActive) Extend(fnct func(m.PartnerTitleSet)) pToggleActive {
...
// pUnion holds the metadata of the PartnerTitle.Union() method
type pUnion struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pUnion) Extend(fnct func(m.PartnerTitleSet, m.PartnerTitleSet) m.PartnerTitleSet) pUnion {
	return pUnion{
		Method: m.Method.Extend(fnct),
	}
}
...
// pUnlink holds the metadata of the PartnerTitle.Unlink() method
type pUnlink struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pUnlink) Extend(fnct func(m.PartnerTitleSet) int64) pUnlink {
	return pUnlink{
		Method: m.Method.Extend(fnct),
	}
}
...
// pWebReadGroup holds the metadata of the PartnerTitle.WebReadGroup() method
type pWebReadGroup struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWebReadGroup) Extend(fnct func(m.PartnerTitleSet, webtypes.WebReadGroupParams) webtypes.WebReadGroupResult) pWebReadGroup {
...
// pWebReadGroupPrivate holds the metadata of the PartnerTitle.WebReadGroupPrivate() method
type pWebReadGroupPrivate struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWebReadGroupPrivate) Extend(fnct func(m.PartnerTitleSet, webtypes.WebReadGroupParams) []models.FieldMap) pWebReadGroupPrivate {
...
// pWebSearchRead holds the metadata of the PartnerTitle.WebSearchRead() method
type pWebSearchRead struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWebSearchRead) Extend(fnct func(m.PartnerTitleSet, webtypes.SearchParams) webtypes.SearchReadResult) pWebSearchRead {
...
// pWithContext holds the metadata of the PartnerTitle.WithContext() method
type pWithContext struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWithContext) Extend(fnct func(m.PartnerTitleSet, string, interface{}) m.PartnerTitleSet) pWithContext {
	return pWithContext{
		Method: m.Method.Extend(fnct),
	}
}
...
// pWithEnv holds the metadata of the PartnerTitle.WithEnv() method
type pWithEnv struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWithEnv) Extend(fnct func(m.PartnerTitleSet, models.Environment) m.PartnerTitleSet) pWithEnv {
	return pWithEnv{
		Method: m.Method.Extend(fnct),
	}
}
...
// pWithNewContext holds the metadata of the PartnerTitle.WithNewContext() method
type pWithNewContext struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWithNewContext) Extend(fnct func(m.PartnerTitleSet, *types.Context) m.PartnerTitleSet) pWithNewContext {
...
// pWrite holds the metadata of the PartnerTitle.Write() method
type pWrite struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWrite) Extend(fnct func(m.PartnerTitleSet, m.PartnerTitleData) bool) pWrite {
	return pWrite{
		Method: m.Method.Extend(fnct),
	}
}
...
func (d PartnerTitleData) Set(field models.FieldName, value interface{}) m.PartnerTitleData {
	return &PartnerTitleData{
...
func (d PartnerTitleData) Unset(field models.FieldName) m.PartnerTitleData {
	return &PartnerTitleData{
...
func (d PartnerTitleData) Copy() m.PartnerTitleData {
	return &PartnerTitleData{
		d.ModelData.Copy(),
	}
}
...
func (d PartnerTitleData) MergeWith(other m.PartnerTitleData) {
...
func (d PartnerTitleData) CreateDate() dates.DateTime {
...
func (d PartnerTitleData) HasCreateDate() bool {
...
func (d PartnerTitleData) SetCreateDate(value dates.DateTime) m.PartnerTitleData {
...
// It returns this PartnerTitleData so that calls can be chained.
func (d PartnerTitleData) UnsetCreateDate() m.PartnerTitleData {
...
// the Go zero value for the type is returned.
func (d PartnerTitleData) CreateUID() int64 {
...
func (d PartnerTitleData) HasCreateUID() bool {
...
// It returns this PartnerTitleData so that calls can be chained.
func (d PartnerTitleData) SetCreateUID(value int64) m.PartnerTitleData {
...
// It returns this PartnerTitleData so that calls can be chained.
func (d PartnerTitleData) UnsetCreateUID() m.PartnerTitleData {
...
// the Go zero value for the type is returned.
func (d PartnerTitleData) DisplayName() string {
...
func (d PartnerTitleData) HasDisplayName() bool {
...
// It returns this PartnerTitleData so that calls can be chained.
func (d PartnerTitleData) SetDisplayName(value string) m.PartnerTitleData {
...
// It returns this PartnerTitleData so that calls can be chained.
func (d PartnerTitleData) UnsetDisplayName() m.PartnerTitleData {
...
// the Go zero value for the type is returned.
func (d PartnerTitleData) HexyaExternalID() string {
...
func (d PartnerTitleData) HasHexyaExternalID() bool {
...
// It returns this PartnerTitleData so that calls can be chained.
func (d PartnerTitleData) SetHexyaExternalID(value string) m.PartnerTitleData {
...
// It returns this PartnerTitleData so that calls can be chained.
func (d PartnerTitleData) UnsetHexyaExternalID() m.PartnerTitleData {
...
// the Go zero value for the type is returned.
func (d PartnerTitleData) HexyaVersion() int {
...
func (d PartnerTitleData) HasHexyaVersion() bool {
...
// It returns this PartnerTitleData so that calls can be chained.
func (d PartnerTitleData) SetHexyaVersion(value int) m.PartnerTitleData {
...
// It returns this PartnerTitleData so that calls can be chained.
func (d PartnerTitleData) UnsetHexyaVersion() m.PartnerTitleData {
...
// the Go zero value for the type is returned.
func (d PartnerTitleData) ID() int64 {
...
func (d PartnerTitleData) HasID() bool {
	return d.ModelData.Has(models.NewFieldName("ID", "id"))
}

// SetID sets the ID field with the given value.
// It returns this PartnerTitleData so that calls can be chained.
func (d PartnerTitleData) SetID(value int64) m.PartnerTitleData {
...
// It returns this PartnerTitleData so that calls can be chained.
func (d PartnerTitleData) UnsetID() m.PartnerTitleData {
...
// the Go zero value for the type is returned.
func (d PartnerTitleData) LastUpdate() dates.DateTime {
...
func (d PartnerTitleData) HasLastUpdate() bool {
...
// It returns this PartnerTitleData so that calls can be chained.
func (d PartnerTitleData) SetLastUpdate(value dates.DateTime) m.PartnerTitleData {
...
// It returns this PartnerTitleData so that calls can be chained.
func (d PartnerTitleData) UnsetLastUpdate() m.PartnerTitleData {
...
// the Go zero value for the type is returned.
func (d PartnerTitleData) Name() string {
...
// It returns this PartnerTitleData so that calls can be chained.
func (d PartnerTitleData) UnsetName() m.PartnerTitleData {
...
// the Go zero value for the type is returned.
func (d PartnerTitleData) Shortcut() string {
	val := d.ModelData.Get(models.NewFieldName("Shortcut", "shortcut"))
	if !d.Has(models.NewFieldName("Shortcut", "shortcut")) {
		return *new(string)
	}
	return val.(string)
}
...
func (d PartnerTitleData) HasShortcut() bool {
	return d.ModelData.Has(models.NewFieldName("Shortcut", "shortcut"))
}

// SetShortcut sets the Shortcut field with the given value.
// It returns this PartnerTitleData so that calls can be chained.
func (d PartnerTitleData) SetShortcut(value string) m.PartnerTitleData {
	d.ModelData.Set(models.NewFieldName("Shortcut", "shortcut"), value)
	return d
}

// UnsetShortcut removes the value of the Shortcut field if it exists.
// It returns this PartnerTitleData so that calls can be chained.
func (d PartnerTitleData) UnsetShortcut() m.PartnerTitleData {
	d.ModelData.Unset(models.NewFieldName("Shortcut", "shortcut"))
	return d
}
...
// the Go zero value for the type is returned.
func (d PartnerTitleData) WriteDate() dates.DateTime {
...
func (d PartnerTitleData) HasWriteDate() bool {
...
// It returns this PartnerTitleData so that calls can be chained.
func (d PartnerTitleData) SetWriteDate(value dates.DateTime) m.PartnerTitleData {
...
// It returns this PartnerTitleData so that calls can be chained.
func (d PartnerTitleData) UnsetWriteDate() m.PartnerTitleData {
...
// the Go zero value for the type is returned.
func (d PartnerTitleData) WriteUID() int64 {
...
// It returns this PartnerTitleData so that calls can be chained.
func (d PartnerTitleData) UnsetWriteUID() m.PartnerTitleData {
	d.ModelData.Unset(models.NewFieldName("WriteUID", "write_uid"))
	return d
}

var _ m.PartnerTitleData = new(PartnerTitleData)
var _ m.PartnerTitleData = PartnerTitleData{}
...
type PartnerTitleGroupAggregateRow struct {
	values    m.PartnerTitleData
	count     int
	condition q.PartnerTitleCondition
}

// Values returns the values of the actual query
func (a PartnerTitleGroupAggregateRow) Values() m.PartnerTitleData {
	return a.values
}

// Count returns the number of lines aggregated into this one
func (a PartnerTitleGroupAggregateRow) Count() int {
	return a.count
}

// Condition can be used to query the aggregated rows separately if needed
func (a PartnerTitleGroupAggregateRow) Condition() q.PartnerTitleCondition {
	return a.condition
}
...
func (s PartnerTitleSet) ForceLoad(fields ...models.FieldName) m.PartnerTitleSet {
...
// RecordSets
func (s PartnerTitleSet) Records() []m.PartnerTitleSet {
	recs := s.RecordCollection.Records()
	res := make([]m.PartnerTitleSet, len(recs))
	for i, rec := range recs {
		res[i] = rec.Wrap("PartnerTitle").(m.PartnerTitleSet)
	}
	return res
}

// CartesianProduct returns the cartesian product of this PartnerTitleSet with others.
func (s PartnerTitleSet) CartesianProduct(others ...m.PartnerTitleSet) []m.PartnerTitleSet {
...
func (s PartnerTitleSet) First() m.PartnerTitleData {
	return &PartnerTitleData{
...
func (s PartnerTitleSet) All() []m.PartnerTitleData {
	allSlice := s.RecordCollection.All()
	res := make([]m.PartnerTitleData, len(allSlice))
	for i, v := range allSlice {
		res[i] = &PartnerTitleData{v}
	}
	return res
}

// Sorted returns a new PartnerTitleSet sorted according to the given less function.
//
// The less function should return true if rs1 < rs2
func (s PartnerTitleSet) Sorted(less func(rs1, rs2 m.PartnerTitleSet) bool) m.PartnerTitleSet {
	res := s.RecordCollection.Sorted(func(rc1 models.RecordSet, rc2 models.RecordSet) bool {
		return less(PartnerTitleSet{RecordCollection: rc1.Collection()}, PartnerTitleSet{RecordCollection: rc2.Collection()})
	})
	return res.Wrap("PartnerTitle").(m.PartnerTitleSet)
}

// Filtered returns a new PartnerTitleSet with only the elements of this record set
// for which test is true.
//
// Note that if this PartnerTitleSet is not fully loaded, this function will call the database
...
func (s PartnerTitleSet) Filtered(test func(rs m.PartnerTitleSet) bool) m.PartnerTitleSet {
	res := s.RecordCollection.Filtered(func(rc models.RecordSet) bool {
		return test(PartnerTitleSet{RecordCollection: rc.Collection()})
	})
	return res.Wrap("PartnerTitle").(m.PartnerTitleSet)
}
...
func (s PartnerTitleSet) CreateDate() dates.DateTime {
...
func (s PartnerTitleSet) SetCreateDate(value dates.DateTime) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s PartnerTitleSet) CreateUID() int64 {
...
func (s PartnerTitleSet) SetCreateUID(value int64) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s PartnerTitleSet) DisplayName() string {
...
func (s PartnerTitleSet) SetDisplayName(value string) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s PartnerTitleSet) HexyaExternalID() string {
...
func (s PartnerTitleSet) SetHexyaExternalID(value string) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s PartnerTitleSet) HexyaVersion() int {
...
func (s PartnerTitleSet) SetHexyaVersion(value int) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s PartnerTitleSet) ID() int64 {
...
func (s PartnerTitleSet) SetID(value int64) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s PartnerTitleSet) LastUpdate() dates.DateTime {
...
func (s PartnerTitleSet) SetLastUpdate(value dates.DateTime) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s PartnerTitleSet) Name() string {
...
func (s PartnerTitleSet) SetName(value string) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s PartnerTitleSet) Shortcut() string {
	res, _ := s.RecordCollection.Get(models.NewFieldName("Shortcut", "shortcut")).(string)
	return res
}
...
func (s PartnerTitleSet) SetShortcut(value string) {
	s.RecordCollection.Set(models.NewFieldName("Shortcut", "shortcut"), value)
}

// WriteDate is a getter for the value of the "WriteDate" field of the first
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s PartnerTitleSet) WriteDate() dates.DateTime {
...
func (s PartnerTitleSet) SetWriteDate(value dates.DateTime) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s PartnerTitleSet) WriteUID() int64 {
...
func (s PartnerTitleSet) SetWriteUID(value int64) {
...
func (s PartnerTitleSet) Super() m.PartnerTitleSet {
	return s.RecordCollection.Super().Wrap("PartnerTitle").(m.PartnerTitleSet)
}

// ModelData returns a new PartnerTitleData object populated with the values
// of the given FieldMap.
func (s PartnerTitleSet) ModelData(fMap models.FieldMap) m.PartnerTitleData {
	res := &PartnerTitleData{
		models.NewModelData(models.Registry.MustGet("PartnerTitle")),
	}
	for k, v := range fMap {
		res.Set(models.Registry.MustGet("PartnerTitle").FieldName(k), v)
	}
	return res
}
...
func (s PartnerTitleSet) AddDomainLimitOffset(domain domains.Domain, limit int, offset int, order string) m.PartnerTitleSet {
	res := s.Collection().Call("AddDomainLimitOffset", domain, limit, offset, order)
	resTyped := res.(models.RecordSet).Collection().Wrap("PartnerTitle").(m.PartnerTitleSet)
	return resTyped
}

// AddModifiers adds the modifiers attribute nodes to given xml doc.
func (s PartnerTitleSet) AddModifiers(doc *etree.Document, fieldInfos map[string]*models.FieldInfo) {
...
func (s PartnerTitleSet) AddNamesToRelations(data models.RecordData, fInfos map[string]*models.FieldInfo) models.RecordData {
...
func (s PartnerTitleSet) Aggregates(fieldNames ...models.FieldName) []m.PartnerTitleGroupAggregateRow {
	res := s.Collection().Call("Aggregates", fieldNames)
	resTyped, _ := res.([]m.PartnerTitleGroupAggregateRow)
	return resTyped
}

// Browse returns a new RecordSet with only the records with the given ids.
// Note that this function is just a shorcut for Search on a list of ids.
func (s PartnerTitleSet) Browse(ids []int64) m.PartnerTitleSet {
...
func (s PartnerTitleSet) BrowseOne(id int64) m.PartnerTitleSet {
...
func (s PartnerTitleSet) CheckAccessRights(args webtypes.CheckAccessRightsArgs) bool {
...
func (s PartnerTitleSet) CheckExecutionPermission(method *models.Method, dontPanic ...bool) bool {
...
func (s PartnerTitleSet) CheckRecursion() bool {
...
func (s PartnerTitleSet) ComputeDisplayName() *models.ModelData {
...
func (s PartnerTitleSet) ComputeLastUpdate() *models.ModelData {
	res := s.Collection().Call("ComputeLastUpdate")
	resTyped, _ := res.(*models.ModelData)
	return resTyped
}

// Copy duplicates the given PartnerTitle record, overridding values with overrides.
func (s PartnerTitleSet) Copy(overrides m.PartnerTitleData) m.PartnerTitleSet {
...
func (s PartnerTitleSet) CopyData(overrides m.PartnerTitleData) m.PartnerTitleData {
	res := s.Collection().Call("CopyData", overrides)
	resTyped, _ := res.(models.RecordData)
	return resTyped.Underlying().Wrap().(m.PartnerTitleData)
}

// Create inserts a PartnerTitle record in the database from the given data.
// Returns the created PartnerTitleSet.
func (s PartnerTitleSet) Create(data m.PartnerTitleData) m.PartnerTitleSet {
	res := s.Collection().Call("Create", data)
	resTyped := res.(models.RecordSet).Collection().Wrap("PartnerTitle").(m.PartnerTitleSet)
	return resTyped
}

// DefaultGet returns a PartnerTitleData with the default values for the model.
func (s PartnerTitleSet) DefaultGet() m.PartnerTitleData {
...
func (s PartnerTitleSet) Enqueue(description string, method models.Methoder, arguments ...interface{}) m.QueueJobSet {
...
func (s PartnerTitleSet) Equals(other m.PartnerTitleSet) bool {
...
func (s PartnerTitleSet) ExecuteO2MActions(fieldName models.FieldName, info *models.FieldInfo, value interface{}) interface{} {
...
func (s PartnerTitleSet) Fetch() m.PartnerTitleSet {
...
func (s PartnerTitleSet) FieldGet(field models.FieldName) *models.FieldInfo {
...
func (s PartnerTitleSet) FieldsGet(args models.FieldsGetArgs) map[string]*models.FieldInfo {
...
// view architecture.
func (s PartnerTitleSet) FieldsViewGet(args webtypes.FieldsViewGetParams) *webtypes.FieldsViewData {
...
func (s PartnerTitleSet) FormatRelationFields(data models.RecordData, fInfos map[string]*models.FieldInfo) models.RecordData {
...
func (s PartnerTitleSet) GetFormviewAction() *actions.Action {
...
// This method is meant to be overridden in addons that want
// to give specific view ids for example.
func (s PartnerTitleSet) GetFormviewId() string {
...
func (s PartnerTitleSet) GetRecord(externalID string) m.PartnerTitleSet {
...
func (s PartnerTitleSet) GetToolbar() webtypes.Toolbar {
...
func (s PartnerTitleSet) GroupBy(exprs ...models.FieldName) m.PartnerTitleSet {
...
func (s PartnerTitleSet) Intersect(other m.PartnerTitleSet) m.PartnerTitleSet {
...
func (s PartnerTitleSet) Limit(limit int) m.PartnerTitleSet {
...
// model are retrieved.
func (s PartnerTitleSet) Load(fields ...models.FieldName) m.PartnerTitleSet {
...
func (s PartnerTitleSet) LoadViews(args webtypes.LoadViewsArgs) *webtypes.LoadViewsData {
...
func (s PartnerTitleSet) ManageGroupsOnFields(doc *etree.Document, fieldInfos map[string]*models.FieldInfo) {
	s.Collection().Call("ManageGroupsOnFields", doc, fieldInfos)
}

// NameGet retrieves the human readable name of this record.`,
func (s PartnerTitleSet) NameGet() string {
...
func (s PartnerTitleSet) NameSearch(params webtypes.NameSearchParams) []webtypes.RecordIDWithName {
	res := s.Collection().Call("NameSearch", params)
	resTyped, _ := res.([]webtypes.RecordIDWithName)
	return resTyped
}

// New creates a PartnerTitle record in memory from the given data.
// Such PartnerTitleSet has a negative ID and cannot be reloaded from the database
func (s PartnerTitleSet) New(data m.PartnerTitleData) m.PartnerTitleSet {
...
func (s PartnerTitleSet) NormalizeM2MData(fieldName models.FieldName, info *models.FieldInfo, value interface{}) interface{} {
...
func (s PartnerTitleSet) Offset(offset int) m.PartnerTitleSet {
...
func (s PartnerTitleSet) Onchange(params models.OnchangeParams) models.OnchangeResult {
...
func (s PartnerTitleSet) OrderBy(exprs ...string) m.PartnerTitleSet {
...
func (s PartnerTitleSet) PostProcessCreateValues(data models.RecordData) {
...
func (s PartnerTitleSet) PostProcessFilters(in map[models.FieldName]models.Conditioner) map[string][]interface{} {
...
func (s PartnerTitleSet) ProcessCreateValues(data models.RecordData) (models.RecordData, models.RecordData) {
...
func (s PartnerTitleSet) ProcessElementAttrs(element *etree.Element, fieldInfos map[string]*models.FieldInfo) map[string]interface{} {
...
func (s PartnerTitleSet) ProcessFieldElementModifiers(element *etree.Element, fieldInfos map[string]*models.FieldInfo, modifiers map[string]interface{}) map[string]interface{} {
...
func (s PartnerTitleSet) ProcessView(arch *etree.Document, fieldInfos map[string]*models.FieldInfo) string {
...
// compatible with the ORM, in particular for relation fields
func (s PartnerTitleSet) ProcessWriteValues(data models.RecordData) models.RecordData {
...
func (s PartnerTitleSet) Read(fields models.FieldNames) []models.RecordData {
...
func (s PartnerTitleSet) ReadGroup(params webtypes.ReadGroupParams) []models.FieldMap {
...
// the given condition.`,
func (s PartnerTitleSet) SQLFromCondition(c *models.Condition) (string, models.SQLParams) {
...
// Search returns a new PartnerTitleSet filtering on the current one with the additional given Condition
func (s PartnerTitleSet) Search(condition q.PartnerTitleCondition) m.PartnerTitleSet {
...
func (s PartnerTitleSet) SearchAll() m.PartnerTitleSet {
	res := s.Collection().Call("SearchAll")
	resTyped := res.(models.RecordSet).Collection().Wrap("PartnerTitle").(m.PartnerTitleSet)
	return resTyped
}

// SearchByName searches for PartnerTitle records that have a display name matching the given
...
// value for a relational field. Sometimes be seen as the inverse
// function of NameGet but it is not guaranteed to be.
func (s PartnerTitleSet) SearchByName(name string, op operator.Operator, additionalCond q.PartnerTitleCondition, limit int) m.PartnerTitleSet {
...
func (s PartnerTitleSet) SearchCount() int {
...
func (s PartnerTitleSet) SearchDomain(domain domains.Domain) m.CommonMixinSet {
...
func (s PartnerTitleSet) SearchRead(params webtypes.SearchParams) []models.RecordData {
...
func (s PartnerTitleSet) SortedByField(namer models.FieldName, reverse bool) m.PartnerTitleSet {
...
func (s PartnerTitleSet) SortedDefault() m.PartnerTitleSet {
...
func (s PartnerTitleSet) Subtract(other m.PartnerTitleSet) m.PartnerTitleSet {
...
func (s PartnerTitleSet) Sudo(userID ...int64) m.PartnerTitleSet {
...
func (s PartnerTitleSet) ToggleActive() {
...
func (s PartnerTitleSet) Union(other m.PartnerTitleSet) m.PartnerTitleSet {
...
func (s PartnerTitleSet) Unlink() int64 {
...
func (s PartnerTitleSet) WebReadGroup(params webtypes.WebReadGroupParams) webtypes.WebReadGroupResult {
...
func (s PartnerTitleSet) WebReadGroupPrivate(params webtypes.WebReadGroupParams) []models.FieldMap {
...
func (s PartnerTitleSet) WebSearchRead(params webtypes.SearchParams) webtypes.SearchReadResult {
...
func (s PartnerTitleSet) WithContext(key string, value interface{}) m.PartnerTitleSet {
...
func (s PartnerTitleSet) WithEnv(env models.Environment) m.PartnerTitleSet {
...
func (s PartnerTitleSet) WithNewContext(context *types.Context) m.PartnerTitleSet {
...
// PartnerTitle records in the database with the given data.
func (s PartnerTitleSet) Write(data m.PartnerTitleData) bool {
...
// Aggregates returns the result of this RecordSet query, which must by a grouped query.
func m_PartnerTitle_Aggregates(rs PartnerTitleSet, fieldNames ...models.FieldName) []m.PartnerTitleGroupAggregateRow {
	lines := rs.RecordCollection.Aggregates(fieldNames...)
	res := make([]m.PartnerTitleGroupAggregateRow, len(lines))
	for i, l := range lines {
		res[i] = PartnerTitleGroupAggregateRow{
			values: l.Values.Wrap().(m.PartnerTitleData),
			count:  l.Count,
			condition: q.PartnerTitleCondition{
...
func init() {
	models.CreateModel("PartnerTitle", 0)
	models.Registry.MustGet("PartnerTitle").AddFields(map[string]models.FieldDefinition{
	...
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("ActionArchive")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("ActionUnarchive")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("AddDomainLimitOffset")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("AddModifiers")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("AddNamesToRelations")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("Browse")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("BrowseOne")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("CheckAccessRights")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("CheckExecutionPermission")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("CheckRecursion")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("ComputeDisplayName")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("ComputeLastUpdate")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("Copy")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("CopyData")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("Create")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("DefaultGet")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("Enqueue")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("Equals")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("ExecuteO2MActions")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("Fetch")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("FieldGet")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("FieldsGet")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("FieldsViewGet")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("FormatRelationFields")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("GetFormviewAction")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("GetFormviewId")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("GetRecord")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("GetToolbar")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("GroupBy")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("Intersect")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("Limit")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("Load")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("LoadViews")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("ManageGroupsOnFields")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("NameGet")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("NameSearch")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("New")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("NormalizeM2MData")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("Offset")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("Onchange")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("OrderBy")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("PostProcessCreateValues")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("PostProcessFilters")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("ProcessCreateValues")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("ProcessElementAttrs")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("ProcessFieldElementModifiers")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("ProcessView")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("ProcessWriteValues")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("Read")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("ReadGroup")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("SQLFromCondition")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("Search")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("SearchAll")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("SearchByName")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("SearchCount")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("SearchDomain")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("SearchRead")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("SortedByField")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("SortedDefault")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("Subtract")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("Sudo")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("ToggleActive")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("Union")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("Unlink")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("WebReadGroup")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("WebReadGroupPrivate")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("WebSearchRead")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("WithContext")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("WithEnv")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("WithNewContext")
	models.Registry.MustGet("PartnerTitle").AddEmptyMethod("Write")
	models.Registry.MustGet("PartnerTitle").NewMethod("Aggregates", m_PartnerTitle_Aggregates)
	models.RegisterRecordSetWrapper("PartnerTitle", PartnerTitleSet{})
	models.RegisterModelDataWrapper("PartnerTitle", PartnerTitleData{})
}
